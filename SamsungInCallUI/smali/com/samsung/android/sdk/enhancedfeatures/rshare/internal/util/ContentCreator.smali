...
# static fields
.field private static final CALENDAR_CONTENT_AUTHORITY:Ljava/lang/String; = "com.samsung.android.calendar.vcs"
...
.field private static final DOCUMENT_GOOGLE_DOCS_AUTHORITY:Ljava/lang/String; = "com.google.android.apps.docs.storage.legacy"

.field private static final DOCUMENT_GOOGLE_PHOTOS_AUTHORITY:Ljava/lang/String; = "com.google.android.apps.photos.content"
...
.field private static final ONE_DRIVE_AUTHORITY:Ljava/lang/String; = "com.microsoft.skydrive.content.external"
...
.method public static createContents(Landroid/content/Context;Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/BasicUploadRequest;)Ljava/util/ArrayList;
    ...
    iget-object v1, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ContentInfo;->contentUri:Landroid/net/Uri;
    ...
    invoke-static {v3, v7}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/RLog;->d(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v1}, Landroid/net/Uri;->getEncodedAuthority()Ljava/lang/String;

    move-result-object v3

    const-string v7, "0@media"
    ...
    const-string v9, "setUpAndStartContact : authority = [ "
    ...
    invoke-static {v1, v9}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/RLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v7}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/ContentCreator;->createFileContent(Landroid/content/Context;Landroid/net/Uri;)Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/ContentData;
    ...
    invoke-static {v7, v9}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/RLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "0@com.sec.android.gallery3d.provider"
    ...
    :cond_4
    invoke-static {p0, v7}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/ContentCreator;->createMediaContent(Landroid/content/Context;Landroid/net/Uri;)Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/ContentData;
    ...
    invoke-static {p0, v1}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/ContentCreator;->createContactContent(Landroid/content/Context;Ljava/util/ArrayList;)Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/ContentData;
    ...
    :cond_6
    invoke-static {p0, v7}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/ContentCreator;->createOtherContent(Landroid/content/Context;Landroid/net/Uri;)Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/ContentData;
...
.method public static createMediaContent(Landroid/content/Context;Landroid/net/Uri;)Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/ContentData;
    ...
    const-string v0, "run createMediaContent"
    ...
    const-string v1, "createMediaContent : uri = [ "
    ...
    :try_start_1
    const-string v1, "exist cloud_is_cached column"
    ...
    const-string v2, "MediaStore has no real file for "
    ...
    :cond_1
    invoke-static {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/ContentCreator;->existCloudCacheFile(Landroid/database/Cursor;)Z
    :try_end_1
    ...
    :try_start_3
    const-string v1, "call openInputStream for cloud gallery"
    ...
    const-string v1, "MediaStore has no real file for "
    ...
    const-string v4, "inputStream close error : "
    ...
    const-string v0, "not exist cloud_is_cached column"
    ...
    invoke-static {v1, v4}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/RLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_6
    ...
    const-string v3, "createMediaContent : path = "
    ...
    const-string v1, "createMediaContent = mimeType = "
    ...
    const-string v1, "MediaStore has empty file for "
    ...
    const-string v1, "MediaStore has no content for "
    ...
    const-string v4, "createMediaContent : path = [ "
...
.method private static getAbsolutePath(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    :cond_8
    const-string v1, "com.samsung.android.calendar.vcs"
    ...
    :cond_9
    const-string v1, "com.microsoft.skydrive.content.external"
    ...
    :cond_a
    invoke-static {p0, p1, v0, v0}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/ContentCreator;->getDataColumn(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public static isApkFile(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 3
    ...
    const-string v1, "createMediaContent apk file type"
