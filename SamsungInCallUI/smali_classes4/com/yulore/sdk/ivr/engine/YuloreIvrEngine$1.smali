...
.method public run()V
    ...
    const-string v4, " prepared to delete all old data except zip file "
    ...
    const-string v3, " copy offline data packet from assets folder, copy offline data packet from user direction "
    ...
    const-string v3, "copy offline data packet successfully, prepared to unzip the file"
