...
.method private download(Lcom/yulore/sdk/ivr/model/IvrPkgInfo;)Z
    ...
    const-string v2, " update a part of offline files "
    ...
    const-string v2, " update all offline files "
...
.method private downloadPkg(ILjava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v5, " update url is null"
    ...
    sget-object v5, Lcom/yulore/sdk/ivr/util/Constants;->API_KEY:Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/yulore/android/common/download/DownloadManager;->getInstance(Landroid/content/Context;)Lcom/yulore/android/common/download/DownloadManager;
    ...
    invoke-virtual {v1, v4}, Lcom/yulore/android/common/download/DownloadManager$Request;->setUrl(Ljava/lang/String;)Lcom/yulore/android/common/download/DownloadManager$Request;

    iget-object v4, p0, Lcom/yulore/sdk/ivr/service/IvrCacheService;->yuloreIVREngine:Lcom/yulore/sdk/ivr/engine/YuloreIvrEngine;

    invoke-virtual {v4}, Lcom/yulore/sdk/ivr/engine/YuloreIvrEngine;->getIvrFileDir()Ljava/io/File;

    move-result-object v4

    invoke-virtual {v1, v4}, Lcom/yulore/android/common/download/DownloadManager$Request;->setSaveDir(Ljava/io/File;)Lcom/yulore/android/common/download/DownloadManager$Request;

    const-string v4, "ivr.zip"

    invoke-virtual {v1, v4}, Lcom/yulore/android/common/download/DownloadManager$Request;->setSaveName(Ljava/lang/String;)Lcom/yulore/android/common/download/DownloadManager$Request;

    const-string v4, "request packet"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "download zip file url ="
    ...
    const-string v6, "download zip file result ="
    ...
    iget-object v4, p0, Lcom/yulore/sdk/ivr/service/IvrCacheService;->sp:Lcom/yulore/android/common/util/SharedPreferencesUtility;

    const-string v5, "version"

    invoke-virtual {v4, v5, p1}, Lcom/yulore/android/common/util/SharedPreferencesUtility;->putInt(Ljava/lang/String;I)V
...
.method private requestUpdate(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string v7, " request error : UnsupportedEncodingException"
    ...
    const-string v7, " update all data files "
    ...
    const-string v7, " request error : IOException"
    ...
    const-string v7, " update a part of offline files "
    ...
    const-string v7, " request error : JSONException"
