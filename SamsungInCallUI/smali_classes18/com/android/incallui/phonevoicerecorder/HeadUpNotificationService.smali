...
.method private animateForSlideOut(Z)V
    ...
    iget-boolean v5, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mCanSlideOut:Z
    ...
    :cond_1
    iget-object v5, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mHeadUpNotificationView:Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationView;

    if-eqz v5, :cond_0

    iput-boolean v9, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mIsHideAnimationRunning:Z
    ...
    new-instance v6, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService$4;

    invoke-direct {v6, p0}, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService$4;-><init>(Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;)V
...
.method public animateForHide()V
    ...
    iget-boolean v2, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mIsPopupShowing:Z
    ...
    invoke-virtual {v2}, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationView;->getHeight()I
    ...
    iput-object v2, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mMoveAnimator:Landroid/animation/ObjectAnimator;

    iget-object v2, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mMoveAnimator:Landroid/animation/ObjectAnimator;
    ...
    new-instance v3, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService$5;

    invoke-direct {v3, p0}, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService$5;-><init>(Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;)V
...
.method public animateForHideNotStopSelf(Landroid/animation/AnimatorListenerAdapter;)V
    ...
    iget-object v3, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mHeadUpNotificationView:Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationView;

    if-eqz v3, :cond_0

    iget-boolean v3, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mIsPopupShowing:Z

    if-eqz v3, :cond_0

    iput-boolean v5, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mIsHideAnimationRunning:Z
    ...
    invoke-virtual {v3}, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationView;->getHeight()I
...
.method protected animateForShow()V
    ...
    iput-boolean v5, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mIsShowAnimationRunning:Z
    ...
    invoke-virtual {v3, v4}, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationView;->setTranslationY(F)V
    ...
    new-instance v4, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService$3;

    invoke-direct {v4, p0}, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService$3;-><init>(Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;)V
...
.method public getMaxX()I
    ...
    invoke-virtual {p0, v2}, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method public onCreate()V
    ...
    iput v1, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mMinFlingVelocity:I
...
.method protected setHeadUpNotificationWindowFocusable()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v3, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mContext:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mWindowAttributes:Landroid/view/WindowManager$LayoutParams;

    iget-object v4, p0, Lcom/android/incallui/phonevoicerecorder/HeadUpNotificationService;->mWindowAttributes:Landroid/view/WindowManager$LayoutParams;
