...
.method public onCreate()V
    ...
    invoke-static {v2}, Lcom/android/incallui/util/SystemServiceUtils;->getAppVersionName(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0, v2}, Lcom/android/incallui/InCallApp;->setAppVerionName(Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/android/incallui/InCallUIFeature;->makeFeature(Landroid/content/Context;)V
    ...
    invoke-static {v2}, Lcom/android/incallui/InCallUISystemDB;->initialize(Landroid/content/Context;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/incallui/operator/usa/InCallUIExtensionManager;->telephonyManager(Landroid/content/Context;)V
    ...
    invoke-static {v2}, Lcom/android/incallui/util/VisualCallCenter;->VCC_init(Landroid/content/Context;)V
    ...
    new-instance v2, Lcom/android/incallui/util/SecUncaughtExceptionHandler;
    ...
    invoke-direct {v2, v3, v4}, Lcom/android/incallui/util/SecUncaughtExceptionHandler;-><init>(Landroid/content/Context;Ljava/lang/Thread$UncaughtExceptionHandler;)V
