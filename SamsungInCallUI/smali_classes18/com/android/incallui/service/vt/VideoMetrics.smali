...
.method private getBigTempleteAlign(Lcom/android/incallui/service/vt/VideoDimension;)I
    ...
    new-instance v3, Lcom/android/incallui/util/VideoTemplate;

    invoke-direct {v3}, Lcom/android/incallui/util/VideoTemplate;-><init>()V
    ...
    invoke-virtual {v4, v5}, Lcom/android/incallui/util/VideoTemplate;->getCenterFitSizeTemplete(F)Lcom/android/incallui/util/VideoTemplate;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/android/incallui/util/VideoTemplate;->update(Lcom/android/incallui/util/VideoTemplate;)V
    ...
    invoke-virtual {v4, v5}, Lcom/android/incallui/util/VideoTemplate;->getHeightDifference(I)I

    move-result v1

    if-eqz v1, :cond_0

    iget-object v4, p0, Lcom/android/incallui/service/vt/VideoMetrics;->mCardMetrics:Lcom/android/incallui/service/vt/VideoCardMetrics;
...
.method private getResizeHeight(I)I
    ...
    iget v0, v1, Lcom/android/incallui/service/vt/VideoDimension;->height:I
...
.method private getResizeWidth(I)I
    ...
    iget v0, v1, Lcom/android/incallui/service/vt/VideoDimension;->width:I
...
.method public getBaseSmallTemplete(Z)Lcom/android/incallui/util/VideoTemplate;
    ...
    iget-boolean v4, p0, Lcom/android/incallui/service/vt/VideoMetrics;->mIsInMultiWindowMode:Z
    ...
    invoke-virtual {v4}, Lcom/android/incallui/util/VideoTemplate;->getX()F
    ...
    invoke-virtual {v3, v4}, Lcom/android/incallui/util/VideoTemplate;->setX(F)V

    iget-object v4, p0, Lcom/android/incallui/service/vt/VideoMetrics;->mVideoZone:Lcom/android/incallui/util/VideoTemplate;

    invoke-virtual {v4}, Lcom/android/incallui/util/VideoTemplate;->getY()F
    ...
    invoke-virtual {v3, v4}, Lcom/android/incallui/util/VideoTemplate;->setY(F)V

    invoke-virtual {p0}, Lcom/android/incallui/service/vt/VideoMetrics;->getSmallTempleteWeight()F

    move-result v4

    invoke-virtual {v3, v4}, Lcom/android/incallui/util/VideoTemplate;->zoom(F)V

    invoke-virtual {p0, v3}, Lcom/android/incallui/service/vt/VideoMetrics;->getSmallTempleteMinWidth(Lcom/android/incallui/util/VideoTemplate;)I
    ...
    invoke-virtual {v3, v2}, Lcom/android/incallui/util/VideoTemplate;->zoom(F)V
    ...
    invoke-virtual {v3}, Lcom/android/incallui/util/VideoTemplate;->invertSize()V
...
.method public getSmallBannerTemplete(Z)Lcom/android/incallui/util/VideoTemplate;
    ...
    invoke-virtual {v3}, Lcom/android/incallui/service/vt/VideoCardMetrics;->getBannerCallCardHeight()I
...
.method public getSmallCameraEffectTemplete(Z)Lcom/android/incallui/util/VideoTemplate;
    ...
    invoke-virtual {v3}, Lcom/android/incallui/service/vt/VideoCardMetrics;->getCameraEffectCallCardHeight()I
...
.method public getSmallMultipartyBannerTemplete(Z)Lcom/android/incallui/util/VideoTemplate;
    ...
    invoke-virtual {v3}, Lcom/android/incallui/service/vt/VideoCardMetrics;->getMultipartyBannerCallCardHeight()I
...
.method public getSmallMultipartyTemplete(Z)Lcom/android/incallui/util/VideoTemplate;
    ...
    invoke-virtual {v3}, Lcom/android/incallui/service/vt/VideoCardMetrics;->getMultipartyCallCardHeight()I
...
.method public update(Lcom/android/incallui/service/vt/VideoCallMetrics;Landroid/content/Context;)V
    ...
    :cond_0
    iget v4, p1, Lcom/android/incallui/service/vt/VideoCallMetrics;->density:F

    iput v4, p0, Lcom/android/incallui/service/vt/VideoMetrics;->mDensity:F

    invoke-virtual {p1}, Lcom/android/incallui/service/vt/VideoCallMetrics;->isInMultiWindowMode()Z

    move-result v4

    iput-boolean v4, p0, Lcom/android/incallui/service/vt/VideoMetrics;->mIsInMultiWindowMode:Z

    invoke-virtual {p1}, Lcom/android/incallui/service/vt/VideoCallMetrics;->isDeviceLandScape()Z

    move-result v4

    iput-boolean v4, p0, Lcom/android/incallui/service/vt/VideoMetrics;->mIsDeviceLandScape:Z

    invoke-virtual {p1}, Lcom/android/incallui/service/vt/VideoCallMetrics;->isPhoneVideoUX()Z

    move-result v4

    iput-boolean v4, p0, Lcom/android/incallui/service/vt/VideoMetrics;->mIsPhoneVideoUX:Z

    iget-object v4, p0, Lcom/android/incallui/service/vt/VideoMetrics;->mCardMetrics:Lcom/android/incallui/service/vt/VideoCardMetrics;

    invoke-virtual {v4, p1, p2}, Lcom/android/incallui/service/vt/VideoCardMetrics;->update(Lcom/android/incallui/service/vt/VideoCallMetrics;Landroid/content/Context;)V
    ...
    invoke-virtual {v4, v1, v2}, Lcom/android/incallui/util/VideoTemplate;->set(FF)V

    iget-object v4, p0, Lcom/android/incallui/service/vt/VideoMetrics;->mVideoZone:Lcom/android/incallui/util/VideoTemplate;

    invoke-virtual {v4, v3, v0}, Lcom/android/incallui/util/VideoTemplate;->setSize(II)V
    ...
    iget-boolean v4, p1, Lcom/android/incallui/service/vt/VideoCallMetrics;->isLeftHandRotation:Z
