...
.field static final RECORD_INFO_STATE_CHANGED:I = 0xc9
...
.method static synthetic access$502(Lcom/android/incallui/service/SecCallPopupService;Z)Z
    .locals 0
...
.method public animateForShowIfNecessary()V
    ...
    iget-boolean v2, p0, Lcom/android/incallui/service/SecCallPopupService;->mIsShowAnimationRunning:Z

    if-nez v2, :cond_0

    iget-boolean v2, p0, Lcom/android/incallui/service/SecCallPopupService;->mIsPopupShowing:Z

    if-nez v2, :cond_0

    iget-boolean v2, p0, Lcom/android/incallui/service/SecCallPopupService;->mIsViewInflated:Z

    if-nez v2, :cond_2

    :cond_0
    const-string v2, "animateForShowIfNecessary: skip"
    ...
    :cond_2
    iget-object v2, p0, Lcom/android/incallui/service/SecCallPopupService;->mSecCallPopupWaitingCall:Lcom/android/incallui/service/SecCallPopupWaitingCall;

    invoke-virtual {v2}, Lcom/android/incallui/service/SecCallPopupWaitingCall;->getWaitingDialg()Landroid/app/AlertDialog;
    ...
    const-string v2, "WaitingDialog is showing now : skip"
    ...
    invoke-static {v2, v0, v4}, Lcom/android/incallui/util/InCallUtils;->getCallToDisplay(Lcom/android/incallui/CallList;Lcom/android/incallui/Call;Z)Lcom/android/incallui/Call;

    move-result-object v1

    if-eqz v0, :cond_5

    iget-object v2, p0, Lcom/android/incallui/service/SecCallPopupService;->mSecCallPopupContainer:Lcom/android/incallui/service/SecCallPopupContainer;

    if-eqz v2, :cond_4

    iget-object v2, p0, Lcom/android/incallui/service/SecCallPopupService;->mSecCallPopupContainer:Lcom/android/incallui/service/SecCallPopupContainer;

    invoke-virtual {v2}, Lcom/android/incallui/service/SecCallPopupContainer;->isBackgroundShowing()Z

    move-result v2

    if-eqz v2, :cond_4

    const-string v2, "animateForShowIfNecessary: show"
    ...
    const-string v2, "animateForShowIfNecessary: second call is exist"
    ...
    :cond_4
    const-string v2, "animateForShowIfNecessary: not ready"
    ...
    :cond_5
    const-string v2, "animateForShowIfNecessary: no call"
...
.method endCallClicked()V
    ...
    invoke-direct {p0, v1, v4}, Lcom/android/incallui/service/SecCallPopupService;->log(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v1, v3, v3}, Lcom/android/incallui/service/SecCallPopupContainer;->manageRecordInfo(ZZ)V
...
.method public onAnswerWithWaitingCheck()V
    ...
    invoke-virtual {v2}, Lcom/android/incallui/service/SecCallPopupWaitingCall;->controlWaitingCall()V
...
.method public onCallProtectInfoQueryComplete(Ljava/lang/String;)V
    ...
    iget-object v1, v1, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->callProtectInfo:Lcom/whitepages/nameid/CallProtectInfo;
    ...
    iget-object v1, v1, Lcom/whitepages/nameid/CallProtectInfo;->riskRating:Ljava/lang/String;

    if-nez v1, :cond_3

    :cond_2
    const-string v1, "Call Protect riskRating is null--no need to update popup."
...
.method public onCreate()V
    ...
    invoke-virtual {v2, p0}, Lcom/whitepages/nameid/CallProtectInfoController;->addListener(Lcom/whitepages/nameid/CallProtectInfoController$CallProtectInfoListener;)V
    ...
    const-string v2, "onCreate : InCallActivity isShowingInCallUi"
...
.method protected onCreateCustomView(Landroid/view/ViewGroup;)V
    ...
    const-string v4, "onCreateCustomView"

    invoke-direct {p0, v4}, Lcom/android/incallui/service/SecCallPopupService;->log(Ljava/lang/String;)V
    ...
    check-cast v4, Lcom/android/incallui/service/SecCallPopupContainer;

    iput-object v4, p0, Lcom/android/incallui/service/SecCallPopupService;->mSecCallPopupContainer:Lcom/android/incallui/service/SecCallPopupContainer;

    iget-object v4, p0, Lcom/android/incallui/service/SecCallPopupService;->mSecCallPopupContainer:Lcom/android/incallui/service/SecCallPopupContainer;

    invoke-virtual {v4}, Lcom/android/incallui/service/SecCallPopupContainer;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v3

    new-instance v4, Lcom/android/incallui/service/SecCallPopupService$5;

    invoke-direct {v4, p0}, Lcom/android/incallui/service/SecCallPopupService$5;-><init>(Lcom/android/incallui/service/SecCallPopupService;)V

    invoke-virtual {v3, v4}, Landroid/view/ViewTreeObserver;->addOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    iget-object v4, p0, Lcom/android/incallui/service/SecCallPopupService;->mSecCallPopupContainer:Lcom/android/incallui/service/SecCallPopupContainer;

    invoke-virtual {v4, p0}, Lcom/android/incallui/service/SecCallPopupContainer;->setSecCallPopupService(Lcom/android/incallui/service/SecCallPopupService;)V
    ...
    invoke-virtual {v4, v1, v0, v5}, Lcom/android/incallui/operator/usa/InCallUIExtensionManager;->showCallRoamingGuardDialog(Landroid/content/Context;Lcom/android/incallui/Call;Z)V
...
.method public onDestroy()V
    ...
    invoke-virtual {v1, p0}, Lcom/whitepages/nameid/CallProtectInfoController;->removeListener(Lcom/whitepages/nameid/CallProtectInfoController$CallProtectInfoListener;)V
...
.method public onStateChange(Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/CallList;)V
    ...
    invoke-static {p3, v2, v4}, Lcom/android/incallui/util/InCallUtils;->getCallToDisplay(Lcom/android/incallui/CallList;Lcom/android/incallui/Call;Z)Lcom/android/incallui/Call;
    ...
    invoke-direct {p0, v2}, Lcom/android/incallui/service/SecCallPopupService;->log(Ljava/lang/String;)V
    ...
    :cond_3
    const-string v2, "During call is not available"
    ...
    iput-object v2, p0, Lcom/android/incallui/service/SecCallPopupService;->mContactInfo:Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;
    ...
    invoke-static {v0, v2, v5, v6}, Lcom/android/incallui/service/EcidClient;->startEcidLookupQuery(Lcom/android/incallui/Call;Landroid/content/Context;Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;Lcom/android/incallui/service/EcidClient$Listener;)V
    ...
    invoke-virtual {v2, v0, v5}, Lcom/android/incallui/service/SecCallPopupContainer;->updatePrimaryDisplayInfo(Lcom/android/incallui/Call;Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;)V

    iget-object v2, p0, Lcom/android/incallui/service/SecCallPopupService;->mSecCallPopupContainer:Lcom/android/incallui/service/SecCallPopupContainer;

    invoke-virtual {v2, p2}, Lcom/android/incallui/service/SecCallPopupContainer;->updateCallButtons(Lcom/android/incallui/InCallPresenter$InCallState;)V

    iget-object v2, p0, Lcom/android/incallui/service/SecCallPopupService;->mSecCallPopupContainer:Lcom/android/incallui/service/SecCallPopupContainer;

    invoke-virtual {v2, p1, p2, p3, v0}, Lcom/android/incallui/service/SecCallPopupContainer;->onStateChange(Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/CallList;Lcom/android/incallui/Call;)V
    ...
    invoke-virtual {v2}, Lcom/android/incallui/service/SecCallPopupWaitingCall;->dismissWaitingCallPopup()V
    ...
    invoke-direct {p0, v2}, Lcom/android/incallui/service/SecCallPopupService;->updateWakeLockState(I)V

    iget v2, p0, Lcom/android/incallui/service/SecCallPopupService;->mPrevState:I
    ...
    invoke-static {v2, v5, v6}, Lcom/android/incallui/util/SALogging;->sendSAEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v5, p0}, Lcom/android/incallui/CallList;->addCallUpdateListener(Ljava/lang/String;Lcom/android/incallui/CallList$CallUpdateListener;)V
    ...
    iput v2, p0, Lcom/android/incallui/service/SecCallPopupService;->mPrevState:I
    ...
    const-string v5, "onStateChange :  isSmartAnswered - "
    ...
    const-string v2, "onStateChange :  setBlockToUpdateNotification false"
    ...
    invoke-virtual {v2, v4}, Lcom/android/incallui/InCallPresenter;->setBlockToUpdateNotification(Z)V
...
.method public showInCallUI()V
    ...
    invoke-virtual {v3}, Lcom/android/incallui/InCallPresenter;->getInCallActivityOptions()Landroid/os/Bundle;
...
.method showInCallUIForAnswer()V
    ...
    const-string v3, "fromPopupForAnswer"
    ...
    const-string v4, "showInCallUIForAnswer"
...
.method toggleSpeaker(Z)V
    ...
    invoke-virtual {v1}, Lcom/android/incallui/service/SecCallPopupContainer;->updateAudioButtons()V
