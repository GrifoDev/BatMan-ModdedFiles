...
.method private queryInCallServiceProvider(Landroid/content/Context;Lcom/android/incallui/Call;)Landroid/database/Cursor;
    ...
    sget-boolean v0, Lcom/android/incallui/secrcs/RcsShareUI;->mReConnect:Z
...
.method private setupRcsServicesButton(Landroid/content/Context;Landroid/view/ViewStub;Landroid/widget/Button;Landroid/database/Cursor;)V
    ...
    const-string v9, " setupRcsServicesButton mIsSelfCapable "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    sget-boolean v9, Lcom/android/incallui/secrcs/RcsShareUI;->mIsSelfCapable:Z
    ...
    const-string v9, " setupRcsServicesButton ImsCommonUtils.isAvailablePSVT() "
    ...
    const-string v9, "isCrane supported : "
...
.method public disconnect(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, v5}, Lcom/android/incallui/ProximitySensor;->setFromRcsShare(Z)V
    ...
    invoke-virtual {v2}, Lcom/sec/ims/options/CapabilityManager;->isConnected()Z
    ...
    invoke-virtual {v2}, Lcom/sec/ims/options/CapabilityManager;->disconnect()V

    sget-object v2, Lcom/android/incallui/secrcs/RcsShareUI;->LOG_TAG:Ljava/lang/String;

    const-string v3, " mCapabilityManager disconnected! "

    invoke-static {v2, v3}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;)V

    iput-object v4, p0, Lcom/android/incallui/secrcs/RcsShareUI;->mCapabilityManager:Lcom/sec/ims/options/CapabilityManager;
...
.method public setupLegacyInCallButtons(Landroid/widget/Button;Landroid/widget/ToggleButton;Landroid/view/ViewStub;Landroid/widget/Button;Landroid/view/ViewStub;Landroid/widget/Button;)V
    ...
    const-string v3, "State = Dialing  or Hold"
