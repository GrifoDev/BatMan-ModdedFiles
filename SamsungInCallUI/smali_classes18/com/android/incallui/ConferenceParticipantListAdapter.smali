...
.method private declared-synchronized updateParticipantInfo(Ljava/util/List;)V
    ...
    const-string v19, "updateParticipantInfo: delete action is pending"
    ...
    const-string v19, "ConferenceParticipantListAdapter"

    new-instance v20, Ljava/lang/StringBuilder;

    invoke-direct/range {v20 .. v20}, Ljava/lang/StringBuilder;-><init>()V

    const-string v21, "updateParticipantInfo previousParticipantCount:"
    ...
    const-string v22, "updateParticipantInfo callId:"
    ...
    const-string v22, "already removed call so do not display it again - callId :"
    ...
    check-cast v16, Lcom/android/incallui/ConferenceParticipantListAdapter$ParticipantInfo;
    ...
    const-string v22, "updateParticipantInfo previousState :"

    invoke-virtual/range {v21 .. v22}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v21

    invoke-virtual/range {v16 .. v16}, Lcom/android/incallui/ConferenceParticipantListAdapter$ParticipantInfo;->getPreviousCallState()I

    move-result v22

    invoke-static/range {v22 .. v22}, Lcom/android/incallui/Call$State;->toString(I)Ljava/lang/String;
    ...
    const-string v22, " call.getState():"
    ...
    invoke-virtual {v0, v4}, Lcom/android/incallui/ConferenceParticipantListAdapter$ParticipantInfo;->setCall(Lcom/android/incallui/Call;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/incallui/ConferenceParticipantListAdapter$ParticipantInfo;->setPreviousCallState(I)V

    move-object/from16 v0, v16

    invoke-virtual {v0, v6}, Lcom/android/incallui/ConferenceParticipantListAdapter$ParticipantInfo;->setContactCacheEntry(Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;)V
    ...
    const-string v22, "updateParticipantInfo state: "
    ...
    const-string v22, "updateParticipantInfo getDisconnectedByUser: "
    ...
    const-string v22, "updateParticipantInfo: participantInfoListForDelete.add("
    ...
    const-string v21, "updateParticipantInfo newParticipantAdded"
    ...
    new-instance v16, Lcom/android/incallui/ConferenceParticipantListAdapter$ParticipantInfo;

    move-object/from16 v0, v16

    move-object/from16 v1, p0

    invoke-direct {v0, v1, v4, v6}, Lcom/android/incallui/ConferenceParticipantListAdapter$ParticipantInfo;-><init>(Lcom/android/incallui/ConferenceParticipantListAdapter;Lcom/android/incallui/Call;Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;)V
    ...
    const-string v21, "updateParticipantInfo: call.setIllusion(true)"
    ...
    const-string v21, "updateParticipantInfo mConferenceParticipants:"
    ...
    const-string v21, "updateParticipantInfo: "
    ...
    const-string v21, " conferenceParticipants.size():"
    ...
    const-string v21, "updateParticipantInfo individualUpdateCallIds.size():"
    ...
    const-string v21, " individualUpdateCallIds:"
    ...
    const-string v21, "updateParticipantInfo participantInfoListForDelete.size() = "
    ...
    invoke-static/range {v19 .. v20}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;)V

    if-eqz v15, :cond_e

    const-string v19, "ConferenceParticipantListAdapter"

    const-string v20, "updateParticipantInfo - some participants are Added"
    ...
    const-string v20, "updateParticipantInfo - some participants are removed"
    ...
    const-string v20, "updateParticipantInfo - no call state change so don\'t need to update"
    ...
    const-string v20, "updateParticipantInfo - update list fully by unknown reason"
