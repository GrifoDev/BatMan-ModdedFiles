...
.method public isShowMultiWindowMode()Z
    ...
    invoke-virtual {v0}, Lcom/android/incallui/InCallActivity;->isMultiWindowUX()Z
...
.method public isTabletUX()Z
    ...
    invoke-virtual {v0}, Lcom/android/incallui/InCallActivity;->isTabletUX()Z
...
.method public onContentViewChanged(Landroid/graphics/Point;)V
    ...
    invoke-interface {v1, p1}, Lcom/android/incallui/CallButtonUi;->onContentViewChanged(Landroid/graphics/Point;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/incallui/AnswerUi;->onContentViewChanged(Landroid/graphics/Point;)V
    ...
    invoke-interface {v2, p1}, Lcom/android/incallui/CallCardUi;->onContentViewChanged(Landroid/graphics/Point;)V
...
.method public restartTimer(III)V
    ...
    iget-object v2, p0, Lcom/android/incallui/UiAdapter;->mHandler:Landroid/os/Handler;
...
.method public showVideoBanner(Ljava/lang/String;)V
    ...
    const-string v3, "showVideoBanner : "
...
.method public showVoiceCallModifyStateMessage(ZII)V
    ...
    invoke-static {p2, v8}, Lcom/android/incallui/VideoBanner;->getMessageForVideoState(IZ)Ljava/lang/String;
    ...
    invoke-interface {v3, p1, v0, v8}, Lcom/android/incallui/CallCardUi;->showModifyStateInfoBanner(ZLjava/lang/String;I)V

    :cond_6
    if-ne p3, v6, :cond_7

    invoke-interface {v3, p1, v0, v6}, Lcom/android/incallui/CallCardUi;->showModifyStateInfoBanner(ZLjava/lang/String;I)V

    :cond_7
    if-ne p3, v7, :cond_1

    invoke-interface {v3, p1, v0, v7}, Lcom/android/incallui/CallCardUi;->showModifyStateInfoBanner(ZLjava/lang/String;I)V
