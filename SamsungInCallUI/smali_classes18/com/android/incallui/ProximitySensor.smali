...
.method private declared-synchronized updateProximitySensorMode()V
    ...
    const-string v11, "isForegroundVideoCallType : "
    ...
    invoke-static {p0, v10, v11}, Lcom/android/incallui/Log;->v(Ljava/lang/Object;Ljava/lang/String;Z)V
    ...
    const-string v11, "isCallForwardingState : "
    ...
    :cond_3
    iget-object v10, p0, Lcom/android/incallui/ProximitySensor;->mSamsungAudioManager:Landroid/media/AudioManager;
    ...
    invoke-virtual {v10}, Lcom/android/incallui/accessory/AccessoryEventHandler;->isWIFIDisplayOn()Z
    ...
    invoke-virtual {v10}, Landroid/media/AudioManager;->semIsSplitSoundRunning()Z
    ...
    const-string v11, "isWIFIDisplayOn : "
    ...
    const-string v11, " isSplitSoundRunning : "
    ...
    iget-boolean v10, p0, Lcom/android/incallui/ProximitySensor;->mFromRcsShare:Z
    ...
    const-string v11, "mFromRcsShare: "
    ...
    :goto_2
    invoke-virtual {v11, v12, v10}, Lcom/google/common/base/Objects$ToStringHelper;->add(Ljava/lang/String;I)Lcom/google/common/base/Objects$ToStringHelper;
    ...
    iget-boolean v12, p0, Lcom/android/incallui/ProximitySensor;->mUiShowing:Z

    if-eqz v12, :cond_b

    :goto_5
    invoke-virtual {v10, v11, v8}, Lcom/google/common/base/Objects$ToStringHelper;->add(Ljava/lang/String;I)Lcom/google/common/base/Objects$ToStringHelper;
    ...
    invoke-virtual {v8, v9, v10}, Lcom/google/common/base/Objects$ToStringHelper;->add(Ljava/lang/String;Ljava/lang/Object;)Lcom/google/common/base/Objects$ToStringHelper;

    move-result-object v8

    invoke-virtual {v8}, Lcom/google/common/base/Objects$ToStringHelper;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v8}, Lcom/android/incallui/accessory/AccessoryEventHandler;->isCoverClosed()Z
    ...
    invoke-virtual {v8}, Lcom/android/incallui/accessory/AccessoryEventHandler;->isHmtDocked()Z

    move-result v4

    iget-boolean v8, p0, Lcom/android/incallui/ProximitySensor;->mIsPhoneOffhook:Z
    ...
    const-string v8, "Turning off proximity sensor"
    ...
    const-string v8, "Turning on proximity sensor"
    ...
    invoke-virtual {p0, v7}, Lcom/android/incallui/ProximitySensor;->turnOffProximitySensor(Z)V
    :try_end_2
