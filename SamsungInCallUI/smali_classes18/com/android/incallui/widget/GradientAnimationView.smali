...
.method private declared-synchronized updateGradient()V
    ...
    const-string v2, "updateGradient..."

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-boolean v1, p0, Lcom/android/incallui/widget/GradientAnimationView;->mIsColorValid:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Lcom/android/incallui/widget/GradientAnimationView;->TAG:Ljava/lang/String;

    const-string v2, "updateGradient: color is not valid"
    ...
    invoke-static {v1, v2, v3, v4}, Lcom/sec/android/gradient_color_extractor/GradientMaker;->getGradation_low_machband(IIII)Landroid/graphics/Bitmap;
...
.method private updateGradientSize()Z
    ...
    :cond_0
    invoke-direct {p0, v3, v2}, Lcom/android/incallui/widget/GradientAnimationView;->updateGradientSize(II)Z
...
.method public updateGradientColor(Landroid/graphics/drawable/Drawable;Z)V
    ...
    iget-object v7, p0, Lcom/android/incallui/widget/GradientAnimationView;->TAG:Ljava/lang/String;

    const-string v8, "updateGradientColor: call is null"
    ...
    const-string v8, "updateGradientColor: emergency call"
    ...
    :goto_1
    iget v7, p0, Lcom/android/incallui/widget/GradientAnimationView;->mStartColor:I

    if-ne v7, v5, :cond_1

    iget v7, p0, Lcom/android/incallui/widget/GradientAnimationView;->mEndColor:I
    ...
    iput-boolean v10, p0, Lcom/android/incallui/widget/GradientAnimationView;->mIsColorValid:Z
    ...
    iget-boolean v7, v3, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->queryCompleted:Z
    ...
    const-string v8, "updateGradientColor: spam call"
    ...
    invoke-static {v7}, Lcom/whitepages/nameid/NameIDHelper;->getRiskRating(Ljava/lang/String;)I
    ...
    const-string v8, "updateGradientColor: extract color from drawable"
    ...
    invoke-static {v7}, Lcom/android/incallui/util/GraphicResourceUtils;->getGradientDefaultColors(Ljava/lang/String;)[I
    ...
    iget-boolean v7, v3, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->isGradientColorExists:Z

    if-eqz v7, :cond_9

    iget-object v7, p0, Lcom/android/incallui/widget/GradientAnimationView;->TAG:Ljava/lang/String;

    const-string v8, "updateGradientColor: color exists"
    ...
    const-string v8, "updateGradientColor: NameIDHelper is bound"
    ...
    const-string v8, "updateGradientColor: default"
    ...
    const-string v8, "updateGradientColor: skip"
    ...
    const-string v8, "updateGradientColor: duplicated"
...
.method public updateGradientColorExceptCall(Landroid/graphics/drawable/Drawable;Z)V
    ...
    iput-boolean v5, p0, Lcom/android/incallui/widget/GradientAnimationView;->mIsColorValid:Z
