...
.method public static displayToast(Ljava/lang/String;I)V
    ...
    invoke-static {v5}, Lcom/android/incallui/wrapper/ReflectUtil;->classForName(Ljava/lang/String;)Ljava/lang/Class;
    ...
    invoke-static {v3, v5, v6}, Lcom/android/incallui/wrapper/ReflectUtil;->getMethod(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    invoke-virtual {v1, v5}, Landroid/view/WindowManager$LayoutParams;->semAddPrivateFlags(I)V
    ...
    invoke-virtual {v5}, Lcom/android/incallui/InCallApp;->getBaseContext()Landroid/content/Context;
...
.method public static isShowHDVoiceIcon(Lcom/android/incallui/Call;)Z
    ...
    const-string v6, "isShowHDVoiceIcon() call is null"
    ...
    const-string v7, "isShowHDVoiceIcon() not supported by operator"
    ...
    const-string v6, "display_cshd_icon"
    ...
    const-string v7, "isShowHDVoiceIcon : HDicon not support : "
    ...
    invoke-static {v4}, Lcom/android/incallui/util/InCallUtils;->isSmsCapable(Landroid/content/Context;)Z
    ...
    const-string v7, "isShowHDVoiceIcon : HDicon not required for Softphone : "
    ...
    const-string v7, "isShowHDVoiceIcon() isWBMode : "
    ...
    const-string v6, "isShowHDVoiceIcon false during incoming reject "
    ...
    :cond_19
    const-string v5, "singapore_volte_ui"
    ...
    const-string v6, "isShowHDVoiceIcon is false in BUSY "
    ...
    const-string v5, "spr_display_hd_icon"
...
.method public static isSmsCapable(Landroid/content/Context;)Z
    ...
    const-string v3, "SmsCapable : passes context is null"
...
.method public static needToAnimateForOutgoingCall()Z
    ...
    const-string v7, "support_outgoing_dialer_animation"
    ...
    const-string v8, "needToAnimateForOutgoingCall: skip"
    ...
    const-string v8, "needToAnimateForOutgoingCall: is not dialing"
    ...
    const-string v8, "needToAnimateForOutgoingCall: video call"
    ...
    invoke-static {v7, v2, v6}, Lcom/android/incallui/util/InCallUtils;->getCallToDisplay(Lcom/android/incallui/CallList;Lcom/android/incallui/Call;Z)Lcom/android/incallui/Call;
    ...
    const-string v8, "needToAnimateForOutgoingCall: held call is exist"
    ...
    invoke-static {v7}, Lcom/android/incallui/util/SecOpenThemeUtils;->getCurrentTheme(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v8, "needToAnimateForOutgoingCall: theme"
    ...
    invoke-virtual {v7}, Lcom/android/incallui/UiAdapter;->getInCallActivity()Lcom/android/incallui/InCallActivity;
    ...
    const-string v8, "needToAnimateForOutgoingCall: Landscape mode"
...
.method public static needToShowAsFullScreen()Z
    ...
    invoke-static {v11, v0}, Lcom/android/incallui/util/PackageHelpers;->isTopActivityRunning(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v11, v0}, Lcom/android/incallui/util/PackageHelpers;->isTopActivityRunningEx(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v11, v0}, Lcom/android/incallui/util/PackageHelpers;->isTopActivityRunningPackage(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    :cond_e
    invoke-static {v11}, Lcom/android/incallui/util/SystemServiceUtils;->isKeyguardLocked(Landroid/content/Context;)Z
    ...
    :cond_13
    invoke-static {v11}, Lcom/android/incallui/util/SystemServiceUtils;->isCameraForeground(Landroid/content/Context;)Z
    ...
    const-string v1, "needToShowAsFullScreen Searching SyncCall settings..."
    ...
    invoke-virtual {v6}, Lcom/android/incallui/InCallActivity;->isFDNDialogDismissed()Z
