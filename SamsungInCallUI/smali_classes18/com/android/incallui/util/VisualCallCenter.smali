...
.method public static VCC_init(Landroid/content/Context;)V
    ...
    const-string v6, "VisualCallCenter"

    const-string v7, "Direct Boot mode running"
    ...
    const-string v7, "file success:"

    invoke-static {v6, v7}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_1
    new-instance v6, Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;

    invoke-direct {v6, v4}, Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;-><init>(Landroid/content/Context;)V

    const-string v7, "7OX8e8HMMDUfp4glcsz9Mjc9F4JwKyJl"

    invoke-virtual {v6, v7}, Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;->apiKey(Ljava/lang/String;)Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;

    move-result-object v6

    const-string v7, "EJxt0qbvSidBlSxhgzw27KxdrrhdLrW9b2J51YCwQ3lwuF8RemYAbDYYragwlauto2zdyd4hvrlWuNO5rs0snpdMeGhWqfnfzvqhqBvtsci3nHMJzkCTBAV3WR9cngCRiWFLAlXKuwXhwhOzn5Z6iP3cnhvN1RwwOFHf7"

    invoke-virtual {v6, v7}, Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;->secret(Ljava/lang/String;)Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;

    move-result-object v6

    new-instance v7, Ljava/io/File;

    const-string v8, "yulore/ivr"

    invoke-direct {v7, v0, v8}, Ljava/io/File;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v6, v7}, Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;->ivrFileDir(Ljava/io/File;)Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;
    ...
    invoke-virtual {v6, v7}, Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;->offlinePacketDir(Ljava/io/File;)Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;

    move-result-object v6

    sget-object v7, Lcom/yulore/sdk/ivr/UpdateNetworkStrategy;->WIFI:Lcom/yulore/sdk/ivr/UpdateNetworkStrategy;

    invoke-virtual {v6, v7}, Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;->updateNetworkStrategy(Lcom/yulore/sdk/ivr/UpdateNetworkStrategy;)Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;

    move-result-object v6

    const/16 v7, 0xa8

    invoke-virtual {v6, v7}, Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;->updateIntervalByHour(I)Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;

    move-result-object v6

    invoke-virtual {v6}, Lcom/yulore/sdk/ivr/IvrConfiguration$Builder;->create()Lcom/yulore/sdk/ivr/IvrConfiguration;
    ...
    invoke-virtual {v6, v1, v7}, Lcom/yulore/sdk/ivr/engine/YuloreIvrEngine;->init(Lcom/yulore/sdk/ivr/IvrConfiguration;Z)V
