...
.method public create(Lcom/android/incallui/InCallActivity;)V
    ...
    invoke-virtual {p1, v1}, Lcom/android/incallui/InCallActivity;->findViewById(I)Landroid/view/View;

    move-result-object v1

    check-cast v1, Landroid/view/ViewGroup;

    sput-object v1, Lcom/android/incallui/util/DebugScreen;->mParent:Landroid/view/ViewGroup;
    ...
    sput-object v1, Lcom/android/incallui/util/DebugScreen;->mDebugScreenLayout:Landroid/widget/FrameLayout;
    ...
    iput-object v1, p0, Lcom/android/incallui/util/DebugScreen;->mMainContainer:Landroid/view/View;

    const/4 v1, 0x1

    invoke-direct {p0, v1}, Lcom/android/incallui/util/DebugScreen;->registerDragListener(Z)V
    ...
    iput-object v1, p0, Lcom/android/incallui/util/DebugScreen;->mScreenContainer:Landroid/view/ViewGroup;

    sget-object v1, Lcom/android/incallui/util/DebugScreen;->mParent:Landroid/view/ViewGroup;

    sget-object v2, Lcom/android/incallui/util/DebugScreen;->mDebugScreenLayout:Landroid/widget/FrameLayout;
...
.method public moveScreen(FF)V
    ...
    iget-object v4, p0, Lcom/android/incallui/util/DebugScreen;->mDragStart:Lcom/android/incallui/service/vt/VideoCallMetrics$Position;
    ...
    iput p1, v4, Lcom/android/incallui/service/vt/VideoCallMetrics$Position;->x:F

    iget-object v4, p0, Lcom/android/incallui/util/DebugScreen;->mDragStart:Lcom/android/incallui/service/vt/VideoCallMetrics$Position;

    iput p2, v4, Lcom/android/incallui/service/vt/VideoCallMetrics$Position;->y:F

    iget-object v4, p0, Lcom/android/incallui/util/DebugScreen;->mScreenContainer:Landroid/view/ViewGroup;
...
.method public onClick(Landroid/view/View;)V
    ...
    :pswitch_1
    sget-object v2, Lcom/android/incallui/util/DebugScreen;->mScreenHolder:Lcom/android/incallui/util/DebugScreen$ScreenHolder;

    sget-object v1, Lcom/android/incallui/util/DebugScreen;->mScreenHolder:Lcom/android/incallui/util/DebugScreen$ScreenHolder;

    iget-boolean v1, v1, Lcom/android/incallui/util/DebugScreen$ScreenHolder;->isShowingScreen:Z
    ...
    :goto_1
    iput-boolean v1, v2, Lcom/android/incallui/util/DebugScreen$ScreenHolder;->isShowingScreen:Z
