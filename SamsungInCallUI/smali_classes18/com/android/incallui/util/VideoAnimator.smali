...
.method public static setCallCardFullScreen(Landroid/view/View;Z)V
    ...
    iget v1, v6, Lcom/android/incallui/service/vt/VideoCardMetrics;->indicator_area:I
...
.method public fadeIn(Lcom/android/incallui/util/VideoTemplate;I)V
    ...
    iget-object v8, p0, Lcom/android/incallui/util/VideoAnimator;->mTarget:Landroid/view/View;
    ...
    invoke-direct {v7, v8}, Lcom/android/incallui/util/VideoTemplate;-><init>(Landroid/view/View;)V
    ...
    :cond_3
    iget-object v8, p0, Lcom/android/incallui/util/VideoAnimator;->mAnimatorSet:Landroid/animation/AnimatorSet;
    ...
    iget-object v8, p0, Lcom/android/incallui/util/VideoAnimator;->mEnd:Lcom/android/incallui/util/VideoTemplate;

    invoke-virtual {p1, v8}, Lcom/android/incallui/util/VideoTemplate;->areSame(Lcom/android/incallui/util/VideoTemplate;)Z

    move-result v8

    if-eqz v8, :cond_4

    const-string v8, "VideoAnimator"

    const-string v9, "same animation is running"
    ...
    const-string v9, "forcely end animation for new animation"
