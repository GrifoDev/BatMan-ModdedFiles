...
.method private static getDefaultWallpaper(Landroid/content/Context;Landroid/app/WallpaperManager;)Landroid/graphics/Bitmap;
    ...
    const-string v1, "keyguard_default_wallpaper_thumbnail"

    const/4 v2, 0x0

    :try_start_0
    sget-boolean v10, Lcom/android/incallui/util/GraphicResourceUtils;->SUPPORT_INFINITY_WALLPAPER:Z
    ...
    const-string v11, "edge_lighting_wallpaper_color"
    ...
    :cond_0
    :goto_0
    const-string v6, "keyguard_default_wallpaper_thumbnail"
    ...
    const-string v12, "getDefaultWallpaper: "
    ...
    invoke-virtual {v8, v6, v10, v11}, Landroid/content/res/Resources;->getIdentifier(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I

    move-result v7

    const/4 v10, 0x0

    invoke-virtual {v8, v7, v10}, Landroid/content/res/Resources;->getDrawable(ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    const-string v11, "getDefaultWallpaper: get keyguard_default_wallpaper_thumbnail"

    invoke-static {v10, v11, v13}, Lcom/android/incallui/Log;->i(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v10, "keyguard_default_wallpaper_thumbnail"
    ...
    :cond_3
    :try_start_2
    sget-boolean v10, Lcom/android/incallui/util/GraphicResourceUtils;->SUPPORT_MOTION_WALLPAPER:Z

    if-eqz v10, :cond_0

    const-class v10, Landroid/app/WallpaperManager;

    const-string v11, "getPreloadWallpaperColorCode"

    const/4 v12, 0x0

    new-array v12, v12, [Ljava/lang/Class;

    invoke-static {v10, v11, v12}, Lcom/android/incallui/wrapper/ReflectUtil;->getMethod(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    invoke-static {p1, v5, v10}, Lcom/android/incallui/wrapper/ReflectUtil;->invoke(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v12, "getDefaultWallpaperColors: "
...
.method private static getGradientColors(Landroid/graphics/Bitmap;Z)[I
    ...
    invoke-static {v3}, Lcom/sec/android/gradient_color_extractor/CallGradient;->getGradientColorFromBitmap(Landroid/graphics/Bitmap;)Lcom/sec/android/gradient_color_extractor/CallGradient$GradientColorResult;
    ...
    iget v10, v4, Lcom/sec/android/gradient_color_extractor/CallGradient$GradientColorResult;->gradientColor_a:I
    ...
    iget v10, v4, Lcom/sec/android/gradient_color_extractor/CallGradient$GradientColorResult;->gradientColor_b:I
    ...
    iget v9, v4, Lcom/sec/android/gradient_color_extractor/CallGradient$GradientColorResult;->gradientColor_a:I

    aput v9, v1, v8

    iget v8, v4, Lcom/sec/android/gradient_color_extractor/CallGradient$GradientColorResult;->gradientColor_b:I
    ...
    :cond_5
    invoke-static {v3}, Lcom/sec/android/gradient_color_extractor/CallGradient;->getGradientColorForWallPaperFromBitmap(Landroid/graphics/Bitmap;)Lcom/sec/android/gradient_color_extractor/CallGradient$GradientColorResult;
...
.method public static getGradientDefaultColors(Ljava/lang/String;)[I
    ...
    invoke-virtual {v1, p0}, Lcom/android/incallui/CallList;->getCallById(Ljava/lang/String;)Lcom/android/incallui/Call;
...
.method public static getRoundRectDrawableForBizRing(Landroid/content/Context;Landroid/graphics/drawable/Drawable;I)Landroid/graphics/drawable/Drawable;
    ...
    const-string v18, "GraphicResourceUtils"

    new-instance v19, Ljava/lang/StringBuilder;

    invoke-direct/range {v19 .. v19}, Ljava/lang/StringBuilder;-><init>()V

    const-string v20, "getRoundRectDrawable: bitmap.getWidth()"
    ...
    const-string v20, "getRoundRectDrawable: bitmap.getHeight()"
    ...
    const-string v20, "getCircledDrawable: "
    ...
    invoke-static/range {v18 .. v19}, Lcom/android/incallui/Log;->e(Ljava/lang/String;Ljava/lang/String;)V
