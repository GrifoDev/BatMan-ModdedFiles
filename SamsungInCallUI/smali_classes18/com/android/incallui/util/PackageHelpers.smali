...
.method public static addToContactClicked()V
    ...
    invoke-virtual {v9, v1}, Lcom/android/incallui/CallList;->isCallDisconnectingOrDisconnected(Lcom/android/incallui/Call;)Z
    ...
    invoke-virtual {v9}, Lcom/android/incallui/InCallPresenter;->attemptFinishActivity()V
    :try_end_0
...
.method public static enableBikeModeReceiver()V
    .locals 10
    ...
    const-string v8, "enableBikeModeReceiver"
    ...
    :try_start_0
    const-string v7, "com.samsung.android.app.bikemode"
    ...
    invoke-static {v5, v6}, Lcom/android/incallui/util/PackageHelpers;->isSystemPackage(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
    ...
    const-string v2, "com.android.incallui.bike.BikeModeDTMFReceiver"
    ...
    invoke-virtual {v5, v0, v7, v8}, Landroid/content/pm/PackageManager;->setComponentEnabledSetting(Landroid/content/ComponentName;II)V
    :try_end_0
    ...
    const-string v8, "enableBikeModeReceiver: S-Bike package not found"
...
.method public static getHomeActivity()Ljava/lang/String;
    ...
    const-string v6, "getHomeActivity: "
...
.method public static isSystemPackage(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-static {v1}, Lcom/android/incallui/util/PackageHelpers;->getFirstSignature(Landroid/content/pm/PackageInfo;)Landroid/content/pm/Signature;
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "isSystemPackage: Couldn\'t get system signature"
...
.method public static launchEmergencyCall()V
    ...
    const-string v4, "launchEmergencyCall"
...
.method public static launchReportSpamCall(Ljava/lang/String;)V
    ...
    const-string v5, "launchReportSpamCall"
    ...
    const-string v5, "com.android.server.telecom.operator.chn.SpamCallReportDialogActivity"
...
.method public static viewContactClicked()V
    ...
    invoke-static {v5, v8, v9}, Lcom/android/incallui/util/InCallUtils;->getCallToDisplay(Lcom/android/incallui/CallList;Lcom/android/incallui/Call;Z)Lcom/android/incallui/Call;
    ...
    invoke-virtual {v5, v2}, Lcom/android/incallui/CallList;->isCallDisconnectingOrDisconnected(Lcom/android/incallui/Call;)Z
    ...
    invoke-virtual {v5}, Lcom/android/incallui/InCallPresenter;->attemptFinishActivity()V
    :try_end_0
    .catch Landroid/content/ActivityNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static viewContactClicked(J)V
    ...
    invoke-virtual {v5, v1}, Lcom/android/incallui/CallList;->isCallDisconnectingOrDisconnected(Lcom/android/incallui/Call;)Z
