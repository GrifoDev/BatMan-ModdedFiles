...
.field protected static mIsInMultiWindowMode:Z = false
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/incallui/fragment/VideoCallCardFragment;->mIsInMultiWindowMode:Z
...
.method private updateHideMeLayoutForMultiWindow(II)V
    ...
    :goto_0
    sput-boolean v4, Lcom/android/incallui/fragment/VideoCallCardFragment;->mIsNeedToHideMeLayout:Z
    ...
    :goto_1
    sget-boolean v4, Lcom/android/incallui/fragment/VideoCallCardFragment;->mIsNeedToHideMeLayout:Z
    ...
    :goto_2
    invoke-virtual {p0, v5}, Lcom/android/incallui/fragment/VideoCallCardFragment;->showIncomingHideMeButton(Z)V
...
.method public onMultiWindowModeChanged(Z)V
    ...
    sput-boolean p1, Lcom/android/incallui/fragment/VideoCallCardFragment;->mIsInMultiWindowMode:Z
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updateHideMeLayoutForMultiWindow(II)V
...
.method public setCallState(IIILandroid/telecom/DisconnectCause;Ljava/lang/String;Landroid/graphics/drawable/Drawable;Ljava/lang/String;ZZZ)V
    ...
    invoke-direct/range {v3 .. v9}, Lcom/android/incallui/fragment/VideoCallCardFragment;->getCallStateLabelFromState(IIILandroid/telecom/DisconnectCause;Ljava/lang/String;Z)Ljava/lang/CharSequence;
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p1}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updateLayoutForCallState(I)V
    :try_end_0
    ...
    iget v3, v0, Lcom/android/incallui/fragment/VideoCallCardFragment;->mOldCallState:I
    ...
    iget-object v3, v0, Lcom/android/incallui/fragment/VideoCallCardFragment;->mCallStateLabel:Landroid/widget/TextView;
    ...
    const-string v3, "skip setCallState : not update in idle state"
    ...
    iget-object v3, v0, Lcom/android/incallui/fragment/VideoCallCardFragment;->mEndCallContactBtn:Landroid/widget/Button;
    ...
    invoke-static {v15}, Lcom/android/incallui/util/CallTypeUtils;->isVoiceCall(Lcom/android/incallui/Call;)Z

    move-result v3

    if-eqz v3, :cond_4

    const-string v3, "skip setCallState : not update in incoming voice call"
    ...
    invoke-virtual {v0, v3}, Lcom/android/incallui/fragment/VideoCallCardFragment;->setVisible(Z)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/incallui/fragment/VideoCallCardFragment;->getView()Landroid/view/View;
    ...
    iget-object v3, v14, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->callMessage:Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lcom/android/incallui/fragment/VideoCallCardFragment;->setCnapName(Ljava/lang/String;)V
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updateCnapVisibleForCallState(I)V
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updateCdnipVisibleForCallState(I)V
    ...
    invoke-direct {v0, v1, v11, v2}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updateCallStateLabelForCallState(ILjava/lang/CharSequence;Landroid/graphics/drawable/Drawable;)V

    invoke-virtual/range {p0 .. p1}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updateBgColorForCallState(I)V

    invoke-direct/range {p0 .. p1}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updatePhotoViewForCallState(I)V

    invoke-virtual/range {p0 .. p1}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updatePrimaryVisibleForCallState(I)V

    invoke-virtual/range {p0 .. p1}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updateTextColor(I)V

    invoke-virtual/range {p0 .. p1}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updateIncomingHideShowButtonForCallState(I)V

    invoke-virtual/range {p0 .. p0}, Lcom/android/incallui/fragment/VideoCallCardFragment;->isInMultiWindowMode()Z

    move-result v3

    if-nez v3, :cond_9

    sget-boolean v3, Lcom/android/incallui/fragment/VideoCallCardFragment;->mIsInMultiWindowMode:Z
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/incallui/fragment/VideoCallCardFragment;->getResources()Landroid/content/res/Resources;
    ...
    iget v3, v12, Landroid/content/res/Configuration;->screenWidthDp:I

    iget v4, v12, Landroid/content/res/Configuration;->screenHeightDp:I

    move-object/from16 v0, p0

    invoke-direct {v0, v3, v4}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updateHideMeLayoutForMultiWindow(II)V
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updateKTTwoPhoneLayout(I)V
    ...
    iget-object v3, v0, Lcom/android/incallui/fragment/VideoCallCardFragment;->mElapsedTime:Landroid/widget/TextView;
    ...
    iput v0, v1, Lcom/android/incallui/fragment/VideoCallCardFragment;->mOldCallState:I

    goto/16 :goto_2

    :cond_d
    iget-object v3, v14, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->message:Ljava/lang/String;
...
.method public setPrimary(Ljava/lang/String;Ljava/lang/String;ZZZLcom/android/incallui/ContactInfoCache$ContactCacheEntry;Z)V
    ...
    const-string v9, "VideoCallCardFragment"

    const-string v10, "Setting primary call"
    ...
    iget-object v2, v0, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->gifPhoto:Lcom/android/incallui/gif/GifDrawable;
    ...
    invoke-direct {p0, v0}, Lcom/android/incallui/fragment/VideoCallCardFragment;->getConferencePhoto(Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v9, p0, Lcom/android/incallui/fragment/VideoCallCardFragment;->mCallNumberAndLabel:Landroid/view/View;
    ...
    invoke-virtual {p0, v5}, Lcom/android/incallui/fragment/VideoCallCardFragment;->setPrimaryLabel(Ljava/lang/String;)V

    if-eqz v2, :cond_e

    invoke-virtual {p0, v2}, Lcom/android/incallui/fragment/VideoCallCardFragment;->setPrimaryGifImage(Lcom/android/incallui/gif/GifDrawable;)V
    ...
    invoke-virtual {p0, v9}, Lcom/android/incallui/fragment/VideoCallCardFragment;->setCnapName(Ljava/lang/String;)V

    invoke-virtual {v7}, Lcom/android/incallui/Call;->getState()I

    move-result v9

    invoke-virtual {p0, v9}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updateCnapVisibleForCallState(I)V
    ...
    invoke-virtual {p0, v9}, Lcom/android/incallui/fragment/VideoCallCardFragment;->setCdnipNumber(Ljava/lang/String;)V

    invoke-virtual {v7}, Lcom/android/incallui/Call;->getState()I

    move-result v9

    invoke-virtual {p0, v9}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updateCdnipVisibleForCallState(I)V
    ...
    invoke-virtual {p0, v9, v10}, Lcom/android/incallui/fragment/VideoCallCardFragment;->updatePrimaryCallElapsedTimeArea(ZLjava/lang/String;)V
    ...
    iget-object v9, v1, Lcom/android/incallui/coreapps/CoreAppsContact;->name:Ljava/lang/String;
    ...
    iget-object p2, v1, Lcom/android/incallui/coreapps/CoreAppsContact;->name:Ljava/lang/String;

    const/4 p3, 0x0

    :cond_9
    iget-object v9, v1, Lcom/android/incallui/coreapps/CoreAppsContact;->drawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v6, v3}, Lcom/android/incallui/fragment/VideoCallCardFragment;->setPrimaryImage(Landroid/graphics/drawable/Drawable;Z)V
...
.method public setPrimaryGifImage(Lcom/android/incallui/gif/GifDrawable;)V
    ...
    :cond_2
    iget-object v2, p0, Lcom/android/incallui/fragment/VideoCallCardFragment;->mPhoto:Landroid/widget/ImageView;

    invoke-direct {p0, v2, p1}, Lcom/android/incallui/fragment/VideoCallCardFragment;->setGifDrawableToImageView(Landroid/widget/ImageView;Lcom/android/incallui/gif/GifDrawable;)Z
...
.method protected updateView()V
    ...
    iput-object v3, p0, Lcom/android/incallui/fragment/VideoCallCardFragment;->mDisplay:Landroid/view/Display;
    ...
    iput v3, p0, Lcom/android/incallui/fragment/VideoCallCardFragment;->activityWidth:I

    iget v3, v2, Landroid/util/DisplayMetrics;->heightPixels:I

    iput v3, p0, Lcom/android/incallui/fragment/VideoCallCardFragment;->activityHeight:I
