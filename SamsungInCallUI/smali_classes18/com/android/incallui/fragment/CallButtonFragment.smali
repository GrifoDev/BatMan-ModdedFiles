...
.method public constructor <init>()V
    ...
    iput v2, p0, Lcom/android/incallui/fragment/CallButtonFragment;->INCALL_MARGIN_UPPER_TOP:F

    const v0, 0x3f4ccccd    # 0.8f

    iput v0, p0, Lcom/android/incallui/fragment/CallButtonFragment;->INCALL_MARGIN_UNDER_TOP:F

    iput v2, p0, Lcom/android/incallui/fragment/CallButtonFragment;->INCALL_MARGIN_ENDCALL_TOP:F
    ...
    iput v1, p0, Lcom/android/incallui/fragment/CallButtonFragment;->INCALL_HORIZONTAL_TABLET_SIDE_MARGIN:F

    const v0, 0x3cf5c28f    # 0.03f

    iput v0, p0, Lcom/android/incallui/fragment/CallButtonFragment;->ENDCALL_HORIZONTAL_SIDE_MARGIN:F

    iput v1, p0, Lcom/android/incallui/fragment/CallButtonFragment;->ENDCALL_HORIZONTAL_TABLET_SIDE_MARGIN:F
...
.method private manageBluetoothClicked()V
    ...
    invoke-virtual {v2}, Lcom/android/incallui/CallButtonPresenter;->getCall()Lcom/android/incallui/Call;

    move-result-object v2

    invoke-static {v2}, Lcom/android/incallui/util/SecCallExtraUtils;->wasVTSpeakerOn(Lcom/android/incallui/Call;)Z

    move-result v2

    if-nez v2, :cond_0

    invoke-virtual {p0, v4}, Lcom/android/incallui/fragment/CallButtonFragment;->setAudioMode(I)V
...
.method public getUpperViewMarginTop()I
    ...
    iget-object v1, p0, Lcom/android/incallui/fragment/CallButtonFragment;->mInCallButtonsUpper:Landroid/view/ViewGroup;
...
.method public getVoiceCallButtonsGap()I
    ...
    iget-object v2, p0, Lcom/android/incallui/fragment/CallButtonFragment;->mInCallButtonsUpper:Landroid/view/ViewGroup;

    if-eqz v2, :cond_0

    iget-object v2, p0, Lcom/android/incallui/fragment/CallButtonFragment;->mInCallButtonsUnder:Landroid/view/ViewGroup;
    ...
    iget-object v3, p0, Lcom/android/incallui/fragment/CallButtonFragment;->mInCallButtonsUpper:Landroid/view/ViewGroup;
...
.method public updateHorizontalMargin(Landroid/view/ViewGroup;)V
    ...
    :cond_1
    const-string v6, "CallButtonFragment"

    const-string v7, "updateHorizontalMargin"
    ...
    invoke-virtual {v6}, Lcom/android/incallui/UiAdapter;->getContentViewSize()Landroid/graphics/Point;
    ...
    iget v7, p0, Lcom/android/incallui/fragment/CallButtonFragment;->INCALL_HORIZONTAL_TABLET_SIDE_MARGIN:F
    ...
    const-string v8, "updateHorizontalMargin parentViewWidth = "
    ...
    iget v7, p0, Lcom/android/incallui/fragment/CallButtonFragment;->INCALL_HORIZONTAL_SIDE_MARGIN:F
    ...
    iget v7, p0, Lcom/android/incallui/fragment/CallButtonFragment;->INCALL_HORIZONTAL_MW_MARGIN_SUM:F
    ...
    const-string v8, "updateHorizontalMargin childView = "
    ...
    const-string v8, "updateHorizontalMargin last childView = "
...
.method public updateNavigationBar()V
    ...
    iget-object v4, p0, Lcom/android/incallui/fragment/CallButtonFragment;->mNavigationBarArea:Landroid/view/View;
...
.method public updateVerticalMargin(Landroid/view/View;Landroid/view/ViewGroup;Landroid/view/ViewGroup;Landroid/view/View;)V
    ...
    invoke-virtual {v11}, Lcom/android/incallui/UiAdapter;->getContentViewSize()Landroid/graphics/Point;
    ...
    invoke-static {v11}, Lcom/android/incallui/util/ScreenControlUtils;->hasNavigationBar(Landroid/content/Context;)Z
    ...
    invoke-static {v11}, Lcom/android/incallui/util/ScreenControlUtils;->getNavigationBarHeight(Landroid/content/Context;)I
    ...
    iget v12, p0, Lcom/android/incallui/fragment/CallButtonFragment;->INCALL_BUTTON_SCALE:F
    ...
    iget v12, p0, Lcom/android/incallui/fragment/CallButtonFragment;->INCALL_MARGIN_ENDCALL_BOTTOM:F
    ...
    iget v12, p0, Lcom/android/incallui/fragment/CallButtonFragment;->INCALL_VERTICAL_MARGIN_SUM:F

    div-float v7, v11, v12

    const-string v11, "CallButtonFragment"
    ...
    iget v11, p0, Lcom/android/incallui/fragment/CallButtonFragment;->INCALL_MARGIN_UPPER_TOP:F
    ...
    iget v11, p0, Lcom/android/incallui/fragment/CallButtonFragment;->INCALL_MARGIN_UNDER_TOP:F
