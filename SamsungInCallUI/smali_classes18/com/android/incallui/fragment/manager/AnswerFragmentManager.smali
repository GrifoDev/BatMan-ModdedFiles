...
.method protected checkAndSet(Z)Lcom/android/incallui/fragment/AnswerFragment;
    ...
    iget-object v5, p0, Lcom/android/incallui/fragment/manager/AnswerFragmentManager;->mInCallActivity:Lcom/android/incallui/InCallActivity;
    ...
    const-string v5, "AnswerFragmentManager - fragment is gone"
    ...
    invoke-virtual {v5}, Lcom/android/incallui/fragment/AnswerFragment;->getView()Landroid/view/View;
    ...
    iput-object v4, p0, Lcom/android/incallui/fragment/manager/AnswerFragmentManager;->mFragmentType:Ljava/lang/Enum;
    ...
    :cond_5
    sget-object v3, Lcom/android/incallui/fragment/manager/AnswerFragmentManager$FragmentMode;->DEFAULT:Lcom/android/incallui/fragment/manager/AnswerFragmentManager$FragmentMode;
    ...
    sget-object v3, Lcom/android/incallui/fragment/manager/AnswerFragmentManager$FragmentMode;->THREE_WIDGET:Lcom/android/incallui/fragment/manager/AnswerFragmentManager$FragmentMode;

    :cond_6
    if-nez p1, :cond_7

    iget-object v4, p0, Lcom/android/incallui/fragment/manager/AnswerFragmentManager;->mFragmentType:Ljava/lang/Enum;

    if-eq v4, v3, :cond_8

    :cond_7
    invoke-virtual {p0, v3, p1}, Lcom/android/incallui/fragment/manager/AnswerFragmentManager;->setFragment(Ljava/lang/Enum;Z)V

    iput-object v3, p0, Lcom/android/incallui/fragment/manager/AnswerFragmentManager;->mFragmentType:Ljava/lang/Enum;

    :cond_8
    iget-object v4, p0, Lcom/android/incallui/fragment/manager/AnswerFragmentManager;->mCurrentFragment:Lcom/android/incallui/fragment/AnswerFragment;
