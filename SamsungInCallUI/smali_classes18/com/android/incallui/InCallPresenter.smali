...
.method private attemptCleanup()V
    ...
    const-string v5, "attemptCleanup? "
    ...
    const-string v4, "support_smart_glow"
    ...
    iget-boolean v4, p0, Lcom/android/incallui/InCallPresenter;->isIncomingCall:Z
    ...
    const-string v2, "com.samsung.android.smartglow"
    ...
    :cond_2
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mContactInfoCache:Lcom/android/incallui/ContactInfoCache;
    ...
    :cond_3
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mProximitySensor:Lcom/android/incallui/ProximitySensor;

    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mAudioModeProvider:Lcom/android/incallui/AudioModeProvider;
    ...
    :cond_4
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mStatusBarNotifier:Lcom/android/incallui/StatusBarNotifier;
    ...
    :cond_5
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mCallList:Lcom/android/incallui/CallList;
    ...
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mAccessoryEventHandler:Lcom/android/incallui/accessory/AccessoryEventHandler;
    ...
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mContext:Landroid/content/Context;

    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mInCallActivity:Lcom/android/incallui/InCallActivity;
    ...
    invoke-virtual {v2, v4}, Lcom/android/incallui/InCallApp;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_4

    :goto_2
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mInCallReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mEpdgManager:Lcom/android/incallui/service/vt/EpdgManager;
    ...
    :goto_3
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mSmartAnswerBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    :goto_4
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mContactAgentReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v4, p0, Lcom/android/incallui/InCallPresenter;->mMirrorlinkStateReceiver:Landroid/content/BroadcastReceiver;
    ...
    :goto_5
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mMirrorlinkStateReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v4, p0, Lcom/android/incallui/InCallPresenter;->mCarmodeStateReceiver:Landroid/content/BroadcastReceiver;
    ...
    :goto_6
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mCarmodeStateReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mBluetoothProfileManager:Lcom/android/incallui/BluetoothProfileManager;
    ...
    :cond_e
    iget-object v2, p0, Lcom/android/incallui/InCallPresenter;->mAnswerMemoController:Lcom/android/incallui/operator/dcm/AnswerMemoController;

    if-eqz v2, :cond_f

    iget-object v2, p0, Lcom/android/incallui/InCallPresenter;->mAnswerMemoController:Lcom/android/incallui/operator/dcm/AnswerMemoController;

    invoke-virtual {v2}, Lcom/android/incallui/operator/dcm/AnswerMemoController;->cleanUp()V

    iput-object v6, p0, Lcom/android/incallui/InCallPresenter;->mAnswerMemoController:Lcom/android/incallui/operator/dcm/AnswerMemoController;
    ...
    iput v3, p0, Lcom/android/incallui/InCallPresenter;->mKnoxCustomDisabledItems:I
    ...
    invoke-virtual {v2}, Lcom/android/incallui/util/DesktopModeManager;->tearDown()V
    ...
    invoke-static {v2}, Lcom/android/incallui/util/SALogging;->unregisterTelecommSALoggingReceiver(Landroid/content/Context;)Z

    const-string v2, "Finished InCallPresenter.CleanUp"
...
.method private needToSkipUpdateForAnim()Z
    ...
    const-string v2, "needToSkipUpdateForAnim: isAnswerAnimationRunning"
    ...
    invoke-virtual {v3}, Lcom/android/incallui/InCallActivity;->isShrinkBackgroundRunning()Z

    move-result v3

    if-eqz v3, :cond_3

    const-string v2, "needToSkipUpdateForAnim: isShrinkBackgroundRunning"
...
.method private processOnCallListChange(Lcom/android/incallui/CallList;)V
    ...
    iput v10, p0, Lcom/android/incallui/InCallPresenter;->mFirstCallState:I
    ...
    const-string v4, "send nuber to crane for MO Dial"
    ...
    invoke-static {v4, v0, v5}, Lcom/android/incallui/secrcs/RcsShareUI;->sendPhoneNumberBroadcast(Landroid/content/Context;Lcom/android/incallui/Call;Ljava/lang/String;)V
...
.method public getInCallActivityOptions()Landroid/os/Bundle;
    ...
    const-string v8, "getInCallActivityOptions - set ps video call hd720p window size"

    invoke-static {v8}, Lcom/android/incallui/service/vt/VideoCallLog;->flow(Ljava/lang/String;)V
    ...
    const-string v9, "getInCallActivityOptions posX = "
    ...
    invoke-virtual {v4, v8}, Landroid/app/ActivityOptions;->setLaunchBounds(Landroid/graphics/Rect;)Landroid/app/ActivityOptions;
    ...
    :cond_1
    const-string v8, "getInCallActivityOptions - set ps video call vga window size"
...
.method public getTargetClass()Ljava/lang/Class;
    ...
    iget-boolean v2, p0, Lcom/android/incallui/InCallPresenter;->mEmergencyCall:Z

    if-eqz v2, :cond_0

    const-string v2, "panic_mode_swa"
    ...
    const-class v2, Lcom/android/incallui/PinPanicDummyActivity;
...
.method public handleRcsAction(Ljava/lang/String;)V
    ...
    const-string v5, "com.samsung.rcs.intent.action.SPEAKER_OFFF"
    ...
    const-string v5, "com.samsung.rcs.intent.action.SPEAKER_ONN"
    ...
    const-string v5, "com.samsung.rcs.intent.action.MUTE_ONN"
    ...
    const-string v5, "com.samsung.rcs.intent.action.MUTE_OFFF"
    ...
    const-string v5, "com.samsung.rcs.intent.action.END_CALLL"
...
.method public minimizeOtherWindows()V
    ...
    const-string v1, "Minimize other popup window"
...
.method public onCallListChange(Lcom/android/incallui/CallList;)V
    ...
    const-string v19, "onCallListChange: start"
    ...
    iget-object v15, v0, Lcom/android/incallui/InCallPresenter;->mInCallState:Lcom/android/incallui/InCallPresenter$InCallState;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/incallui/InCallPresenter;->isFromPopupForAnswer()Z
    ...
    invoke-virtual/range {v19 .. v20}, Lcom/android/incallui/InCallActivity;->setIsFromPopupForAnswer(Z)V
    ...
    invoke-virtual {v0, v6, v15, v14}, Lcom/android/incallui/InCallPresenter;->startContactInfoSearch(Lcom/android/incallui/Call;Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/InCallPresenter$InCallState;)V
    ...
    new-instance v18, Lcom/android/incallui/InCallPresenter$8;

    move-object/from16 v0, v18

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/incallui/InCallPresenter$8;-><init>(Lcom/android/incallui/InCallPresenter;)V
    ...
    :cond_5
    :goto_2
    invoke-direct/range {p0 .. p0}, Lcom/android/incallui/InCallPresenter;->needToSkipUpdateForAnim()Z
    ...
    invoke-virtual {v0, v14}, Lcom/android/incallui/InCallPresenter;->startOrFinishUi(Lcom/android/incallui/InCallPresenter$InCallState;)Lcom/android/incallui/InCallPresenter$InCallState;
    ...
    iput-object v14, v0, Lcom/android/incallui/InCallPresenter;->mInCallState:Lcom/android/incallui/InCallPresenter$InCallState;
    ...
    :cond_9
    invoke-virtual/range {p0 .. p0}, Lcom/android/incallui/InCallPresenter;->isNormalWindow()Z
    ...
    invoke-static {v4, v0}, Lcom/android/incallui/util/ScreenControlUtils;->showNavigationBar(Landroid/app/Activity;Z)V
    ...
    iget-boolean v0, v9, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->hide_status:Z

    move/from16 v19, v0

    if-nez v19, :cond_c

    iget-boolean v0, v9, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->isChangedHideStatus:Z
    ...
    iput-boolean v0, v9, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->hide_status:Z

    const/16 v19, 0x0

    move/from16 v0, v19

    iput-boolean v0, v9, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->isChangedHideStatus:Z
    ...
    invoke-virtual {v13}, Lcom/android/incallui/Call;->isEmergencyCall()Z
    ...
    invoke-virtual {v0, v5}, Lcom/android/incallui/InCallPresenter;->sendLockScreenEvent(Z)V
    ...
    const-string v20, "onCallListChange state Incoming "
    ...
    sput-boolean v19, Lcom/android/incallui/secrcs/RcsShareUI;->isMT:Z
    ...
    const-string v20, "onCallListChange: "
    ...
    check-cast v12, Lcom/android/incallui/InCallPresenter$InCallStateListener;
    ...
    invoke-interface {v12, v15, v0, v1}, Lcom/android/incallui/InCallPresenter$InCallStateListener;->onStateChange(Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/CallList;)V
    ...
    invoke-virtual {v0, v10}, Lcom/android/incallui/InCallActivity;->dismissKeyguard(Z)V
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/incallui/CallList;->hasLiveCallToDisplay()Z
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/incallui/util/SystemServiceUtils;->boostCPU(Landroid/content/Context;)V
    ...
    invoke-virtual/range {v19 .. v20}, Lcom/android/incallui/InCallActivity;->animateForShrinkBackground(Z)V
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/incallui/InCallActivity;->updateGradientBackground()V
    ...
    invoke-virtual {v0, v1, v3}, Lcom/android/incallui/secrcs/RcsInvitation;->updateState(Landroid/content/Context;Lcom/android/incallui/Call;)V
    ...
    invoke-virtual {v0, v6}, Lcom/android/incallui/InCallPresenter;->handoverFailNotification(Lcom/android/incallui/Call;)V

    :cond_31
    const-string v19, "onCallListChange: end"
...
.method public onIncomingCall(Lcom/android/incallui/Call;)V
    ...
    invoke-virtual {v4, p1, v1}, Lcom/android/incallui/bike/BikeModeController;->onIncomingCallConsumed(Lcom/android/incallui/Call;I)Z
    ...
    invoke-virtual {v4}, Lcom/android/incallui/InCallActivity;->dismissDataUsageLimitDialog()V
    ...
    const-string v5, "onIncomingCall : "
    ...
    invoke-virtual {p0, p1, v3, v2}, Lcom/android/incallui/InCallPresenter;->startContactInfoSearch(Lcom/android/incallui/Call;Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/InCallPresenter$InCallState;)V
    ...
    iget-object v4, p0, Lcom/android/incallui/InCallPresenter;->mCoverViewManager:Lcom/android/incallui/accessory/CoverViewManager;
    ...
    invoke-virtual {p0, v4}, Lcom/android/incallui/InCallPresenter;->onCoverStateChanged(Z)V
    ...
    invoke-interface {v0, v3, v5, p1}, Lcom/android/incallui/InCallPresenter$IncomingCallListener;->onIncomingCall(Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/Call;)V
    ...
    invoke-static {v4}, Lcom/android/incallui/util/InCallUtils;->isEcholocateEnabled(Ljava/lang/String;)Z
    ...
    invoke-static {v4}, Lcom/android/incallui/util/InCallUtils;->sendEcholocateUIState(I)V
    ...
    invoke-virtual {v4, v5}, Lcom/android/incallui/InCallActivity;->setStatusBar(Z)V
...
.method public onReceivedMessageFromTelecom(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/android/incallui/util/SystemServiceUtils;->pokeUserActivity(Landroid/content/Context;)V
...
.method public setUp(Landroid/content/Context;Lcom/android/incallui/CallList;Lcom/android/incallui/AudioModeProvider;Lcom/android/incallui/StatusBarNotifier;Lcom/android/incallui/ContactInfoCache;Lcom/android/incallui/ProximitySensor;)V
    ...
    const-string v4, "com.samsung.systemui.statusbar.STARTED"
    ...
    iget-object v4, p0, Lcom/android/incallui/InCallPresenter;->mAnswerMemoController:Lcom/android/incallui/operator/dcm/AnswerMemoController;

    if-nez v4, :cond_13

    new-instance v4, Lcom/android/incallui/operator/dcm/AnswerMemoController;

    iget-object v6, p0, Lcom/android/incallui/InCallPresenter;->mContext:Landroid/content/Context;

    invoke-direct {v4, v6}, Lcom/android/incallui/operator/dcm/AnswerMemoController;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/incallui/InCallPresenter;->mAnswerMemoController:Lcom/android/incallui/operator/dcm/AnswerMemoController;
    ...
    iget-object v6, p0, Lcom/android/incallui/InCallPresenter;->mContactUpdateObserver:Landroid/database/ContentObserver;

    invoke-static {v4, v5, v6}, Lcom/android/incallui/InCallPresenter;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V
...
.method public startContactInfoSearch(Lcom/android/incallui/Call;Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/InCallPresenter$InCallState;)V
    ...
    :cond_0
    const-string v6, "perf - startContactInfoSearch"
    ...
    const-string v6, "skip startContactInfoSearch - querystarted"
    ...
    invoke-virtual {v0, v6}, Lcom/android/incallui/ContactInfoCache;->getInfo(Ljava/lang/String;)Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;

    move-result-object v2

    if-eqz v2, :cond_2

    iget-boolean v6, v2, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->queryCompleted:Z

    if-eqz v6, :cond_2

    const-string v6, "skip startContactInfoSearch - query completed"
    ...
    invoke-virtual {v6}, Lcom/android/incallui/CallList;->getRedialCall()Lcom/android/incallui/Call;
    ...
    const-string v7, "startContactInfoSearch"
    ...
    const-string v6, "skip startContactInfoSearch - number is same with previous call"
    ...
    invoke-virtual {v0, v6, v3}, Lcom/android/incallui/ContactInfoCache;->putContactInfoCache(Ljava/lang/String;Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;)V
    ...
    invoke-virtual {v6, v9}, Lcom/android/incallui/CallList;->setRedialCall(Lcom/android/incallui/Call;)V
    ...
    new-instance v7, Lcom/android/incallui/InCallPresenter$ContactInfoCallback;

    invoke-direct {v7, p0, v9}, Lcom/android/incallui/InCallPresenter$ContactInfoCallback;-><init>(Lcom/android/incallui/InCallPresenter;Lcom/android/incallui/InCallPresenter$1;)V

    invoke-virtual {v0, p1, v6, v7}, Lcom/android/incallui/ContactInfoCache;->findInfo(Lcom/android/incallui/Call;ZLcom/android/incallui/ContactInfoCache$ContactInfoCacheCallback;)V
...
.method public startOrFinishUi(Lcom/android/incallui/InCallPresenter$InCallState;)Lcom/android/incallui/InCallPresenter$InCallState;
    ...
    const-string v13, "startOrFinishUi: "
    ...
    iget-object v12, v0, Lcom/android/incallui/InCallPresenter;->mInCallState:Lcom/android/incallui/InCallPresenter$InCallState;
    ...
    iget-object v12, v0, Lcom/android/incallui/InCallPresenter;->mContext:Landroid/content/Context;

    invoke-static {v12}, Lcom/android/incallui/wrapper/KnoxCustomManagerWrapper;->getCallScreenDisabledItems(Landroid/content/Context;)I

    move-result v12

    move-object/from16 v0, p0

    iput v12, v0, Lcom/android/incallui/InCallPresenter;->mKnoxCustomDisabledItems:I

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string v13, "startOrFinishUi: mKnoxCustomDisabledItems = "
    ...
    iget v13, v0, Lcom/android/incallui/InCallPresenter;->mKnoxCustomDisabledItems:I
    ...
    invoke-virtual {v12}, Lcom/android/incallui/InCallApp;->isLocked()Z
    ...
    invoke-virtual {v12}, Lcom/android/incallui/InCallApp;->unlock()V
    ...
    const-string v12, "kids mode is running, return"
    ...
    iget-object v12, v0, Lcom/android/incallui/InCallPresenter;->mInCallActivity:Lcom/android/incallui/InCallActivity;
    ...
    invoke-virtual {v12}, Lcom/android/incallui/InCallActivity;->finish()V
    ...
    const-string v12, "car mode is running, return"
    ...
    iget-object v12, v0, Lcom/android/incallui/InCallPresenter;->mBikeModeController:Lcom/android/incallui/bike/BikeModeController;
    ...
    invoke-virtual {v12, v0}, Lcom/android/incallui/bike/BikeModeController;->startOrFinishUiConsumed(Lcom/android/incallui/InCallPresenter$InCallState;)Z
    ...
    sget-object v13, Lcom/android/incallui/InCallPresenter$InCallState;->PENDING_OUTGOING:Lcom/android/incallui/InCallPresenter$InCallState;
    ...
    invoke-virtual {v12}, Lcom/android/incallui/CallList;->getLiveCallCounts()I
    ...
    const-string v13, "alreadyOutgoing: "
    ...
    :cond_6
    sget-object v12, Lcom/android/incallui/InCallPresenter$InCallState;->WAITING_FOR_ACCOUNT:Lcom/android/incallui/InCallPresenter$InCallState;

    move-object/from16 v0, p1

    if-eq v12, v0, :cond_7

    sget-object v12, Lcom/android/incallui/InCallPresenter$InCallState;->WAITING_FOR_SIM_ACCOUNT:Lcom/android/incallui/InCallPresenter$InCallState;
    ...
    iget-object v12, v0, Lcom/android/incallui/InCallPresenter;->mCallPopupService:Lcom/android/incallui/service/SecCallPopupService;
    ...
    const-string v12, "rich_call_screen_cmcc"
    ...
    iget-object v12, v0, Lcom/android/incallui/InCallPresenter;->mCallList:Lcom/android/incallui/CallList;

    invoke-virtual {v12}, Lcom/android/incallui/CallList;->getIncomingCall()Lcom/android/incallui/Call;
    ...
    const-string v13, "RichScreenApp: getRichScreen:"
    ...
    new-instance v6, Lcom/android/incallui/richscreen/RichCallScreenUtils;

    invoke-direct {v6}, Lcom/android/incallui/richscreen/RichCallScreenUtils;-><init>()V

    invoke-virtual {v8}, Lcom/android/incallui/Call;->getNumber()Ljava/lang/String;

    move-result-object v12

    const-string v13, "1110000000"

    invoke-virtual {v6, v12, v13}, Lcom/android/incallui/richscreen/RichCallScreenUtils;->getRichCallScreenPersonObject(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v12}, Lcom/android/incallui/CallList;->getPendingOutgoingCall()Lcom/android/incallui/Call;

    move-result-object v12

    invoke-static {v12}, Lcom/android/incallui/InCallPresenter;->isCallWithNoValidAccounts(Lcom/android/incallui/Call;)Z
    ...
    const-string v13, "Undo the state change: "
    ...
    invoke-static {v0, v12}, Lcom/android/incallui/Log;->i(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-virtual {v12}, Lcom/android/incallui/CallList;->getOutgoingCall()Lcom/android/incallui/Call;
    ...
    invoke-virtual {v12}, Lcom/android/incallui/CallList;->getActiveCall()Lcom/android/incallui/Call;
    ...
    :cond_1e
    const-string v12, "perf - Start in call UI"

    const/4 v13, 0x1

    move-object/from16 v0, p0

    invoke-static {v0, v12, v13}, Lcom/android/incallui/Log;->i(Ljava/lang/Object;Ljava/lang/String;Z)V

    invoke-static {}, Lcom/android/incallui/CallList;->getInstance()Lcom/android/incallui/CallList;

    move-result-object v12

    invoke-virtual {v12}, Lcom/android/incallui/CallList;->clearDisconnectedTimeoutEvent()Z
    ...
    invoke-virtual {v0, v13, v12}, Lcom/android/incallui/InCallPresenter;->showInCall(ZZ)V

    invoke-direct/range {p0 .. p0}, Lcom/android/incallui/InCallPresenter;->checkAndMinimizeOtherWindows()V

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/incallui/InCallPresenter;->mContext:Landroid/content/Context;

    const-string v14, "com.android.incallui"
    ...
    invoke-static {v13, v14, v12, v15}, Lcom/android/incallui/util/AppLogging;->insertLog(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v12, "perf - Start Full Screen in call UI"
    ...
    invoke-virtual {v12}, Lcom/android/incallui/InCallActivity;->dismissPendingDialogs()V
    ...
    iget-object v12, v0, Lcom/android/incallui/InCallPresenter;->mSubNumberDialog:Lcom/android/incallui/util/SecSubNumberDialogActivity;
    ...
    invoke-virtual {v12}, Lcom/android/incallui/util/SecSubNumberDialogActivity;->finish()V
    ...
    invoke-static {v4}, Lcom/android/incallui/util/CallTypeUtils;->isVideoCall(Lcom/android/incallui/Call;)Z
    ...
    const-string v12, "finish InCallActivity when incoming call in the tphone mode"

    move-object/from16 v0, p0

    invoke-static {v0, v12}, Lcom/android/incallui/Log;->w(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-virtual {v13}, Lcom/android/incallui/InCallApp;->getAppVerionName()Ljava/lang/String;
...
.method public updateContactInfo()V
    ...
    iget-boolean v5, v2, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->queryCompleted:Z

    if-eqz v5, :cond_0

    :cond_2
    const-string v5, "updateContactInfo()"

    invoke-static {p0, v5}, Lcom/android/incallui/Log;->d(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {p0, v1}, Lcom/android/incallui/InCallPresenter;->startContactInfoSearchCache(Lcom/android/incallui/Call;)V

    iget-object v5, p0, Lcom/android/incallui/InCallPresenter;->mUpdateContactListener:Ljava/util/Set;
    ...
    check-cast v3, Lcom/android/incallui/InCallPresenter$UpdateContactListener;

    invoke-interface {v3}, Lcom/android/incallui/InCallPresenter$UpdateContactListener;->onContactChanged()V
