...
.method private createLaunchPendingIntent(Z)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v5, v6, v6}, Lcom/android/incallui/InCallPresenter;->getInCallIntent(ZZ)Landroid/content/Intent;
    ...
    invoke-virtual {v5}, Lcom/android/incallui/InCallPresenter;->getInCallActivityOptions()Landroid/os/Bundle;
    ...
    invoke-static {v5, v6, v3, v1, v4}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;ILandroid/os/Bundle;)Landroid/app/PendingIntent;
    :try_end_0
    ...
    const-string v6, "createLaunchPendingIntent() - NullPointerException"
...
.method public registerRejectCallNotification(Z)V
    ...
    invoke-static {v9, v13, v8}, Lcom/android/incallui/util/InCallUtils;->getCallToDisplay(Lcom/android/incallui/CallList;Lcom/android/incallui/Call;Z)Lcom/android/incallui/Call;
    ...
    const-string v9, "support_sassistant"
    ...
    const-string v7, "StatusBarNotifier"

    const-string v8, "The rejected call notification was hide."
    ...
    invoke-virtual {v9, v13, v7}, Landroid/app/Notification$Builder;->setFullScreenIntent(Landroid/app/PendingIntent;Z)Landroid/app/Notification$Builder;

    move-result-object v9

    const-string v10, "com.samsung.android.incallui.ACTION_DELETE_REJECT_NOTIFICATION"

    invoke-direct {p0, v10, v2}, Lcom/android/incallui/StatusBarNotifier;->createNotificationPendingIntent(Ljava/lang/String;Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v9, v7}, Landroid/app/Notification$Builder;->setAutoCancel(Z)Landroid/app/Notification$Builder;

    invoke-static {}, Lcom/android/incallui/CallList;->getInstance()Lcom/android/incallui/CallList;

    move-result-object v7

    invoke-virtual {v7, v1}, Lcom/android/incallui/CallList;->isConferenceCall(Lcom/android/incallui/Call;)Z

    move-result v7

    invoke-direct {p0, v3, v7}, Lcom/android/incallui/StatusBarNotifier;->getContentTitle(Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;Z)Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v0, v7}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    invoke-direct {p0, v1, v3}, Lcom/android/incallui/StatusBarNotifier;->getLargeIconForRejectedCall(Lcom/android/incallui/Call;Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;)Landroid/graphics/Bitmap;
    ...
    const-string v9, "com.samsung.android.incallui.ACTION_VOICE_CALL"

    invoke-direct {p0, v9, v2}, Lcom/android/incallui/StatusBarNotifier;->createNotificationPendingIntent(Ljava/lang/String;Ljava/lang/String;)Landroid/app/PendingIntent;

    move-result-object v9

    invoke-virtual {v0, v8, v7, v9}, Landroid/app/Notification$Builder;->addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/incallui/StatusBarNotifier;->createPendingIntentForSReminder(Ljava/lang/String;Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;)Landroid/app/PendingIntent;
    ...
    iget-object v7, p0, Lcom/android/incallui/StatusBarNotifier;->mHandler:Landroid/os/Handler;
    ...
    const-string v8, "registerRejectCallNotification"

    invoke-static {v7, v8}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v7, p0, Lcom/android/incallui/StatusBarNotifier;->mHandler:Landroid/os/Handler;

    invoke-virtual {v7, v12, v5}, Landroid/os/Handler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public updateNotificationAndLaunchIncomingCallUi(Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/CallList;)Z
    ...
    const-string v2, "perf - updateNotificationAndLaunchIncomingCallUi"
    ...
    invoke-virtual {p0, v5}, Lcom/android/incallui/StatusBarNotifier;->setBlockToUpdate(Z)V
