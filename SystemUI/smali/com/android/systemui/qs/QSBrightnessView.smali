...
.method public getAnimator()Lcom/android/systemui/qs/TouchAnimator;
    ...
    invoke-virtual {v1, v2, v6}, Lcom/android/systemui/tuner/TunerService;->getValue(Ljava/lang/String;I)I
    ...
    invoke-virtual {p0, v5}, Lcom/android/systemui/qs/QSBrightnessView;->setAlpha(F)V
...
.method public setBrightnessOnTop(Z)Z
    ...
    :goto_0
    invoke-virtual {v3, v4, v0}, Lcom/android/systemui/tuner/TunerService;->setValue(Ljava/lang/String;I)V
    ...
    invoke-static {v0, v3, v4, v5, v2}, Lcom/android/keyguard/util/GsimLogManager;->sendLog(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;)V
