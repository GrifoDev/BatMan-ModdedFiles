...
.method private getStatusBar()Z
    ...
    iput-object v1, p0, Lcom/android/systemui/cover/SViewCoverService;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    iget-object v1, p0, Lcom/android/systemui/cover/SViewCoverService;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    if-nez v1, :cond_1

    const-string/jumbo v1, "CoverUI"

    const-string/jumbo v2, "onCreate() - mStatusBar is null"
