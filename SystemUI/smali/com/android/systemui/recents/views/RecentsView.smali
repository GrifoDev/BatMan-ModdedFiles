...
.method static synthetic -get10(Lcom/android/systemui/recents/views/RecentsView;)Landroid/widget/TextView;
    .locals 1
...
.method static synthetic -get11(Lcom/android/systemui/recents/views/RecentsView;)Lcom/android/systemui/recents/views/RecentsTransitionHelper;
    .locals 1
...
.method static synthetic -get7(Lcom/android/systemui/recents/views/RecentsView;)Landroid/widget/Button;
    .locals 1
...
.method static synthetic -get8(Lcom/android/systemui/recents/views/RecentsView;)Landroid/widget/PopupMenu;
    .locals 1
...
.method static synthetic -get9(Lcom/android/systemui/recents/views/RecentsView;)Lcom/android/systemui/recents/model/TaskStack;
    .locals 1
...
.method static synthetic -wrap1(Lcom/android/systemui/recents/views/RecentsView;Lcom/android/systemui/recents/views/TaskView;)Landroid/graphics/Rect;
    .locals 1
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/activity/LaunchTaskEvent;)V
    ...
    invoke-virtual/range {v0 .. v9}, Lcom/android/systemui/recents/views/RecentsTransitionHelper;->launchTaskFromRecents(Lcom/android/systemui/recents/model/TaskStack;Lcom/android/systemui/recents/model/Task;Lcom/android/systemui/recents/views/TaskStackView;Lcom/android/systemui/recents/views/TaskView;ZLandroid/graphics/Rect;IZZ)V
...
.method public setRecentsContainerView(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)V
    ...
    iget-object v3, p0, Lcom/android/systemui/recents/views/RecentsView;->mRecentsMoreButton:Landroid/widget/ImageButton;

    invoke-direct {v1, v2, v3}, Landroid/widget/PopupMenu;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v1, p0, Lcom/android/systemui/recents/views/RecentsView;->mRecentsMoreMenu:Landroid/widget/PopupMenu;

    iget-object v1, p0, Lcom/android/systemui/recents/views/RecentsView;->mRecentsMoreMenu:Landroid/widget/PopupMenu;
    ...
    new-instance v2, Lcom/android/systemui/recents/views/RecentsView$12;

    invoke-direct {v2, p0}, Lcom/android/systemui/recents/views/RecentsView$12;-><init>(Lcom/android/systemui/recents/views/RecentsView;)V
    ...
    iput-object v1, p0, Lcom/android/systemui/recents/views/RecentsView;->mLockEditDoneButton:Landroid/widget/Button;

    iget-object v1, p0, Lcom/android/systemui/recents/views/RecentsView;->mLockEditDoneButton:Landroid/widget/Button;

    new-instance v2, Lcom/android/systemui/recents/views/RecentsView$13;

    invoke-direct {v2, p0}, Lcom/android/systemui/recents/views/RecentsView$13;-><init>(Lcom/android/systemui/recents/views/RecentsView;)V
    ...
    iput-object v1, p0, Lcom/android/systemui/recents/views/RecentsView;->mLockEditCancelButton:Landroid/widget/Button;

    iget-object v1, p0, Lcom/android/systemui/recents/views/RecentsView;->mLockEditCancelButton:Landroid/widget/Button;

    new-instance v2, Lcom/android/systemui/recents/views/RecentsView$14;

    invoke-direct {v2, p0}, Lcom/android/systemui/recents/views/RecentsView$14;-><init>(Lcom/android/systemui/recents/views/RecentsView;)V
...
.method public updateRecentsContainerLayout()V
    ...
    invoke-virtual {v2, v4}, Lcom/android/systemui/recents/misc/SystemServicesProxy;->getStableInsets(Landroid/graphics/Rect;)V
