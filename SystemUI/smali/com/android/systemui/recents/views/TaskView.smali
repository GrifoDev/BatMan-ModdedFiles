...
.method synthetic lambda$-com_android_systemui_recents_views_TaskView_29765()V
    .locals 0
...
.method synthetic lambda$-com_android_systemui_recents_views_TaskView_37318()V
    .locals 0
...
.method synthetic lambda$-com_android_systemui_recents_views_TaskView_51578(Landroid/animation/ObjectAnimator;Lcom/android/systemui/recents/events/activity/LaunchTaskEvent;)V
    .locals 4
...
.method synthetic lambda$-com_android_systemui_recents_views_TaskView_57892()V
    .locals 1
...
.method synthetic lambda$-com_android_systemui_recents_views_TaskView_58305()V
    .locals 1
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-boolean v1, p0, Lcom/android/systemui/recents/views/TaskView;->mIsDisabledInSafeMode:Z
    ...
    iget-object v1, p0, Lcom/android/systemui/recents/views/TaskView;->mDisabledAppToast:Landroid/widget/Toast;
    ...
    :cond_0
    invoke-static {v12, v13, v5}, Landroid/widget/Toast;->makeText(Landroid/content/Context;Ljava/lang/CharSequence;I)Landroid/widget/Toast;

    move-result-object v1

    iput-object v1, p0, Lcom/android/systemui/recents/views/TaskView;->mDisabledAppToast:Landroid/widget/Toast;
    ...
    new-instance v2, Lcom/android/systemui/recents/events/activity/LaunchPairedTaskEvent;

    iget-object v3, p0, Lcom/android/systemui/recents/views/TaskView;->mTask:Lcom/android/systemui/recents/model/Task;

    invoke-direct {v2, v3}, Lcom/android/systemui/recents/events/activity/LaunchPairedTaskEvent;-><init>(Lcom/android/systemui/recents/model/Task;)V
    ...
    iget-object v1, p0, Lcom/android/systemui/recents/views/TaskView;->mRatioButtonIcon:Landroid/widget/ImageView;

    const/4 v2, 0x4

    invoke-virtual {v1, v2}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object v1, p0, Lcom/android/systemui/recents/views/TaskView;->mRatioButtonProgress:Landroid/widget/ProgressBar;
    ...
    invoke-static {v1, v2, v6}, Landroid/animation/ObjectAnimator;->ofInt(Ljava/lang/Object;Ljava/lang/String;[I)Landroid/animation/ObjectAnimator;
    ...
    invoke-virtual {v11, v8}, Landroid/animation/ObjectAnimator;->setRepeatCount(I)V

    invoke-virtual {v11, v8}, Landroid/animation/ObjectAnimator;->setRepeatMode(I)V
    ...
    new-instance v2, Lcom/android/systemui/recents/events/activity/RequestScreenRatioEvent;

    iget-object v3, p0, Lcom/android/systemui/recents/views/TaskView;->mTask:Lcom/android/systemui/recents/model/Task;

    new-instance v4, Lcom/android/systemui/recents/views/-$Lambda$zN5QXyPfvXVsTNl430beG2V9QjM$4;

    invoke-direct {v4, p0, v11, v0}, Lcom/android/systemui/recents/views/-$Lambda$zN5QXyPfvXVsTNl430beG2V9QjM$4;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-direct {v2, p0, v3, v4}, Lcom/android/systemui/recents/events/activity/RequestScreenRatioEvent;-><init>(Lcom/android/systemui/recents/views/TaskView;Lcom/android/systemui/recents/model/Task;Ljava/lang/Runnable;)V
