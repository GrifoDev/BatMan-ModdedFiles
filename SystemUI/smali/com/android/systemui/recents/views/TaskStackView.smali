...
.method static synthetic -get3(Lcom/android/systemui/recents/views/TaskStackView;)Ljava/util/ArrayList;
    .locals 1
...
.method private syncTaskLockState(Lcom/android/systemui/recents/model/Task;)V
    ...
    iget-boolean v6, p1, Lcom/android/systemui/recents/model/Task;->isTaskLocked:Z

    iput-boolean v6, v2, Lcom/android/systemui/recents/model/Task;->isTaskLocked:Z
    ...
    invoke-virtual {v6}, Lcom/android/systemui/recents/views/TaskViewHeader;->setNoUserInteractionLockState()V
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/activity/RecentsViewModeChangedEvent;)V
    ...
    invoke-virtual {v4}, Lcom/android/systemui/recents/views/TaskViewHeader;->setNoUserInteractionLockState()V
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/activity/UnlockTaskEvent;)V
    ...
    invoke-virtual {v2, v3, v0}, Lcom/android/systemui/recents/model/TaskLockPreference;->removePreference(Landroid/content/Context;Ljava/lang/String;)V
...
.method public updateTaskLockState(Z)V
    ...
    iget-boolean v7, v4, Lcom/android/systemui/recents/model/Task;->isTaskLocked:Z
    ...
    iget-object v9, v4, Lcom/android/systemui/recents/model/Task;->key:Lcom/android/systemui/recents/model/Task$TaskKey;

    invoke-virtual {v7, v9}, Lcom/android/systemui/recents/model/RecentsTaskLoader;->getAndUpdateActivityInfo(Lcom/android/systemui/recents/model/Task$TaskKey;)Landroid/content/pm/ActivityInfo;

    move-result-object v0

    if-eqz v0, :cond_2

    iget-object v7, v0, Landroid/content/pm/ActivityInfo;->taskAffinity:Ljava/lang/String;
    ...
    invoke-virtual {v7, v9, v2, v3}, Lcom/android/systemui/recents/model/TaskLockPreference;->savePreference(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;)V
    ...
    invoke-virtual {v7, v9, v2}, Lcom/android/systemui/recents/model/TaskLockPreference;->removePreference(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v7}, Lcom/android/systemui/recents/model/Task;->includeTaskLockPref(Landroid/content/Context;)Z
    ...
    iput-boolean v7, v4, Lcom/android/systemui/recents/model/Task;->isTaskLocked:Z
