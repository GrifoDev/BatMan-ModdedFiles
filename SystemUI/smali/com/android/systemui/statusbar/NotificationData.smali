...
.field private mDeskGroupManager:Lcom/android/systemui/statusbar/phone/NotificationGroupManager;
...
# direct methods
.method static synthetic -get0(Lcom/android/systemui/statusbar/NotificationData;)Lcom/android/systemui/statusbar/policy/HeadsUpManager;
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/statusbar/NotificationData;->mDeskHeadsUpManager:Lcom/android/systemui/statusbar/policy/HeadsUpManager;

    return-object v0
.end method

.method static synthetic -get1(Lcom/android/systemui/statusbar/NotificationData;)Lcom/android/systemui/statusbar/NotificationData$Environment;
    .locals 1
...
.method private updateRankingAndSort(Landroid/service/notification/NotificationListenerService$RankingMap;)V
    ...
    invoke-virtual {v5}, Landroid/service/notification/StatusBarNotification;->isMarkedDex()Z

    move-result v5

    if-eqz v5, :cond_1

    iget-object v5, p0, Lcom/android/systemui/statusbar/NotificationData;->mDeskGroupManager:Lcom/android/systemui/statusbar/phone/NotificationGroupManager;
...
.method public add(Lcom/android/systemui/statusbar/NotificationData$Entry;Landroid/service/notification/NotificationListenerService$RankingMap;)V
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/NotificationData;->mDeskGroupManager:Lcom/android/systemui/statusbar/phone/NotificationGroupManager;
...
.method public getAllDexes()Ljava/util/ArrayList;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v4}, Landroid/service/notification/StatusBarNotification;->isMarkedDex()Z
...
.method public getAllNonDexes()Ljava/util/ArrayList;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public remove(Ljava/lang/String;Landroid/service/notification/NotificationListenerService$RankingMap;)Lcom/android/systemui/statusbar/NotificationData$Entry;
    ...
    iget-object v3, p0, Lcom/android/systemui/statusbar/NotificationData;->mDeskGroupManager:Lcom/android/systemui/statusbar/phone/NotificationGroupManager;
...
.method public setDeskGroupManager(Lcom/android/systemui/statusbar/phone/NotificationGroupManager;)V
    .locals 0

    iput-object p1, p0, Lcom/android/systemui/statusbar/NotificationData;->mDeskGroupManager:Lcom/android/systemui/statusbar/phone/NotificationGroupManager;

    return-void
.end method

.method public setDeskHeadsUpManager(Lcom/android/systemui/statusbar/policy/HeadsUpManager;)V
    .locals 0

    iput-object p1, p0, Lcom/android/systemui/statusbar/NotificationData;->mDeskHeadsUpManager:Lcom/android/systemui/statusbar/policy/HeadsUpManager;
...
.method shouldFilterOut(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-interface {v1}, Lcom/android/systemui/statusbar/NotificationData$Environment;->onSecureLockScreen()Z
    ...
    invoke-virtual {p1}, Landroid/service/notification/StatusBarNotification;->isMarkedDex()Z

    move-result v1

    if-eqz v1, :cond_6

    iget-object v1, p0, Lcom/android/systemui/statusbar/NotificationData;->mDeskGroupManager:Lcom/android/systemui/statusbar/phone/NotificationGroupManager;
