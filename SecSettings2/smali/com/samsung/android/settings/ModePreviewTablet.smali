...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mMdnie:Lcom/samsung/android/hardware/display/SemMdnieManager;

    sget-object v0, Lcom/samsung/android/settings/ModePreviewTablet;->mModePreviewList:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mModePreviewAdapter:Lcom/samsung/android/settings/ModePreviewAdapter;

    if-nez v0, :cond_0

    new-instance v0, Lcom/samsung/android/settings/ModePreviewAdapter;

    sget-object v1, Lcom/samsung/android/settings/ModePreviewTablet;->mModePreviewList:Ljava/util/ArrayList;

    invoke-direct {v0, p0, v4, v4, v1}, Lcom/samsung/android/settings/ModePreviewAdapter;-><init>(Landroid/content/Context;IILjava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/settings/ModePreviewTablet;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/view/LayoutInflater;

    iput-object v0, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mInflater:Landroid/view/LayoutInflater;

    iget-object v6, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mInflater:Landroid/view/LayoutInflater;
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/settings/ModePreviewTablet;->getString(I)Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mAutoAdaptiveTextView:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mListView:Landroid/widget/ListView;
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mColorBalanceList:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mColorBalanceList:Ljava/util/ArrayList;
    ...
    new-instance v0, Lcom/samsung/android/settings/ModePreviewTablet$ColorBalanceListAdapter;

    iget-object v5, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mColorBalanceList:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/samsung/android/settings/ModePreviewTablet$ColorBalanceListAdapter;-><init>(Lcom/samsung/android/settings/ModePreviewTablet;Landroid/content/Context;IILjava/util/ArrayList;)V

    iput-object v0, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mColorBalanceListAdapter:Lcom/samsung/android/settings/ModePreviewTablet$ColorBalanceListAdapter;
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mListViewColorBalance:Landroid/widget/ListView;
    ...
    new-instance v1, Lcom/samsung/android/settings/ModePreviewTablet$6;

    invoke-direct {v1, p0}, Lcom/samsung/android/settings/ModePreviewTablet$6;-><init>(Lcom/samsung/android/settings/ModePreviewTablet;)V

    invoke-virtual {v0, v1}, Landroid/widget/ListView;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mListViewColorBalance:Landroid/widget/ListView;

    iget-object v1, p0, Lcom/samsung/android/settings/ModePreviewTablet;->mColorBalanceListAdapter:Lcom/samsung/android/settings/ModePreviewTablet$ColorBalanceListAdapter;
