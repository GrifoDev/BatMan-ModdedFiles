...
.method static synthetic -get10(Lcom/samsung/android/settings/face/FaceAuthenticateDialog;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic -get11(Lcom/samsung/android/settings/face/FaceAuthenticateDialog;)Landroid/widget/TextView;
    .locals 1
...
.method static synthetic -get12(Lcom/samsung/android/settings/face/FaceAuthenticateDialog;)Landroid/view/WindowManager;
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mWindowManager:Landroid/view/WindowManager;

    return-object v0
.end method

.method static synthetic -get13(Lcom/samsung/android/settings/face/FaceAuthenticateDialog;)Lcom/samsung/android/settings/face/FaceAuthenticateDialog$IFaceAuthenticateDialogEventListener;
    .locals 1
...
.method static synthetic -get5(Lcom/samsung/android/settings/face/FaceAuthenticateDialog;)Landroid/view/View;
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mBackgroundView:Landroid/view/View;
...
.method static synthetic -get7(Lcom/samsung/android/settings/face/FaceAuthenticateDialog;)Landroid/widget/Button;
    .locals 1
...
.method static synthetic -get8(Lcom/samsung/android/settings/face/FaceAuthenticateDialog;)Landroid/os/CountDownTimer;
    .locals 1
...
.method static synthetic -get9(Lcom/samsung/android/settings/face/FaceAuthenticateDialog;)Lcom/samsung/android/bio/face/SemBioFaceManager;
    .locals 1
...
.method public constructor <init>(Landroid/content/Context;Lcom/samsung/android/settings/face/FaceAuthenticateDialog$IFaceAuthenticateDialogEventListener;)V
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mContext:Landroid/content/Context;

    new-instance v0, Landroid/os/Handler;

    invoke-direct {v0}, Landroid/os/Handler;-><init>()V

    iput-object v0, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mHandler:Landroid/os/Handler;

    iput-object v8, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mBackgroundView:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mBackgroundViewParams:Landroid/view/WindowManager$LayoutParams;

    const/16 v0, 0x12c

    iput v0, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->alphaAnimationDuration:I

    iput-object v8, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mCancellationSignal:Landroid/os/CancellationSignal;

    iput v7, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mResultValue:I

    new-instance v0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog$1;

    invoke-direct {v0, p0}, Lcom/samsung/android/settings/face/FaceAuthenticateDialog$1;-><init>(Lcom/samsung/android/settings/face/FaceAuthenticateDialog;)V

    iput-object v0, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mAuthenticationCallback:Lcom/samsung/android/bio/face/SemBioFaceManager$AuthenticationCallback;
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/samsung/android/settings/face/FaceAuthenticateDialog$Config;->initFailedFaceAttempts(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mFaceManager:Lcom/samsung/android/bio/face/SemBioFaceManager;
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mWindowManager:Landroid/view/WindowManager;
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mBackgroundView:Landroid/view/View;
    ...
    iput v0, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mBackupPasswordStatusDB:I
...
.method private dismiss()V
    ...
    new-instance v1, Lcom/samsung/android/settings/face/FaceAuthenticateDialog$17;

    invoke-direct {v1, p0}, Lcom/samsung/android/settings/face/FaceAuthenticateDialog$17;-><init>(Lcom/samsung/android/settings/face/FaceAuthenticateDialog;)V
...
.method private showFaceAuthenticationDialog()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mBackgroundView:Landroid/view/View;

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Landroid/view/View;->setVisibility(I)V

    iget-object v1, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mWindowManager:Landroid/view/WindowManager;

    iget-object v2, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mBackgroundView:Landroid/view/View;

    iget-object v3, p0, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->mBackgroundViewParams:Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-direct {p0, v1}, Lcom/samsung/android/settings/face/FaceAuthenticateDialog;->showDialog(I)V
    ...
    const-string/jumbo v2, "showDialog : failed to show bg view"
