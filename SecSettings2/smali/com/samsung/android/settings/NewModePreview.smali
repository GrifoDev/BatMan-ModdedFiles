...
# direct methods
.method static synthetic -get0(Lcom/samsung/android/settings/NewModePreview;)I
    .locals 1

    iget v0, p0, Lcom/samsung/android/settings/NewModePreview;->mBatteryLevel:I

    return v0
.end method

.method static synthetic -get1(Lcom/samsung/android/settings/NewModePreview;)Landroid/content/Context;
    .locals 1
...
.method static synthetic -get4(Lcom/samsung/android/settings/NewModePreview;)Landroid/widget/SeekBar;
    .locals 1
...
.method static synthetic -set1(Lcom/samsung/android/settings/NewModePreview;Z)Z
    ...
    iput-boolean p1, p0, Lcom/samsung/android/settings/NewModePreview;->mIsCustomEnable:Z
...
.method static synthetic -set4(Lcom/samsung/android/settings/NewModePreview;Z)Z
    .locals 0
...
.method static synthetic -wrap1(Lcom/samsung/android/settings/NewModePreview;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/samsung/android/settings/NewModePreview;->updateColorBalanceCustomItems(Z)V
...
.method private showBluelightfilterDialog()V
    ...
    const v4, 0x7f0b1698    # 1.8488E38f
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v7}, Lcom/samsung/android/settings/NewModePreview;->setContentView(I)V
    ...
    iput-object v7, p0, Lcom/samsung/android/settings/NewModePreview;->mMdnie:Lcom/samsung/android/hardware/display/SemMdnieManager;

    const/4 v7, 0x4

    new-array v7, v7, [Ljava/lang/String;

    sput-object v7, Lcom/samsung/android/settings/NewModePreview;->mModeItem:[Ljava/lang/String;

    sget-object v7, Lcom/samsung/android/settings/NewModePreview;->mModeItem:[Ljava/lang/String;
    ...
    invoke-virtual {p0, v7}, Lcom/samsung/android/settings/NewModePreview;->findViewById(I)Landroid/view/View;

    move-result-object v7

    check-cast v7, Landroid/widget/TextView;

    iput-object v7, p0, Lcom/samsung/android/settings/NewModePreview;->mAutoAdaptiveTextView:Landroid/widget/TextView;
    ...
    iput-object v7, p0, Lcom/samsung/android/settings/NewModePreview;->mListView:Landroid/widget/ListView;

    new-instance v7, Lcom/samsung/android/settings/NewModePreview$RadioAdapter;

    sget-object v8, Lcom/samsung/android/settings/NewModePreview;->mModeItem:[Ljava/lang/String;

    const v9, 0x7f04017d

    invoke-direct {v7, p0, v9, v8}, Lcom/samsung/android/settings/NewModePreview$RadioAdapter;-><init>(Landroid/content/Context;I[Ljava/lang/String;)V

    iput-object v7, p0, Lcom/samsung/android/settings/NewModePreview;->mAdapter:Lcom/samsung/android/settings/NewModePreview$RadioAdapter;

    iget-object v7, p0, Lcom/samsung/android/settings/NewModePreview;->mListView:Landroid/widget/ListView;

    iget-object v8, p0, Lcom/samsung/android/settings/NewModePreview;->mAdapter:Lcom/samsung/android/settings/NewModePreview$RadioAdapter;
    ...
    invoke-virtual {v7, v5, v10}, Landroid/widget/ListView;->setItemChecked(IZ)V
    ...
    invoke-virtual {v7, v12}, Landroid/widget/ListView;->setOverScrollMode(I)V
    ...
    iput-object v7, p0, Lcom/samsung/android/settings/NewModePreview;->mContext:Landroid/content/Context;
    ...
    iget-object v7, p0, Lcom/samsung/android/settings/NewModePreview;->mContext:Landroid/content/Context;

    invoke-direct {v4, v7}, Lcom/samsung/android/settings/policy/SCPMHelper;-><init>(Landroid/content/Context;)V

    const-string/jumbo v7, "edge_color_balance"

    invoke-virtual {v4, v2, v7}, Lcom/samsung/android/settings/policy/SCPMHelper;->isSupportedMenu(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v7

    iput-boolean v7, p0, Lcom/samsung/android/settings/NewModePreview;->mIsCustomEdgeBalanceSupported:Z

    const-string/jumbo v7, "ModePreview"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "onCreate():  mIsCustomEdgeBalanceSupported="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-boolean v9, p0, Lcom/samsung/android/settings/NewModePreview;->mIsCustomEdgeBalanceSupported:Z
    ...
    iget-object v8, p0, Lcom/samsung/android/settings/NewModePreview;->mListView:Landroid/widget/ListView;

    const v9, 0x7f0400e0

    invoke-virtual {v7, v9, v8, v11}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    move-result-object v7

    iput-object v7, p0, Lcom/samsung/android/settings/NewModePreview;->mDisplayColourFooterView:Landroid/view/View;

    iget-object v7, p0, Lcom/samsung/android/settings/NewModePreview;->mDisplayColourFooterView:Landroid/view/View;
    ...
    iget-object v8, p0, Lcom/samsung/android/settings/NewModePreview;->mDisplayColourFooterView:Landroid/view/View;

    invoke-virtual {v7, v8}, Landroid/widget/ListView;->addFooterView(Landroid/view/View;)V

    iget-object v7, p0, Lcom/samsung/android/settings/NewModePreview;->mListView:Landroid/widget/ListView;

    invoke-virtual {v7, v11}, Landroid/widget/ListView;->setFooterDividersEnabled(Z)V
    ...
    iput-object v7, p0, Lcom/samsung/android/settings/NewModePreview;->mEmSettingsManager:Lcom/samsung/android/settings/bixby/EmSettingsManager;
...
.method public onPause()V
    ...
    iget-object v4, p0, Lcom/samsung/android/settings/NewModePreview;->mMdnie:Lcom/samsung/android/hardware/display/SemMdnieManager;

    invoke-virtual {v4, v3}, Lcom/samsung/android/hardware/display/SemMdnieManager;->setScreenMode(I)Z
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/NewModePreview;->mBlueLightFilterObserver:Landroid/database/ContentObserver;
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/NewModePreview;->mGrayscaleObserver:Landroid/database/ContentObserver;
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/NewModePreview;->mNegativeColorObserver:Landroid/database/ContentObserver;
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/NewModePreview;->mColorAdjustmentObserver:Landroid/database/ContentObserver;
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/NewModePreview;->mDTRedObserver:Landroid/database/ContentObserver;
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/NewModePreview;->mDTGreenObserver:Landroid/database/ContentObserver;
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/NewModePreview;->mDTBlueObserver:Landroid/database/ContentObserver;
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/NewModePreview;->mBatteryInfoReceiver:Landroid/content/BroadcastReceiver;
    ...
    :goto_1
    iget-object v4, p0, Lcom/samsung/android/settings/NewModePreview;->mEmSettingsManager:Lcom/samsung/android/settings/bixby/EmSettingsManager;

    const-string/jumbo v5, "ScreenMode"

    invoke-virtual {v4, v5}, Lcom/samsung/android/settings/bixby/EmSettingsManager;->clearEmService(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v1}, Lcom/samsung/android/hardware/display/SemMdnieManager;->setScreenMode(I)Z
