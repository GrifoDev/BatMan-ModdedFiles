...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v11}, Lcom/android/settings/ChooseLockPattern$SaveAndFinishWorker;->setBlocking(Z)V
    ...
    invoke-interface {v1, v4, v11}, Landroid/content/SharedPreferences$Editor;->putBoolean(Ljava/lang/String;Z)Landroid/content/SharedPreferences$Editor;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object v8, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mSUWNextBtnImg:Landroid/widget/ImageView;

    iget-object v8, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mSUWBottomBar:Landroid/widget/RelativeLayout;

    if-eqz v8, :cond_0

    const/4 v8, 0x1

    iput-boolean v8, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mIsSupportSUWBar:Z
    ...
    iget-boolean v8, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mIsSupportSUWBar:Z
    ...
    invoke-static {v8}, Lcom/android/setupwizardlib/util/SystemBarHelper;->hideSystemBars(Landroid/view/Window;)V

    iget-object v8, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mSUWPrevBtn:Landroid/widget/LinearLayout;

    invoke-virtual {v8, p0}, Landroid/widget/LinearLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v8, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mSUWNextBtn:Landroid/widget/LinearLayout;

    invoke-virtual {v8, p0}, Landroid/widget/LinearLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v8, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mBottomBar:Landroid/widget/LinearLayout;
