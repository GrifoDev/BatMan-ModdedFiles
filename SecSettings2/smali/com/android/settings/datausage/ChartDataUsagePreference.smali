...
.method private calcPoints(Lcom/android/settingslib/graph/UsageView;)V
    ...
    iget-object v13, v0, Lcom/android/settings/datausage/ChartDataUsagePreference;->mNetwork:Landroid/net/NetworkStatsHistory;

    move-object/from16 v0, p0

    iget-wide v0, v0, Lcom/android/settings/datausage/ChartDataUsagePreference;->mStart:J

    move-wide/from16 v18, v0

    move-wide/from16 v0, v18

    invoke-virtual {v13, v0, v1}, Landroid/net/NetworkStatsHistory;->getIndexAfter(J)I
    ...
    iget-wide v0, v0, Lcom/android/settings/datausage/ChartDataUsagePreference;->mEnd:J
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/settings/datausage/ChartDataUsagePreference;->toInt(J)I
    ...
    invoke-virtual {v13, v9, v5}, Landroid/net/NetworkStatsHistory;->getValues(ILandroid/net/NetworkStatsHistory$Entry;)Landroid/net/NetworkStatsHistory$Entry;

    move-result-object v5

    iget-wide v14, v5, Landroid/net/NetworkStatsHistory$Entry;->bucketStart:J

    iget-wide v0, v5, Landroid/net/NetworkStatsHistory$Entry;->bucketDuration:J
    ...
    invoke-virtual {v0, v11}, Lcom/android/settingslib/graph/UsageView;->addPath(Landroid/util/SparseIntArray;)V
