...
.method public constructor <init>()V
    ...
    const-class v1, Lcom/android/settings/Settings$AirplaneModeSettingsActivity;
...
.method private bixbyAvailableDialog()V
    ...
    new-instance v1, Lcom/android/settings/SettingsActivity$7;
    ...
    invoke-direct {v2, p0}, Lcom/android/settings/SettingsActivity$8;-><init>(Lcom/android/settings/SettingsActivity;)V
...
.method private doUpdateTilesList()V
    ...
    invoke-virtual/range {v42 .. v42}, Landroid/os/UserManager;->isAdminUser()Z
    ...
    const-string/jumbo v45, "android.hardware.wifi"
    ...
    sget-object v45, Lcom/android/settings/SettingsActivity;->mContext:Landroid/content/Context;

    invoke-static/range {v45 .. v45}, Lcom/android/settings/Utils;->isSupportGraceUXHeroView(Landroid/content/Context;)Z
    ...
    invoke-static/range {v45 .. v45}, Lcom/android/settings/Utils;->checkKnoxCustomSettingsHiddenItem(I)Z
    ...
    const-class v45, Lcom/android/settings/Settings$WifiSettingsActivity;
    ...
    const-string/jumbo v45, "android.hardware.bluetooth"
    ...
    const-class v45, Lcom/android/settings/Settings$BluetoothSettingsActivity;
    ...
    const-class v46, Lcom/android/settings/Settings$DataUsageSummaryActivity;
    ...
    const-class v46, Lcom/android/settings/Settings$SimSettingsActivity;
    ...
    const-class v46, Lcom/android/settings/Settings$PowerUsageSummaryActivity;
    ...
    const-class v45, Lcom/android/settings/Settings$UserSettingsActivity;
    ...
    const-string/jumbo v45, "android.hardware.nfc"
    ...
    const-class v45, Lcom/android/settings/Settings$NfcSettingsActivity;
    ...
    const-class v45, Lcom/android/settings/Settings$NfcOsaifukeitaiSettingsActivity;
    ...
    const-class v45, Lcom/android/settings/Settings$PaymentSettingsActivity;
    ...
    const-string/jumbo v45, "android.hardware.nfc.hce"
    ...
    const-class v46, Lcom/android/settings/Settings$PrintSettingsActivity;
    ...
    const-string/jumbo v46, "android.software.print"
    ...
    const-class v45, Lcom/android/settings/Settings$HelpActivity;
    ...
    const-string/jumbo v45, "connectivity"
    ...
    const-string/jumbo v45, "no_config_tethering"
    ...
    const-class v46, Lcom/android/settings/Settings$TetherSettingsActivity;
    ...
    const-class v45, Lcom/android/settings/Settings$SoftwareUpdateSettingActivity;
    ...
    const-class v46, Lcom/android/settings/Settings$DockSettingsActivity;
    ...
    const-string/jumbo v45, "com.sec.feature.fingerprint_manager_service"
    ...
    const-class v46, Lcom/android/settings/fingerprint/FingerprintEntry;
    ...
    const-class v46, Lcom/samsung/android/settings/face/FaceEntry;
    ...
    const-class v46, Lcom/samsung/android/settings/iris/IrisLockSettings;
    ...
    const-class v45, Lcom/android/settings/Settings$LockAndSecuritySettingsActivity;
    ...
    const-class v45, Lcom/android/settings/Settings$ManageApplicationsActivity;
    ...
    const-class v46, Lcom/android/settings/Settings$LocationSettingsActivity;
    ...
    const-class v45, Lcom/android/settings/Settings$AirplaneModeSettingsActivity;
    ...
    const-class v45, Lcom/android/settings/Settings$InputMethodAndLanguageSettingsActivity;
    ...
    const-class v45, Lcom/android/settings/Settings$ApplicationsActivity;
    ...
    const-class v46, Lcom/android/settings/Settings$PrivacySettingsActivity;
    ...
    :cond_12
    const-string/jumbo v45, "com.android.settings"
    ...
    const-string/jumbo v46, "show"

    sget-object v47, Landroid/os/Build;->TYPE:Ljava/lang/String;

    const-string/jumbo v48, "eng"

    invoke-virtual/range {v47 .. v48}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z

    move-result v47

    invoke-interface/range {v45 .. v47}, Landroid/content/SharedPreferences;->getBoolean(Ljava/lang/String;Z)Z

    move-result v45

    if-eqz v45, :cond_2f

    const-string/jumbo v45, "no_debugging_features"
    ...
    const-class v45, Lcom/android/settings/Settings$DevelopmentSettingsActivity;
    ...
    const-class v46, Lcom/android/settings/Settings$PersonalPageSettingsActivity;
    ...
    const-string/jumbo v46, "CscFeature_Common_EnableSprintExtension"

    invoke-virtual/range {v45 .. v46}, Lcom/samsung/android/feature/SemCscFeature;->getBoolean(Ljava/lang/String;)Z
    ...
    const-string/jumbo v45, "Settings"

    new-instance v46, Ljava/lang/StringBuilder;

    invoke-direct/range {v46 .. v46}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v47, " tetherSummary : "
    ...
    const-string/jumbo v47, "sprint chameleon tethering showTile : "
    ...
    const-class v46, Lcom/android/settings/Settings$SprTetherSettingsActivity;
    ...
    const-class v45, Lcom/android/settings/Settings$PenSettingsMenuActivity;
    ...
    invoke-static/range {v45 .. v45}, Lcom/android/settings/Utils;->hasSPenFeature(Landroid/content/Context;)Z
    ...
    const-class v45, Lcom/android/settings/Settings$AccountSettingsActivity;
    ...
    const-string/jumbo v47, "no_modify_accounts"
    ...
    check-cast v40, Lcom/android/settingslib/drawer/Tile;
    ...
    invoke-static/range {v45 .. v46}, Lcom/android/internal/util/ArrayUtils;->contains([Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method private setTitleFromBackStack()I
    ...
    iput-boolean v5, p0, Lcom/android/settings/SettingsActivity;->bFromRelativeLink:Z
...
.method public openTile(Lcom/android/settingslib/drawer/Tile;)Z
    ...
    const-string/jumbo v0, "general_device_settings"
