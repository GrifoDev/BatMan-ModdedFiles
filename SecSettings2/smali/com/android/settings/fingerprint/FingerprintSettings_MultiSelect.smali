...
.method private deleteAllFingerPrint()V
    ...
    const-string/jumbo v9, "FpstFingerprintSettings_MultiSelect"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v11, "deleteAllFingerPrint : selectedCount "
    ...
    iget-object v9, p0, Lcom/android/settings/fingerprint/FingerprintSettings_MultiSelect;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    iget v10, p0, Lcom/android/settings/fingerprint/FingerprintSettings_MultiSelect;->mUserId:I

    invoke-virtual {v9, v12, v10}, Lcom/android/internal/widget/LockPatternUtils;->getBiometricLockscreen(II)I
    ...
    iget v10, p0, Lcom/android/settings/fingerprint/FingerprintSettings_MultiSelect;->SCREEN_ID_REMOVE:I

    invoke-static {v9, v10}, Lcom/android/settings/Utils;->insertFlowLog(Landroid/content/Context;I)V

    new-instance v9, Lcom/android/settings/fingerprint/FingerprintDeleteDialog;

    new-instance v10, Lcom/android/settings/fingerprint/FingerprintSettings_MultiSelect$11;

    invoke-direct {v10, p0, v2, v1}, Lcom/android/settings/fingerprint/FingerprintSettings_MultiSelect$11;-><init>(Lcom/android/settings/fingerprint/FingerprintSettings_MultiSelect;ZZ)V

    invoke-direct {v9, v8, v7, v10}, Lcom/android/settings/fingerprint/FingerprintDeleteDialog;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/android/settings/fingerprint/FingerprintDeleteDialog$ConfirmationDialogFragmentListener;)V

    iput-object v9, p0, Lcom/android/settings/fingerprint/FingerprintSettings_MultiSelect;->mDeleteAllDialog:Lcom/android/settings/fingerprint/FingerprintDeleteDialog;

    iget-object v9, p0, Lcom/android/settings/fingerprint/FingerprintSettings_MultiSelect;->mDeleteAllDialog:Lcom/android/settings/fingerprint/FingerprintDeleteDialog;
    ...
    const-string/jumbo v11, "fpstDeleteAllDialog"

    invoke-virtual {v9, v10, v11}, Lcom/android/settings/fingerprint/FingerprintDeleteDialog;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v10}, Lcom/android/internal/widget/LockPatternUtils;->getActivePasswordQuality(I)I
    ...
    const-string/jumbo v11, "passwordQuality : "
...
.method protected finishFingerprintSettings()V
    ...
    :cond_2
    iget-object v1, p0, Lcom/android/settings/fingerprint/FingerprintSettings_MultiSelect;->mDeleteAllDialog:Lcom/android/settings/fingerprint/FingerprintDeleteDialog;

    if-eqz v1, :cond_3

    iget-object v1, p0, Lcom/android/settings/fingerprint/FingerprintSettings_MultiSelect;->mDeleteAllDialog:Lcom/android/settings/fingerprint/FingerprintDeleteDialog;

    invoke-virtual {v1}, Lcom/android/settings/fingerprint/FingerprintDeleteDialog;->cancelDeleteDialog()V

    :cond_3
    iget-object v1, p0, Lcom/android/settings/fingerprint/FingerprintSettings_MultiSelect;->mDeleteDialog:Lcom/android/settings/fingerprint/FingerprintDeleteDialog;
