...
.method private initSimInfo()V
    ...
    sput v1, Lcom/android/settings/ApnSettings;->sCurrentTab:I
    ...
    const-string/jumbo v3, "sCurrentTab:"
    ...
    sput v3, Lcom/android/settings/ApnSettings;->sCurrentTab:I
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings/ApnSettings;->getContext()Landroid/content/Context;
    ...
    iput-object v5, p0, Lcom/android/settings/ApnSettings;->mSelectableSubInfos:Ljava/util/List;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/settings/ApnSettings;->initSimInfo()V

    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/ApnSettings;->getEnabledSimCnt()I
    ...
    invoke-static {v0, v12, v6, v13}, Lcom/android/settings/Utils;->prepareCustomPreferencesList(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;Z)V
    ...
    invoke-super {v0, v1, v6, v2}, Lcom/samsung/android/settings/SecRestrictedSettingsFragment;->onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v13, v0, Lcom/android/settings/ApnSettings;->mTabHost:Landroid/widget/TabHost;

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/settings/ApnSettings;->mTabHost:Landroid/widget/TabHost;

    invoke-virtual {v13}, Landroid/widget/TabHost;->setup()V
    ...
    iget-object v14, v0, Lcom/android/settings/ApnSettings;->mTabListener:Landroid/widget/TabHost$OnTabChangeListener;

    invoke-virtual {v13, v14}, Landroid/widget/TabHost;->setOnTabChangedListener(Landroid/widget/TabHost$OnTabChangeListener;)V
    ...
    iget-object v13, v0, Lcom/android/settings/ApnSettings;->mSelectableSubInfos:Ljava/util/List;
    ...
    invoke-direct {v0, v15, v13}, Lcom/android/settings/ApnSettings;->buildTabSpec(Ljava/lang/String;Ljava/lang/String;)Landroid/widget/TabHost$TabSpec;
    ...
    invoke-virtual {v13, v4}, Landroid/widget/TabWidget;->getChildTabViewAt(I)Landroid/view/View;
    ...
    iget-object v13, v0, Lcom/android/settings/ApnSettings;->mContext:Landroid/content/Context;

    invoke-static {v13, v4}, Lcom/android/settings/Utils;->getSimIcon(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v7, v11, v13, v11, v14}, Landroid/widget/ImageView;->setPaddingRelative(IIII)V
    ...
    invoke-virtual {v8, v13}, Landroid/widget/TextView;->setAllCaps(Z)V
