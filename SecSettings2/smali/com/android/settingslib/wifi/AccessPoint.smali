...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    iput-boolean v6, p0, Lcom/android/settingslib/wifi/AccessPoint;->mIsGigaAp:Z

    iput-boolean v6, p0, Lcom/android/settingslib/wifi/AccessPoint;->mIsGigaIcon:Z

    iput-boolean v6, p0, Lcom/android/settingslib/wifi/AccessPoint;->mIsWeChatAp:Z

    iput-boolean v6, p0, Lcom/android/settingslib/wifi/AccessPoint;->mIsAirplaneMode:Z

    iput-object v7, p0, Lcom/android/settingslib/wifi/AccessPoint;->mStoreName:Ljava/lang/String;

    iput-object v7, p0, Lcom/android/settingslib/wifi/AccessPoint;->mWeChatWifiManager:Lcom/android/settingslib/wifi/WeChatWifiManager;
    ...
    iput-object v7, p0, Lcom/android/settingslib/wifi/AccessPoint;->mPreviousSummary:Ljava/lang/String;
...
.method public static getSummary(Landroid/content/Context;Ljava/lang/String;Landroid/net/NetworkInfo$DetailedState;ZLjava/lang/String;Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-interface {v12}, Landroid/net/wifi/IWifiManager;->getCurrentNetwork()Landroid/net/Network;
    :try_end_0
    ...
    :try_start_1
    invoke-interface {v12}, Landroid/net/wifi/IWifiManager;->getConnectionInfo()Landroid/net/wifi/WifiInfo;
    :try_end_1
    ...
    sget v13, Lcom/android/settingslib/R$string;->connected_via_passpoint:I
    ...
    const-string/jumbo v15, "CountryISO"
    ...
    sget v13, Lcom/android/settingslib/R$string;->wifi_connected_no_internet:I
    ...
    invoke-virtual {v9}, Landroid/net/wifi/WifiInfo;->isCaptivePortal()Z

    move-result v13

    if-eqz v13, :cond_3

    invoke-virtual {v9}, Landroid/net/wifi/WifiInfo;->isAuthenticated()Z
    ...
    sget v13, Lcom/android/settingslib/R$string;->wifi_internet_may_not_be_available:I
    ...
    :cond_4
    sget v13, Lcom/android/settingslib/R$string;->wifi_sign_in_to_the_network:I
    ...
    :cond_6
    sget v13, Lcom/android/settingslib/R$string;->wifi_reconnecting:I
    ...
    sget v13, Lcom/android/settingslib/R$string;->wifi_connected_checking_quality:I
    ...
    sget v13, Lcom/android/settingslib/R$string;->connected_via_wfa:I
    ...
    const-string/jumbo v13, "SettingsLib.AccessPoint"

    const-string/jumbo v14, "state is null, returning empty summary"
    ...
    sget v13, Lcom/android/settingslib/R$array;->wifi_status:I
    ...
    :cond_d
    sget v13, Lcom/android/settingslib/R$array;->wifi_status_with_ssid:I
