...
.method public constructor <init>(Lorg/w3c/dom/Document;Ljava/lang/String;ILjava/lang/String;)V
    ...
    iput-object v3, p0, Lcom/sun/org/apache/xml/internal/security/signature/SignedInfo;->_signatureAlgorithm:Lcom/sun/org/apache/xml/internal/security/algorithms/SignatureAlgorithm;

    iput-object v3, p0, Lcom/sun/org/apache/xml/internal/security/signature/SignedInfo;->_c14nizedBytes:[B

    iget-object v1, p0, Lcom/sun/org/apache/xml/internal/security/utils/ElementProxy;->_doc:Lorg/w3c/dom/Document;

    const-string/jumbo v2, "CanonicalizationMethod"
    ...
    invoke-interface {v0, v3, v1, p4}, Lorg/w3c/dom/Element;->setAttributeNS(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, p2}, Lcom/sun/org/apache/xml/internal/security/algorithms/SignatureAlgorithm;-><init>(Lorg/w3c/dom/Document;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/sun/org/apache/xml/internal/security/signature/SignedInfo;->_signatureAlgorithm:Lcom/sun/org/apache/xml/internal/security/algorithms/SignatureAlgorithm;
    ...
    invoke-direct {v1, v2, p2, p3}, Lcom/sun/org/apache/xml/internal/security/algorithms/SignatureAlgorithm;-><init>(Lorg/w3c/dom/Document;Ljava/lang/String;I)V
...
.method public constructor <init>(Lorg/w3c/dom/Element;Ljava/lang/String;)V
    ...
    iput-object v6, p0, Lcom/sun/org/apache/xml/internal/security/signature/SignedInfo;->_signatureAlgorithm:Lcom/sun/org/apache/xml/internal/security/algorithms/SignatureAlgorithm;

    iput-object v6, p0, Lcom/sun/org/apache/xml/internal/security/signature/SignedInfo;->_c14nizedBytes:[B
    ...
    :cond_0
    :goto_0
    new-instance v6, Lcom/sun/org/apache/xml/internal/security/algorithms/SignatureAlgorithm;
    ...
    invoke-direct {v6, v7, v8}, Lcom/sun/org/apache/xml/internal/security/algorithms/SignatureAlgorithm;-><init>(Lorg/w3c/dom/Element;Ljava/lang/String;)V
    ...
    invoke-static {v6}, Lcom/sun/org/apache/xml/internal/security/c14n/Canonicalizer;->getInstance(Ljava/lang/String;)Lcom/sun/org/apache/xml/internal/security/c14n/Canonicalizer;

    move-result-object v1

    iget-object v6, p0, Lcom/sun/org/apache/xml/internal/security/utils/ElementProxy;->_constructionElement:Lorg/w3c/dom/Element;

    invoke-virtual {v1, v6}, Lcom/sun/org/apache/xml/internal/security/c14n/Canonicalizer;->canonicalizeSubtree(Lorg/w3c/dom/Node;)[B
    ...
    iget-object v7, p0, Lcom/sun/org/apache/xml/internal/security/signature/SignedInfo;->_c14nizedBytes:[B
    ...
    iget-object v6, p0, Lcom/sun/org/apache/xml/internal/security/utils/ElementProxy;->_doc:Lorg/w3c/dom/Document;
    ...
    invoke-interface {v6, v7, v8}, Lorg/w3c/dom/Document;->importNode(Lorg/w3c/dom/Node;Z)Lorg/w3c/dom/Node;
    ...
    invoke-interface {v6, v5, v7}, Lorg/w3c/dom/Node;->replaceChild(Lorg/w3c/dom/Node;Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;

    check-cast v5, Lorg/w3c/dom/Element;

    iput-object v5, p0, Lcom/sun/org/apache/xml/internal/security/utils/ElementProxy;->_constructionElement:Lorg/w3c/dom/Element;
    :try_end_0
    ...
    new-instance v6, Lcom/sun/org/apache/xml/internal/security/exceptions/XMLSecurityException;

    const-string/jumbo v7, "empty"

    invoke-direct {v6, v7, v1}, Lcom/sun/org/apache/xml/internal/security/exceptions/XMLSecurityException;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public getCanonicalizationMethodURI()Ljava/lang/String;
    ...
    invoke-interface {v0, v4, v1}, Lorg/w3c/dom/Element;->getAttributeNS(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public getInclusiveNamespaces()Ljava/lang/String;
    ...
    const-string/jumbo v5, "CanonicalizationMethod"

    invoke-static {v4, v5, v8}, Lcom/sun/org/apache/xml/internal/security/utils/XMLUtils;->selectDsNode(Lorg/w3c/dom/Node;Ljava/lang/String;I)Lorg/w3c/dom/Element;
    ...
    invoke-interface {v0, v7, v4}, Lorg/w3c/dom/Element;->getAttributeNS(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    const-string/jumbo v4, "http://www.w3.org/2001/10/xml-exc-c14n#"
    ...
    const-string/jumbo v5, "http://www.w3.org/2001/10/xml-exc-c14n#"

    const-string/jumbo v6, "InclusiveNamespaces"

    invoke-static {v4, v5, v6, v8}, Lcom/sun/org/apache/xml/internal/security/utils/XMLUtils;->selectNode(Lorg/w3c/dom/Node;Ljava/lang/String;Ljava/lang/String;I)Lorg/w3c/dom/Element;
    ...
    :cond_2
    const-string/jumbo v4, "http://www.w3.org/2001/10/xml-exc-c14n#WithComments"
    ...
    :cond_3
    :try_start_0
    new-instance v4, Lcom/sun/org/apache/xml/internal/security/transforms/params/InclusiveNamespaces;

    const-string/jumbo v5, "http://www.w3.org/2001/10/xml-exc-c14n#"

    invoke-direct {v4, v2, v5}, Lcom/sun/org/apache/xml/internal/security/transforms/params/InclusiveNamespaces;-><init>(Lorg/w3c/dom/Element;Ljava/lang/String;)V

    invoke-virtual {v4}, Lcom/sun/org/apache/xml/internal/security/transforms/params/InclusiveNamespaces;->getInclusiveNamespaces()Ljava/lang/String;
    :try_end_0
...
.method public signInOctectStream(Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v0, v2}, Lcom/sun/org/apache/xml/internal/security/c14n/Canonicalizer;->canonicalizeSubtree(Lorg/w3c/dom/Node;)[B
