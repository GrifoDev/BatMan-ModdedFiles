...
.method public static main([Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "data/ie/baltimore/merlin-examples/merlin-xmldsig-eighteen/certs"

    invoke-direct {v0, v4}, Lcom/sun/org/apache/xml/internal/security/keys/storage/implementations/CertsInFilesystemDirectoryResolver;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/sun/org/apache/xml/internal/security/keys/content/x509/XMLX509SKI;->getSKIBytesFromCert(Ljava/security/cert/X509Certificate;)[B
    ...
    const-string/jumbo v6, "Base64(SKI())=                 \""
    ...
    const-string/jumbo v6, "cert.getSerialNumber()=        \""
    ...
    const-string/jumbo v6, "cert.getSubjectDN().getName()= \""
    ...
    const-string/jumbo v6, "cert.getIssuerDN().getName()=  \""
...
.method private readCertsFromHarddrive()V
    ...
    iget-object v14, v0, Lcom/sun/org/apache/xml/internal/security/keys/storage/implementations/CertsInFilesystemDirectoryResolver;->_merlinsCertificatesDir:Ljava/lang/String;
    ...
    new-instance v14, Lcom/sun/org/apache/xml/internal/security/keys/storage/StorageResolverException;

    const-string/jumbo v15, "empty"

    invoke-direct {v14, v15, v9}, Lcom/sun/org/apache/xml/internal/security/keys/storage/StorageResolverException;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-direct {v14, v15}, Lcom/sun/org/apache/xml/internal/security/keys/storage/StorageResolverException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v1}, Ljava/security/cert/CertificateFactory;->generateCertificate(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    iget-object v14, v0, Lcom/sun/org/apache/xml/internal/security/keys/storage/implementations/CertsInFilesystemDirectoryResolver;->_certs:Ljava/util/List;
    ...
    sget-object v14, Lcom/sun/org/apache/xml/internal/security/keys/storage/implementations/CertsInFilesystemDirectoryResolver;->log:Ljava/util/logging/Logger;
    ...
    const-string/jumbo v17, "Could not add certificate from file "
    ...
    invoke-virtual {v14, v15, v0, v1}, Ljava/util/logging/Logger;->log(Ljava/util/logging/Level;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string/jumbo v17, "Added certificate: "
