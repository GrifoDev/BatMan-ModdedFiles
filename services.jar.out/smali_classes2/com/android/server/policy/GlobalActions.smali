...
.field private static final MESSAGE_ONCLICK_WITH_SECURE_POWEROFF:I = 0xa
...
.field mItemMaxWidthForClearCoverClosed:I
...
.method static synthetic -get33(Lcom/android/server/policy/GlobalActions;)Z
    .locals 1
...
.method static synthetic -get39(Lcom/android/server/policy/GlobalActions;)Z
    .locals 1
...
.method static synthetic -get40(Lcom/android/server/policy/GlobalActions;)Ljava/util/ArrayList;
    .locals 1
...
.method static synthetic -get41(Lcom/android/server/policy/GlobalActions;)Landroid/app/KeyguardManager;
    .locals 1
...
.method static synthetic -get42(Lcom/android/server/policy/GlobalActions;)Z
    .locals 1
...
.method static synthetic -get43(Lcom/android/server/policy/GlobalActions;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -get45(Lcom/android/server/policy/GlobalActions;)Landroid/widget/LinearLayout;
    .locals 1
...
.method static synthetic -get48()Z
    .locals 1
...
.method static synthetic -get49()Landroid/widget/EditText;
    .locals 1
...
.method static synthetic -get50(Lcom/android/server/policy/GlobalActions;)I
    .locals 1
...
.method static synthetic -get51()Landroid/app/AlertDialog$Builder;
    .locals 1
...
.method static synthetic -get52(Lcom/android/server/policy/GlobalActions;)Lcom/samsung/android/knox/custom/ProKioskManager;
    .locals 1
...
.method static synthetic -get54()Z
    .locals 1
...
.method static synthetic -get55(Lcom/android/server/policy/GlobalActions;)Lcom/android/server/policy/GlobalActions$ToggleAction;
    .locals 1
...
.method static synthetic -get57()Ljava/lang/String;
    .locals 1
...
.method static synthetic -get58(Lcom/android/server/policy/GlobalActions;)Lcom/android/server/policy/GlobalActions$SilentModeAction;
    .locals 1
...
.method static synthetic -get66(Lcom/android/server/policy/GlobalActions;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -get67(Lcom/android/server/policy/GlobalActions;)Landroid/hardware/usb/UsbManager;
    .locals 1
...
.method static synthetic -get68(Lcom/android/server/policy/GlobalActions;)Landroid/view/WindowManagerPolicy$WindowManagerFuncs;
    .locals 1
...
.method static synthetic -get69()Ljava/lang/Object;
    .locals 1
...
.method static synthetic -get73()Z
    .locals 1
...
.method static synthetic -set15(Lcom/android/server/policy/GlobalActions;Z)Z
    .locals 0
...
.method static synthetic -set17(Lcom/android/server/policy/GlobalActions;Lcom/android/server/policy/GlobalActions$ToggleAction$State;)Lcom/android/server/policy/GlobalActions$ToggleAction$State;
    .locals 0
...
.method static synthetic -set18(Lcom/android/server/policy/GlobalActions;Landroid/hardware/usb/UsbManager;)Landroid/hardware/usb/UsbManager;
    .locals 0
...
.method static synthetic -wrap33(Lcom/android/server/policy/GlobalActions;ILcom/android/server/policy/GlobalActions$ToggleAction$State;)V
    .locals 0
...
.method static synthetic -wrap34(Lcom/android/server/policy/GlobalActions;Ljava/lang/String;)V
    .locals 0
...
.method static constructor <clinit>()V
    ...
    sput-boolean v2, Lcom/android/server/policy/GlobalActions;->sSupportBlackWhiteTheme:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    iput v2, p0, Lcom/android/server/policy/GlobalActions;->mItemMaxWidthForClearCoverClosed:I
    ...
    iput-object v5, p0, Lcom/android/server/policy/GlobalActions;->mDesktopModeManager:Lcom/samsung/android/desktopmode/SemDesktopModeManager;

    iput-object v5, p0, Lcom/android/server/policy/GlobalActions;->mDesktopModeEventListener:Lcom/samsung/android/desktopmode/SemDesktopModeManager$EventListener;

    iput-boolean v2, p0, Lcom/android/server/policy/GlobalActions;->mIsConfirmPoweroffonClearCover:Z

    const v1, 0x3e99999a    # 0.3f

    iput v1, p0, Lcom/android/server/policy/GlobalActions;->BLUR_DIM_AMOUNT:F

    const/16 v1, 0x99

    iput v1, p0, Lcom/android/server/policy/GlobalActions;->DEFAULT_OPACITY:I

    const/16 v1, 0xbf

    iput v1, p0, Lcom/android/server/policy/GlobalActions;->CONFIRM_OPACITY:I
    ...
    :cond_0
    const-string/jumbo v1, "com.samsung.android.app.bikemode"

    invoke-direct {p0, v1}, Lcom/android/server/policy/GlobalActions;->isSBikeInstalled(Ljava/lang/String;)Z
...
.method private addCustomDialogItems(Landroid/graphics/drawable/BitmapDrawable;Ljava/lang/String;Landroid/content/Intent;ILjava/util/ArrayList;)Z
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/policy/GlobalActions$39;-><init>(Lcom/android/server/policy/GlobalActions;Landroid/graphics/drawable/Drawable;Ljava/lang/String;ILandroid/content/Intent;)V
...
.method private addUsersToMenu(Ljava/util/ArrayList;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/policy/GlobalActions$44;-><init>(Lcom/android/server/policy/GlobalActions;ILandroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;Landroid/content/pm/UserInfo;)V
...
.method private changeAirplaneModeSystemSetting(Z)V
    ...
    new-instance v2, Lcom/android/server/policy/GlobalActions$45;

    invoke-direct {v2, p0}, Lcom/android/server/policy/GlobalActions$45;-><init>(Lcom/android/server/policy/GlobalActions;)V
...
.method private confirmedAction(Landroid/view/View;Lcom/android/server/policy/GlobalActions$Action;Z)V
    ...
    :cond_5
    iget-object v8, p0, Lcom/android/server/policy/GlobalActions;->mLandscapeLinearLayout:Landroid/widget/LinearLayout;
    ...
    new-instance v8, Lcom/android/server/policy/GlobalActions$35;

    invoke-direct {v8, p0, p2}, Lcom/android/server/policy/GlobalActions$35;-><init>(Lcom/android/server/policy/GlobalActions;Lcom/android/server/policy/GlobalActions$Action;)V
...
.method private createDialog()Lcom/android/server/policy/GlobalActions$GlobalActionsDialog;
    ...
    invoke-direct/range {v4 .. v10}, Lcom/android/server/policy/GlobalActions$17;-><init>(Lcom/android/server/policy/GlobalActions;IIIII)V
    ...
    new-instance v5, Lcom/android/server/policy/GlobalActions$19;

    move-object/from16 v0, p0

    invoke-direct {v5, v0}, Lcom/android/server/policy/GlobalActions$19;-><init>(Lcom/android/server/policy/GlobalActions;)V
    ...
    invoke-direct/range {v4 .. v10}, Lcom/android/server/policy/GlobalActions$20;-><init>(Lcom/android/server/policy/GlobalActions;IIIII)V
    ...
    new-instance v5, Lcom/android/server/policy/GlobalActions$21;
    ...
    :cond_0
    const-string/jumbo v4, "com.samsung.android.app.bikemode"

    move-object/from16 v0, p0

    invoke-direct {v0, v4}, Lcom/android/server/policy/GlobalActions;->isSBikeInstalled(Ljava/lang/String;)Z
    ...
    :cond_1
    new-instance v4, Lcom/android/server/policy/GlobalActions$22;
    ...
    invoke-direct/range {v4 .. v10}, Lcom/android/server/policy/GlobalActions$22;-><init>(Lcom/android/server/policy/GlobalActions;IIIII)V
    ...
    new-instance v5, Lcom/android/server/policy/GlobalActions$24;

    move-object/from16 v0, p0

    invoke-direct {v5, v0}, Lcom/android/server/policy/GlobalActions$24;-><init>(Lcom/android/server/policy/GlobalActions;)V
    ...
    new-instance v5, Lcom/android/server/policy/GlobalActions$28;

    move-object/from16 v0, p0

    invoke-direct {v5, v0}, Lcom/android/server/policy/GlobalActions$28;-><init>(Lcom/android/server/policy/GlobalActions;)V
    ...
    new-instance v4, Lcom/android/server/policy/GlobalActions$29;

    move-object/from16 v0, p0

    invoke-direct {v4, v0}, Lcom/android/server/policy/GlobalActions$29;-><init>(Lcom/android/server/policy/GlobalActions;)V
    ...
    new-instance v4, Lcom/android/server/policy/GlobalActions$26;

    move-object/from16 v0, p0

    invoke-direct {v4, v0}, Lcom/android/server/policy/GlobalActions$26;-><init>(Lcom/android/server/policy/GlobalActions;)V
...
.method private doAnimation(Landroid/view/View;FFFIZ)V
    ...
    new-instance v27, Lcom/android/server/policy/GlobalActions$38;

    move-object/from16 v0, v27

    move-object/from16 v1, p0

    invoke-direct {v0, v1, v10}, Lcom/android/server/policy/GlobalActions$38;-><init>(Lcom/android/server/policy/GlobalActions;Landroid/widget/FrameLayout;)V
...
.method private getLockdownAction()Lcom/android/server/policy/GlobalActions$Action;
    ...
    invoke-direct {v0, p0, v1, v2}, Lcom/android/server/policy/GlobalActions$43;-><init>(Lcom/android/server/policy/GlobalActions;II)V
...
.method private getPhoneStateListener(II)Landroid/telephony/PhoneStateListener;
    ...
    new-instance v0, Lcom/android/server/policy/GlobalActions$47;

    invoke-direct {v0, p0, p1}, Lcom/android/server/policy/GlobalActions$47;-><init>(Lcom/android/server/policy/GlobalActions;I)V
...
.method private handleShow()V
    ...
    invoke-virtual {v3, v8}, Lcom/android/server/policy/GlobalActions$MyAdapter;->getItem(I)Lcom/android/server/policy/GlobalActions$Action;
    ...
    sput-boolean v8, Lcom/android/server/policy/GlobalActions;->mIsMiniDialogMode:Z
    ...
    const-string/jumbo v5, "handleShow(), mini dialog showed."
    ...
    const-string/jumbo v6, "handleShow() : mIsCoverOpen = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    sget-boolean v6, Lcom/android/server/policy/GlobalActions;->mIsCoverOpen:Z
    ...
    sget v5, Lcom/android/server/policy/GlobalActions;->mClearCoverWidth:I
    ...
    invoke-virtual {v3, v8}, Landroid/view/Window;->setWindowAnimations(I)V
    ...
    iget-object v3, p0, Lcom/android/server/policy/GlobalActions;->mScrollview:Landroid/widget/ScrollView;
    ...
    sget v5, Lcom/android/server/policy/GlobalActions;->mSViewCoverWidth:I

    sget v6, Lcom/android/server/policy/GlobalActions;->mSViewCoverHeight:I

    sget v7, Lcom/android/server/policy/GlobalActions;->mStatusHeight:I
    ...
    :cond_f
    iget-object v3, p0, Lcom/android/server/policy/GlobalActions;->mHorizontalScrollView:Landroid/widget/HorizontalScrollView;

    if-eqz v3, :cond_b

    iget-object v3, p0, Lcom/android/server/policy/GlobalActions;->mHorizontalScrollView:Landroid/widget/HorizontalScrollView;

    invoke-virtual {v3, v10}, Landroid/widget/HorizontalScrollView;->setVisibility(I)V
...
.method private initValueForCreate(Z)V
    ...
    iput-boolean v5, p0, Lcom/android/server/policy/GlobalActions;->mIsConfirmPoweroffonClearCover:Z
    ...
    iput-object v3, p0, Lcom/android/server/policy/GlobalActions;->mDesktopModeManager:Lcom/samsung/android/desktopmode/SemDesktopModeManager;

    new-instance v3, Lcom/android/server/policy/GlobalActions$13;

    invoke-direct {v3, p0}, Lcom/android/server/policy/GlobalActions$13;-><init>(Lcom/android/server/policy/GlobalActions;)V

    iput-object v3, p0, Lcom/android/server/policy/GlobalActions;->mDesktopModeEventListener:Lcom/samsung/android/desktopmode/SemDesktopModeManager$EventListener;

    iget-object v3, p0, Lcom/android/server/policy/GlobalActions;->mDesktopModeManager:Lcom/samsung/android/desktopmode/SemDesktopModeManager;

    iget-object v3, p0, Lcom/android/server/policy/GlobalActions;->mDesktopModeEventListener:Lcom/samsung/android/desktopmode/SemDesktopModeManager$EventListener;
...
.method private isSimReady()Z
    ...
    new-instance v5, Lcom/android/server/policy/GlobalActions$46;

    invoke-direct {v5, p0}, Lcom/android/server/policy/GlobalActions$46;-><init>(Lcom/android/server/policy/GlobalActions;)V
...
.method private isTouchInside(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    sget-boolean v4, Lcom/android/server/policy/GlobalActions;->mIsConfirmDlg:Z

    if-nez v4, :cond_0

    sget-boolean v4, Lcom/android/server/policy/GlobalActions;->mIsConfirmLandDlg:Z
...
.method private makeActionsItem(Lcom/android/server/policy/GlobalActions$Action;IZ)Landroid/view/View;
    ...
    invoke-interface {v0, v4, v7, v9, v5}, Lcom/android/server/policy/GlobalActions$Action;->create(Landroid/content/Context;Landroid/view/View;Landroid/view/ViewGroup;Landroid/view/LayoutInflater;)Landroid/view/View;
    ...
    iget v5, v0, Lcom/android/server/policy/GlobalActions;->mConfirmPowerOffIconResId:I

    sget v7, Lcom/android/server/policy/GlobalActions;->mCurrentDensity:I

    invoke-virtual {v4, v5, v7}, Landroid/content/res/Resources;->getDrawableForDensity(II)Landroid/graphics/drawable/Drawable;
    ...
    iget v5, v0, Lcom/android/server/policy/GlobalActions;->mSafeModeIconResId:I
    ...
    invoke-virtual {v13, v4}, Landroid/widget/ImageView;->setAlpha(F)V
    ...
    iget v4, v0, Lcom/android/server/policy/GlobalActions;->mItemDivider:I
    ...
    invoke-virtual {v14, v5, v7, v9, v4}, Landroid/widget/LinearLayout$LayoutParams;->setMargins(IIII)V
    ...
    invoke-virtual {v11, v4}, Landroid/widget/FrameLayout;->setClickable(Z)V

    const/4 v4, 0x1

    invoke-virtual {v11, v4}, Landroid/widget/FrameLayout;->setFocusable(Z)V

    new-instance v4, Lcom/android/server/policy/GlobalActions$32;
    ...
    invoke-direct/range {v4 .. v9}, Lcom/android/server/policy/GlobalActions$32;-><init>(Lcom/android/server/policy/GlobalActions;Landroid/widget/ImageView;Lcom/android/server/policy/GlobalActions$Action;Landroid/view/View;Z)V

    invoke-virtual {v11, v4}, Landroid/widget/FrameLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance v4, Lcom/android/server/policy/GlobalActions$33;
    ...
    invoke-direct/range {v4 .. v9}, Lcom/android/server/policy/GlobalActions$33;-><init>(Lcom/android/server/policy/GlobalActions;Landroid/widget/ImageView;Lcom/android/server/policy/GlobalActions$Action;Landroid/view/View;Z)V

    invoke-virtual {v11, v4}, Landroid/widget/FrameLayout;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V

    new-instance v4, Lcom/android/server/policy/GlobalActions$34;
    ...
    invoke-direct {v4, v0, v1, v8, v2}, Lcom/android/server/policy/GlobalActions$34;-><init>(Lcom/android/server/policy/GlobalActions;Lcom/android/server/policy/GlobalActions$Action;Landroid/view/View;Z)V
    ...
    const-string/jumbo v5, "AccessibilityManager Enabled"
    ...
    invoke-virtual {v4, v7, v5}, Landroid/content/res/Resources;->getDrawableForDensity(II)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    invoke-virtual {v11, v4}, Landroid/widget/FrameLayout;->setForeground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {v5, v7, v9, v0, v1}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V
    ...
    iget v5, v0, Lcom/android/server/policy/GlobalActions;->mConfirmRestartIconResId:I
    ...
    iget v4, v0, Lcom/android/server/policy/GlobalActions;->mItemDividerLand:I
    ...
    invoke-virtual {v14, v5, v7, v4, v9}, Landroid/widget/LinearLayout$LayoutParams;->setMargins(IIII)V
    ...
    const-string/jumbo v5, "AccessibilityManager Disabled"
...
.method private onClickForHideLandscapeConfirmDialog(Z)V
    ...
    iput-boolean v6, p0, Lcom/android/server/policy/GlobalActions;->mIsConfirmPoweroffonClearCover:Z
...
.method private performItemLongClickForSafemode(Lcom/android/server/policy/GlobalActions$Action;Landroid/view/View;Z)V
    ...
    sget-boolean v1, Lcom/android/server/policy/GlobalActions;->mIsConfirmDlg:Z

    if-nez v1, :cond_1

    sget-boolean v1, Lcom/android/server/policy/GlobalActions;->mIsConfirmLandDlg:Z
...
.method private updateActions(ILcom/android/server/policy/GlobalActions$ToggleAction$State;)V
    ...
    :cond_b
    const-string/jumbo v10, "com.samsung.android.app.bikemode"

    invoke-direct {p0, v10}, Lcom/android/server/policy/GlobalActions;->isSBikeInstalled(Ljava/lang/String;)Z
...
.method adjustBottomView()V
    ...
    new-instance v8, Lcom/android/server/policy/GlobalActions$48;

    invoke-direct {v8, p0}, Lcom/android/server/policy/GlobalActions$48;-><init>(Lcom/android/server/policy/GlobalActions;)V
...
.method calculateDescritionViewHeight(Landroid/view/View;I)V
    ...
    iget v2, p0, Lcom/android/server/policy/GlobalActions;->mItemMaxWidthForClearCoverClosed:I
