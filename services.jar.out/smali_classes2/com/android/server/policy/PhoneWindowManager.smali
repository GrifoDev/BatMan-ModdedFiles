...
.method public constructor <init>()V
    ...
    iput-boolean v2, p0, Lcom/android/server/policy/PhoneWindowManager;->mWakeAndUnlock:Z
...
.method private configureNavBarOpacity(IZZZLandroid/view/WindowManagerPolicy$WindowState;)I
    ...
    invoke-interface {p5}, Landroid/view/WindowManagerPolicy$WindowState;->getAttrs()Landroid/view/WindowManager$LayoutParams;
...
.method private finishPowerKeyPress()V
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mPowerKeyUpHandled:Z
...
.method private interceptPowerKeyDown(Landroid/view/KeyEvent;Z)V
    ...
    invoke-interface {v0}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isPossibleEndCallByPowerKey()Z
...
.method private interceptPowerKeyUp(Landroid/view/KeyEvent;ZZ)V
    ...
    :goto_0
    iput-boolean v4, p0, Lcom/android/server/policy/PhoneWindowManager;->mPowerKeyUpHandled:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/policy/PhoneWindowManager;->mPowerKeyUpHandled:Z

    if-eqz v4, :cond_0

    iget v4, p0, Lcom/android/server/policy/PhoneWindowManager;->mTriplePressOnPowerBehavior:I
    ...
    invoke-virtual {v7, v9, v4, v6, v8}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-direct {p0, v0, v1, p2, v4}, Lcom/android/server/policy/PhoneWindowManager;->powerPress(JZI)V
...
.method private isKnoxKeyguardWindow(Landroid/view/WindowManagerPolicy$WindowState;)Z
    ...
    invoke-virtual {v4, v5, v3}, Lcom/android/server/pm/PersonaManagerService;->isShowKeyguardExceptionalCase(Ljava/lang/String;Z)Z
    ...
    iput v4, p0, Lcom/android/server/policy/PhoneWindowManager;->mKnoxUserToShowKeyguard:I
...
.method private layoutNavigationBar(IIIIIIILandroid/graphics/Rect;ZZZZLandroid/graphics/Rect;)Z
    .locals 15
    ...
    invoke-virtual/range {p13 .. p13}, Landroid/graphics/Rect;->isEmpty()Z
    ...
    invoke-virtual {v2}, Lcom/android/server/policy/ImmersiveModeConfirmation;->handleHide()Z
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/server/policy/PhoneWindowManager;->getNavigationBarWidth(II)I
...
.method private layoutStatusBar(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;IZLandroid/graphics/Rect;)Z
    .locals 11
    ...
    invoke-interface {v1}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->getChangeRatioBarSize()I
...
.method private takeScreenshot(I)V
    ...
    iget-object v0, v0, Lcom/android/server/policy/PhoneWindowManager;->mScreenshotLock:Ljava/lang/Object;
    ...
    const-string/jumbo v18, "takeScreenshot() mScreenshotConnection is not null."
    ...
    const-string/jumbo v19, "takeScreenshot() screenshotType : "
    ...
    iget-object v0, v0, Lcom/android/server/policy/PhoneWindowManager;->mSemPersonaManager:Lcom/samsung/android/knox/SemPersonaManager;

    move-object/from16 v16, v0

    invoke-virtual/range {v16 .. v16}, Lcom/samsung/android/knox/SemPersonaManager;->getFocusedUser()I
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/samsung/android/knox/SemPersonaManager;->getPersonaIds()[I
    ...
    invoke-static/range {v16 .. v16}, Lcom/samsung/android/knox/restriction/IRestrictionPolicy$Stub;->asInterface(Landroid/os/IBinder;)Lcom/samsung/android/knox/restriction/IRestrictionPolicy;
    ...
    invoke-virtual {v0, v1}, Lcom/samsung/android/knox/SemPersonaManager;->isKnoxKeyguardShown(I)Z
    ...
    invoke-interface {v11, v7, v0}, Lcom/samsung/android/knox/restriction/IRestrictionPolicy;->isScreenCaptureEnabledEx(IZ)Z
    ...
    const-string/jumbo v18, "takeScreenshot() KnoxKeyguardExist. can not takescreenshot."
    ...
    invoke-virtual {v14, v7}, Landroid/os/UserManager;->getUserInfo(I)Landroid/content/pm/UserInfo;
    ...
    invoke-static/range {v16 .. v16}, Lcom/samsung/android/knox/SemPersonaManager;->isKioskModeEnabled(Landroid/content/Context;)Z
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/samsung/android/knox/SemPersonaManager;->getKioskId()I
    ...
    const-string/jumbo v18, "com.android.systemui.screenshot.TakeScreenshotService"
    ...
    invoke-direct {v4, v0, v1}, Lcom/android/server/policy/PhoneWindowManager$19;-><init>(Lcom/android/server/policy/PhoneWindowManager;I)V
    ...
    const-string/jumbo v19, " screenshot is taken for user "
    ...
    invoke-virtual {v0, v13, v4, v1, v5}, Landroid/content/Context;->bindServiceAsUser(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mScreenshotConnection:Landroid/content/ServiceConnection;
    ...
    iget-object v0, v0, Lcom/android/server/policy/PhoneWindowManager;->mScreenshotTimeout:Ljava/lang/Runnable;
...
.method private updateSystemBarsLw(Landroid/view/WindowManagerPolicy$WindowState;II)I
    ...
    invoke-virtual {v4, v5}, Lcom/android/server/policy/BarController;->setShowTransparent(Z)V
    ...
    invoke-interface {v4, v0, v9, v1, v2}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->updateSystemBarsLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManagerPolicy$WindowState;II)I
    ...
    invoke-virtual {v0, v5}, Lcom/android/server/policy/PhoneWindowManager;->windowTypeToLayerLw(I)I
    ...
    invoke-interface {v4}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isMirrorLinkEnabled()Z
    ...
    iget v15, v0, Lcom/android/server/policy/PhoneWindowManager;->mDisplayRotation:I

    invoke-virtual/range {v10 .. v16}, Lcom/android/server/policy/ImmersiveModeConfirmation;->immersiveModeChangedLw(Ljava/lang/String;ZZZIZ)V
...
.method private volumeWake(I)V
    ...
    invoke-virtual {v0, v3, v4}, Landroid/os/PowerManager;->wakeUp(J)V
...
.method public addStartingWindow(Landroid/os/IBinder;Ljava/lang/String;ILandroid/content/res/CompatibilityInfo;Ljava/lang/CharSequence;IIIILandroid/content/res/Configuration;Landroid/graphics/Bitmap;I)Landroid/view/View;
    ...
    invoke-interface/range {v20 .. v20}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->getCoverStateSwitch()Z
    ...
    invoke-interface/range {v20 .. v20}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isMobileKeyboardEnabled()Z
    ...
    invoke-static/range {v20 .. v21}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_9
    .catch Landroid/view/InflateException; {:try_start_9 .. :try_end_9} :catch_2
...
.method public adjustSystemUiVisibilityLw(I)I
    ...
    invoke-interface {v1, p1}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->adjustSystemUiVisibilityLw(I)I
...
.method public applyPostLayoutPolicyLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;Landroid/view/WindowManagerPolicy$WindowState;)V
    ...
    const-string/jumbo v19, ": isVisibleOrBehindKeyguardLw="
    ...
    invoke-interface/range {v17 .. v17}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isCarModeBarVisible()Z
    ...
    invoke-interface/range {v17 .. v17}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->getHideSViewCover()I
    ...
    invoke-interface/range {v17 .. v17}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isForceHideBySViewCover()Z
    ...
    invoke-interface/range {v17 .. v18}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->setForceStatusBarFromSViewCover(Z)V
    ...
    invoke-static {v15}, Landroid/app/ActivityManager$StackId;->normallyFullscreenWindows(I)Z
    ...
    invoke-interface {v0, v1, v2, v3, v4}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->applyPostLayoutPolicyLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;Landroid/view/WindowManagerPolicy$WindowState;Z)V
    ...
    invoke-interface {v0, v1, v2, v3}, Lcom/android/server/policy/EdgeWindowPolicy;->applyPostLayoutPolicyLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;)V
    ...
    const-string/jumbo v17, "Shared devices"

    const-string/jumbo v18, "Force status bar SD type privflag"
    ...
    invoke-interface/range {v17 .. v18}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->setShowingSViewCover(Z)V
    ...
    invoke-interface/range {v17 .. v17}, Landroid/view/WindowManagerPolicy$WindowManagerFuncs;->getFocusedAppTokenLw()Landroid/view/IApplicationToken;

    move-result-object v9

    invoke-static {v15}, Landroid/app/ActivityManager$StackId;->tasksAreFloating(I)Z
    ...
    invoke-interface/range {v17 .. v17}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isKnoxDesktopMode()Z
    ...
    invoke-interface/range {v17 .. v17}, Landroid/view/WindowManagerPolicy$WindowState;->inFreeformWorkspace()Z
    ...
    sget-object v18, Lcom/samsung/android/knox/SemPersonaState;->LOCKED:Lcom/samsung/android/knox/SemPersonaState;

    invoke-virtual/range {v17 .. v18}, Lcom/samsung/android/knox/SemPersonaManager$StateManager;->inState(Lcom/samsung/android/knox/SemPersonaState;)Z
    ...
    const-string/jumbo v19, "Fullscreen window: "
    ...
    const-string/jumbo v19, "Setting mDismissKeyguard true by win "
    ...
    const-string/jumbo v19, "Setting mHideLockScreen to true by win "
    ...
    invoke-interface {v0, v1, v2}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->applyForceUserActivityTimeoutWin(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;)V
...
.method public beginLayoutLw(ZIIII)V
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/android/server/policy/PhoneWindowManager;->beginLayoutLw(ZIIIILandroid/graphics/Rect;I)V

    return-void
.end method

.method public beginLayoutLw(ZIIIILandroid/graphics/Rect;I)V
    .locals 39
    ...
    iget v5, v0, Lcom/android/server/policy/PhoneWindowManager;->mUnrestrictedScreenWidth:I

    iput v5, v4, Lcom/android/server/policy/SystemGesturesPointerEventListener;->screenWidth:I
    ...
    iget v5, v0, Lcom/android/server/policy/PhoneWindowManager;->mUnrestrictedScreenHeight:I

    iput v5, v4, Lcom/android/server/policy/SystemGesturesPointerEventListener;->screenHeight:I
    ...
    invoke-direct/range {v4 .. v17}, Lcom/android/server/policy/PhoneWindowManager;->layoutNavigationBar(IIIIIIILandroid/graphics/Rect;ZZZZLandroid/graphics/Rect;)Z
    ...
    invoke-direct/range {v17 .. v25}, Lcom/android/server/policy/PhoneWindowManager;->layoutStatusBar(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;IZLandroid/graphics/Rect;)Z
...
.method public createForceHideWallpaperExitAnimation(Z)Landroid/view/animation/Animation;
    ...
    invoke-interface {v0, v1}, Lcom/android/server/policy/AODWindowPolicy;->isAODWindowHasWallpaper(Landroid/view/WindowManager$LayoutParams;)Z
...
.method public finishPostLayoutPolicyLw()I
    ...
    const-string/jumbo v12, " forcetrans="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-boolean v12, p0, Lcom/android/server/policy/PhoneWindowManager;->mForceStatusBarTransparent:Z
    ...
    const-string/jumbo v12, "statusBarExpandedNotKeyguard="
    ...
    const-string/jumbo v12, " shouldBeTransparent="
    ...
    const-string/jumbo v12, " mShowingDream="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-boolean v12, p0, Lcom/android/server/policy/PhoneWindowManager;->mShowingDream:Z

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v11

    const-string/jumbo v12, " mKeyguardOccluded="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-boolean v12, p0, Lcom/android/server/policy/PhoneWindowManager;->mKeyguardOccluded:Z

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v11

    const-string/jumbo v12, " isKeyguardShowing="
    ...
    const-string/jumbo v12, " mStatusBar.isAnimatingLw()="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v12, p0, Lcom/android/server/policy/PhoneWindowManager;->mStatusBar:Landroid/view/WindowManagerPolicy$WindowState;
    ...
    const-string/jumbo v12, "finishPostLayoutPolicyLw() : mTopFullscreenOpaqueWindowState="
    ...
    const-string/jumbo v11, "** SHOWING status bar: transient showing"
    ...
    const-string/jumbo v11, "** HIDING status bar : full screen activity"
    ...
    iget-object v11, p0, Lcom/android/server/policy/PhoneWindowManager;->mWinDismissingKeyguard:Landroid/view/WindowManagerPolicy$WindowState;
...
.method public finishedGoingToSleep(I)V
    ...
    invoke-interface {v2, p1}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->finishedGoingToSleep(I)V
...
.method getMaxMultiPressPowerCount()I
    ...
    invoke-interface {v0}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isAvailableOneTouchReport()Z
...
.method public getNavigationBarHeight(II)I
    ...
    invoke-interface {v0}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isDesktopModeForPreparing()Z
    ...
    invoke-interface {v0}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->getTaskBarHeightInDesktopMode()I
...
.method public getNavigationBarWidth(II)I
    .locals 2
...
.method public getNonDecorDisplayHeight(IIIII)I
    ...
    invoke-interface {v0}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isNavigationBarDisabled()Z
...
.method public getNonDecorDisplayWidth(IIIII)I
    ...
    invoke-virtual {p0, p3, p4}, Lcom/android/server/policy/PhoneWindowManager;->getNavigationBarWidth(II)I
...
.method public getNonDecorInsetsLw(IIILandroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, p1, v1}, Lcom/android/server/policy/PhoneWindowManager;->getNavigationBarWidth(II)I
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    iget-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mDisplay:Landroid/view/Display;
    ...
    :try_start_0
    invoke-interface/range {v25 .. v25}, Landroid/service/dreams/IDreamManager;->isDreaming()Z
    ...
    const-string/jumbo v7, "interceptKeyTi dozeMode = "
    ...
    const-string/jumbo v6, "RemoteException when checking if dreaming"
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    sget-boolean v22, Lcom/android/server/wm/WindowManagerDebugConfig;->SAFE_DEBUG:Z
    ...
    const-string/jumbo v24, "interceptKeyTq mSystemBooted = "
    ...
    invoke-direct {v0, v14}, Lcom/android/server/policy/PhoneWindowManager;->volumeWake(I)V
    ...
    const-string/jumbo v24, "interceptKeyTq result = "
    ...
    invoke-interface/range {v22 .. v22}, Lcom/android/server/policy/EdgeWindowPolicy;->isEdgeWakeupPending()Z
    ...
    invoke-interface/range {v22 .. v22}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isVolumeKeyMode()Z
    ...
    const-string/jumbo v23, "ringing: Accept the call(volume up)"
...
.method public isScreenOn()Z
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mWakeAndUnlock:Z
...
.method launchHomeFromHotKey(ZZ)V
    ...
    invoke-interface {v2}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->performHome()V
...
.method public layoutWindowLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManagerPolicy$WindowState;)V
    ...
    iget v3, v0, Lcom/android/server/policy/PhoneWindowManager;->mContentBottom:I
    ...
    iget v3, v0, Lcom/android/server/policy/PhoneWindowManager;->mVoiceContentBottom:I
    ...
    sget-object v25, Lcom/android/server/policy/PhoneWindowManager;->mTmpDecorFrame:Landroid/graphics/Rect;

    sget-object v26, Lcom/android/server/policy/PhoneWindowManager;->mTmpStableFrame:Landroid/graphics/Rect;
    ...
    sget-object v27, Lcom/android/server/policy/PhoneWindowManager;->mTmpOutsetFrame:Landroid/graphics/Rect;
    ...
    invoke-static/range {v45 .. v45}, Ljava/lang/Integer;->toHexString(I)Ljava/lang/String;
    ...
    invoke-interface/range {v19 .. v27}, Landroid/view/WindowManagerPolicy$WindowState;->computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public onConfigurationChanged()V
    ...
    invoke-interface {v2}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->updateTaskBarHeightInDesktopMode()V
...
.method public screenTurnedOff()V
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mWakeAndUnlock:Z
...
.method public selectAnimationLw(Landroid/view/WindowManagerPolicy$WindowState;I)I
    ...
    invoke-interface {p1}, Landroid/view/WindowManagerPolicy$WindowState;->whichCustomStartingAnimationLw()I
...
.method public setWakeAndUnlock(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/policy/PhoneWindowManager;->mWakeAndUnlock:Z
...
.method startDockOrHome(ZZ)V
    ...
    invoke-interface {v4, v1}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isDockHomeEnabled(Landroid/content/Intent;)Z
    ...
    invoke-interface {v4, p1}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->launchHomeActivity(Z)V
