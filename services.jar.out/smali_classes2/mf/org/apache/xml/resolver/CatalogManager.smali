...
.method private queryCatalogFiles()Ljava/lang/String;
    ...
    const-string/jumbo v4, ": catalogs not found."
...
.method private queryRelativeCatalogs()Z
    ...
    const-string/jumbo v3, "relative-catalogs"
...
.method private queryUseStaticCatalog()Z
    ...
    const-string/jumbo v3, "static-catalog"
...
.method private queryVerbosity()I
    ...
    iget v5, p0, Lmf/org/apache/xml/resolver/CatalogManager;->defaultVerbosity:I

    invoke-static {v5}, Ljava/lang/Integer;->toString(I)Ljava/lang/String;

    move-result-object v0

    sget-object v5, Lmf/org/apache/xml/resolver/CatalogManager;->pVerbosity:Ljava/lang/String;
    ...
    :goto_0
    iget v3, p0, Lmf/org/apache/xml/resolver/CatalogManager;->defaultVerbosity:I
    ...
    const-string/jumbo v6, "verbosity"
    ...
    const-string/jumbo v7, "Cannot parse verbosity: \""
...
.method private declared-synchronized readProperties()V
    ...
    const-class v7, Lmf/org/apache/xml/resolver/CatalogManager;

    invoke-virtual {v7, v6}, Ljava/lang/Class;->getResource(Ljava/lang/String;)Ljava/net/URL;

    move-result-object v6

    iput-object v6, p0, Lmf/org/apache/xml/resolver/CatalogManager;->propertyFileURI:Ljava/net/URL;
    ...
    invoke-direct {v6, v2}, Ljava/util/PropertyResourceBundle;-><init>(Ljava/io/InputStream;)V

    iput-object v6, p0, Lmf/org/apache/xml/resolver/CatalogManager;->resources:Ljava/util/ResourceBundle;
    :try_end_0
    .catch Ljava/util/MissingResourceException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_0
    :try_start_1
    iget-object v6, p0, Lmf/org/apache/xml/resolver/CatalogManager;->verbosity:Ljava/lang/Integer;
    :try_end_1
    ...
    :cond_1
    :try_start_2
    iget-boolean v6, p0, Lmf/org/apache/xml/resolver/CatalogManager;->ignoreMissingProperties:Z
    :try_end_2
    ...
    iget-object v8, p0, Lmf/org/apache/xml/resolver/CatalogManager;->propertyFile:Ljava/lang/String;
    ...
    iput-boolean v6, p0, Lmf/org/apache/xml/resolver/CatalogManager;->ignoreMissingProperties:Z
    :try_end_3
    ...
    const-string/jumbo v8, "Failure trying to read "
    ...
    :cond_3
    :try_start_6
    iget-object v6, p0, Lmf/org/apache/xml/resolver/CatalogManager;->resources:Ljava/util/ResourceBundle;

    const-string/jumbo v7, "verbosity"
    ...
    invoke-virtual {v6, v4}, Lmf/org/apache/xml/resolver/helpers/Debug;->setDebug(I)V

    new-instance v6, Ljava/lang/Integer;

    invoke-direct {v6, v4}, Ljava/lang/Integer;-><init>(I)V

    iput-object v6, p0, Lmf/org/apache/xml/resolver/CatalogManager;->verbosity:Ljava/lang/Integer;
    :try_end_6
...
.method public getPrivateCatalog()Lmf/org/apache/xml/resolver/Catalog;
    ...
    iget-object v7, p0, Lmf/org/apache/xml/resolver/CatalogManager;->useStaticCatalog:Ljava/lang/Boolean;
    ...
    iput-object v7, p0, Lmf/org/apache/xml/resolver/CatalogManager;->useStaticCatalog:Ljava/lang/Boolean;
    ...
    iget-object v7, p0, Lmf/org/apache/xml/resolver/CatalogManager;->debug:Lmf/org/apache/xml/resolver/helpers/Debug;

    new-instance v8, Ljava/lang/StringBuilder;

    const-string/jumbo v9, "Catalog class named \'"
    ...
    const-string/jumbo v10, "\' could not be found. Using default."
    ...
    const-string/jumbo v9, "Class named \'"
    ...
    const-string/jumbo v10, "\' is not a Catalog. Using default."
...
.method public queryAllowOasisXMLCatalogPI()Z
    ...
    const-string/jumbo v3, "allow-oasis-xml-catalog-pi"
...
.method public queryCatalogClassName()Ljava/lang/String;
    ...
    sget-object v2, Lmf/org/apache/xml/resolver/CatalogManager;->pClassname:Ljava/lang/String;
    ...
    const-string/jumbo v3, "catalog-class-name"
