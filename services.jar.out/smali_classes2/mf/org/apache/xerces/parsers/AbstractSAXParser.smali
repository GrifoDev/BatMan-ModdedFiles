...
.method public getFeature(Ljava/lang/String;)Z
    ...
    invoke-interface {v3, p1}, Lmf/org/apache/xerces/xni/parser/XMLParserConfiguration;->getFeature(Ljava/lang/String;)Z
    ...
    instance-of v3, v3, Lmf/org/apache/xerces/parsers/XML11Configurable;
...
.method public getProperty(Ljava/lang/String;)Ljava/lang/Object;
    ...
    const-string/jumbo v3, "document-xml-version"
    ...
    :cond_3
    const-string/jumbo v3, "declaration-handler"
    ...
    :cond_4
    const-string/jumbo v3, "dom-node"
    ...
    const-string/jumbo v5, "dom-node-read-not-supported"
...
.method public parse(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {p0, v4}, Lmf/org/apache/xerces/parsers/AbstractSAXParser;->parse(Lmf/org/apache/xerces/xni/parser/XMLInputSource;)V
    :try_end_0
    ...
    iget-object v5, p0, Lmf/org/apache/xerces/parsers/AbstractSAXParser;->fVersion:Ljava/lang/String;

    invoke-virtual {v3, v5}, Lorg/xml/sax/ext/Locator2Impl;->setXMLVersion(Ljava/lang/String;)V

    invoke-virtual {v1}, Lmf/org/apache/xerces/xni/parser/XMLParseException;->getPublicId()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v3, v5}, Lorg/xml/sax/ext/Locator2Impl;->setPublicId(Ljava/lang/String;)V

    invoke-virtual {v1}, Lmf/org/apache/xerces/xni/parser/XMLParseException;->getExpandedSystemId()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v3, v5}, Lorg/xml/sax/ext/Locator2Impl;->setSystemId(Ljava/lang/String;)V

    invoke-virtual {v1}, Lmf/org/apache/xerces/xni/parser/XMLParseException;->getLineNumber()I

    move-result v5

    invoke-virtual {v3, v5}, Lorg/xml/sax/ext/Locator2Impl;->setLineNumber(I)V

    invoke-virtual {v1}, Lmf/org/apache/xerces/xni/parser/XMLParseException;->getColumnNumber()I

    move-result v5

    invoke-virtual {v3, v5}, Lorg/xml/sax/ext/Locator2Impl;->setColumnNumber(I)V
...
.method public setEntityResolver(Lorg/xml/sax/EntityResolver;)V
    ...
    iget-boolean v5, p0, Lmf/org/apache/xerces/parsers/AbstractSAXParser;->fUseEntityResolver2:Z
...
.method public setFeature(Ljava/lang/String;Z)V
    ...
    const-string/jumbo v6, "feature-read-only"
    ...
    const-string/jumbo v6, "false-not-supported"
    ...
    const-string/jumbo v6, "true-not-supported"
...
.method public setProperty(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v4, p1, p2}, Lmf/org/apache/xerces/xni/parser/XMLParserConfiguration;->setProperty(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    const-string/jumbo v4, "lexical-handler"
    ...
    :cond_2
    const-string/jumbo v4, "declaration-handler"
    ...
    :cond_3
    const-string/jumbo v4, "dom-node"
    ...
    :cond_4
    const-string/jumbo v4, "document-xml-version"
    ...
    invoke-interface {v5}, Lmf/org/apache/xerces/xni/parser/XMLParserConfiguration;->getLocale()Ljava/util/Locale;
    ...
    const-string/jumbo v7, "property-read-only"

    invoke-static {v5, v7, v6}, Lmf/org/apache/xerces/util/SAXMessageFormatter;->formatMessage(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    const-string/jumbo v7, "org.xml.sax.ext.LexicalHandler"

    const/4 v8, 0x1

    aput-object v7, v6, v8

    const-string/jumbo v7, "incompatible-class"
    ...
    const-string/jumbo v7, "org.xml.sax.ext.DeclHandler"
