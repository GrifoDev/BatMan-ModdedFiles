...
.method static createObject(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;
    ...
    sget-boolean v21, Lmf/org/apache/xerces/parsers/ObjectFactory;->DEBUG:Z
    ...
    :try_start_0
    invoke-static/range {p0 .. p0}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    :try_end_0
    ...
    invoke-static/range {v21 .. v21}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;
    ...
    invoke-static/range {p0 .. p0}, Lmf/org/apache/xerces/parsers/ObjectFactory;->findJarServiceProvider(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v0, v8, v1}, Lmf/org/apache/xerces/parsers/ObjectFactory;->newInstance(Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;
    ...
    invoke-static/range {v21 .. v21}, Lmf/org/apache/xerces/parsers/ObjectFactory;->debugPrintln(Ljava/lang/String;)V
    ...
    invoke-static/range {v21 .. v21}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_4
    invoke-static {v15}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getFileExists(Ljava/io/File;)Z
    :try_end_4
    ...
    :goto_5
    const-class v6, Lmf/org/apache/xerces/parsers/ObjectFactory;

    const-class v21, Lmf/org/apache/xerces/parsers/ObjectFactory;
    ...
    :try_start_5
    sget-wide v22, Lmf/org/apache/xerces/parsers/ObjectFactory;->fLastModified:J
    :try_end_5
    ...
    sget-object v21, Lmf/org/apache/xerces/parsers/ObjectFactory;->fXercesProperties:Ljava/util/Properties;
    ...
    sput-wide v22, Lmf/org/apache/xerces/parsers/ObjectFactory;->fLastModified:J

    const/16 v21, 0x0

    sput-object v21, Lmf/org/apache/xerces/parsers/ObjectFactory;->fXercesProperties:Ljava/util/Properties;
    ...
    invoke-static {v14}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getLastModified(Ljava/io/File;)J

    move-result-wide v24

    sput-wide v24, Lmf/org/apache/xerces/parsers/ObjectFactory;->fLastModified:J
    ...
    invoke-static {v14}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;
    ...
    invoke-static {v10, v8, v0}, Lmf/org/apache/xerces/parsers/ObjectFactory;->newInstance(Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;
    ...
    :cond_16
    new-instance v21, Lmf/org/apache/xerces/parsers/ObjectFactory$ConfigurationError;
    ...
    invoke-direct/range {v21 .. v23}, Lmf/org/apache/xerces/parsers/ObjectFactory$ConfigurationError;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method static findClassLoader()Ljava/lang/ClassLoader;
    ...
    :cond_0
    const-class v4, Lmf/org/apache/xerces/parsers/ObjectFactory;
...
.method private static findJarServiceProvider(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v1, v7}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getResourceAsStream(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    sget-boolean v9, Lmf/org/apache/xerces/parsers/ObjectFactory;->DEBUG:Z
    ...
    :cond_2
    const-class v9, Lmf/org/apache/xerces/parsers/ObjectFactory;
    ...
    invoke-static {v2, v7}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getResourceAsStream(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    invoke-static {v9}, Lmf/org/apache/xerces/parsers/ObjectFactory;->debugPrintln(Ljava/lang/String;)V
    ...
    :goto_6
    invoke-static {v4, v1, v12}, Lmf/org/apache/xerces/parsers/ObjectFactory;->newInstance(Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;
...
.method private static isDebugEnabled()Z
    ...
    invoke-static {v2}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
...
.method static newInstance(Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;
    ...
    sget-boolean v4, Lmf/org/apache/xerces/parsers/ObjectFactory;->DEBUG:Z
    ...
    invoke-static {v4}, Lmf/org/apache/xerces/parsers/ObjectFactory;->debugPrintln(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/ClassNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    new-instance v4, Lmf/org/apache/xerces/parsers/ObjectFactory$ConfigurationError;
    ...
    invoke-direct {v4, v5, v2}, Lmf/org/apache/xerces/parsers/ObjectFactory$ConfigurationError;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-direct {v4, v5, v3}, Lmf/org/apache/xerces/parsers/ObjectFactory$ConfigurationError;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
