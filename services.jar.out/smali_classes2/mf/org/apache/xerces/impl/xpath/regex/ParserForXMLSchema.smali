...
.method protected static declared-synchronized getRange(Ljava/lang/String;Z)Lmf/org/apache/xerces/impl/xpath/regex/RangeToken;
    ...
    const-class v3, Lmf/org/apache/xerces/impl/xpath/regex/ParserForXMLSchema;
    ...
    sput-object v2, Lmf/org/apache/xerces/impl/xpath/regex/ParserForXMLSchema;->ranges:Ljava/util/Hashtable;

    new-instance v2, Ljava/util/Hashtable;

    invoke-direct {v2}, Ljava/util/Hashtable;-><init>()V

    sput-object v2, Lmf/org/apache/xerces/impl/xpath/regex/ParserForXMLSchema;->ranges2:Ljava/util/Hashtable;
    ...
    const-string/jumbo v5, "xml:isSpace"
    ...
    const-string/jumbo v4, "xml:isDigit"
    ...
    const-string/jumbo v5, "xml:isDigit"
    ...
    const-string/jumbo v4, "xml:isWord"
    ...
    const-string/jumbo v4, "xml:isNameChar"
    ...
    const-string/jumbo v5, "xml:isNameChar"
    ...
    invoke-virtual {v1, v2, v4}, Lmf/org/apache/xerces/impl/xpath/regex/Token;->addRange(II)V
    ...
    const-string/jumbo v4, "xml:isInitialNameChar"
    ...
    const-string/jumbo v5, "xml:isInitialNameChar"
...
.method decodeEscaped()I
    ...
    const-string/jumbo v2, "parser.process.1"

    invoke-virtual {p0, v2, v1}, Lmf/org/apache/xerces/impl/xpath/regex/ParserForXMLSchema;->ex(Ljava/lang/String;I)Lmf/org/apache/xerces/impl/xpath/regex/ParseException;
    ...
    const-string/jumbo v2, "parser.next.1"
...
.method protected parseCharacterClass(Z)Lmf/org/apache/xerces/impl/xpath/regex/RangeToken;
    ...
    :cond_8
    const-string/jumbo v12, "parser.atom.5"
    ...
    :cond_a
    iget v12, p0, Lmf/org/apache/xerces/impl/xpath/regex/ParserForXMLSchema;->offset:I

    const-string/jumbo v13, "parser.cc.5"

    invoke-virtual {p0, v13, v12}, Lmf/org/apache/xerces/impl/xpath/regex/ParserForXMLSchema;->ex(Ljava/lang/String;I)Lmf/org/apache/xerces/impl/xpath/regex/ParseException;
    ...
    const-string/jumbo v13, "parser.cc.8"
    ...
    const-string/jumbo v13, "parser.cc.6"
    ...
    const-string/jumbo v13, "parser.cc.7"
    ...
    const-string/jumbo v13, "parser.cc.2"
    ...
    const-string/jumbo v13, "parser.ope.3"
