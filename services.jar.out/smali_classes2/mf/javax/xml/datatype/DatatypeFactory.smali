...
.method public newDurationDayTime(Ljava/lang/String;)Lmf/javax/xml/datatype/Duration;
    ...
    const-string/jumbo v2, "Trying to create an xdt:dayTimeDuration with an invalid lexical representation of \"null\""
    ...
    const-string/jumbo v3, "Trying to create an xdt:dayTimeDuration with an invalid lexical representation of \""
    ...
    const-string/jumbo v3, "\", data model requires years and months only."
...
.method public newDurationYearMonth(Ljava/lang/String;)Lmf/javax/xml/datatype/Duration;
    ...
    const-string/jumbo v2, "Trying to create an xdt:yearMonthDuration with an invalid lexical representation of \"null\""
    ...
    const-string/jumbo v3, "Trying to create an xdt:yearMonthDuration with an invalid lexical representation of \""
    ...
    const-string/jumbo v3, "\", data model requires days and times only."
