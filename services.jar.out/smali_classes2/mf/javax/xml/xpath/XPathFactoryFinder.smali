...
.method static constructor <clinit>()V
    ...
    sput-boolean v3, Lmf/javax/xml/xpath/XPathFactoryFinder;->firstTime:Z
...
.method private _newFactory(Ljava/lang/String;)Lmf/javax/xml/xpath/XPathFactory;
    ...
    sget-object v18, Lmf/javax/xml/xpath/XPathFactoryFinder;->SERVICE_CLASS:Ljava/lang/Class;
    ...
    invoke-static/range {v17 .. v17}, Lmf/javax/xml/xpath/XPathFactoryFinder;->debugPrintln(Ljava/lang/String;)V

    sget-object v17, Lmf/javax/xml/xpath/XPathFactoryFinder;->ss:Lmf/javax/xml/xpath/SecuritySupport;

    move-object/from16 v0, v17

    invoke-virtual {v0, v11}, Lmf/javax/xml/xpath/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v17 .. v18}, Lmf/javax/xml/xpath/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_1
    sget-boolean v17, Lmf/javax/xml/xpath/XPathFactoryFinder;->firstTime:Z

    if-nez v17, :cond_4

    :goto_1
    sget-object v17, Lmf/javax/xml/xpath/XPathFactoryFinder;->cacheProps:Ljava/util/Properties;
    ...
    sget-object v18, Lmf/javax/xml/xpath/XPathFactoryFinder;->ss:Lmf/javax/xml/xpath/SecuritySupport;

    move-object/from16 v0, v18

    invoke-virtual {v0, v13}, Lmf/javax/xml/xpath/SecuritySupport;->getURLInputStream(Ljava/net/URL;)Ljava/io/InputStream;
    ...
    invoke-direct {v0, v1, v2, v3}, Lmf/javax/xml/xpath/XPathFactoryFinder;->loadFromService(Ljava/lang/String;Ljava/lang/String;Ljava/io/InputStream;)Lmf/javax/xml/xpath/XPathFactory;
    :try_end_2
    ...
    invoke-virtual {v0, v12, v1}, Lmf/javax/xml/xpath/XPathFactoryFinder;->createInstance(Ljava/lang/String;Z)Lmf/javax/xml/xpath/XPathFactory;
    :try_end_3
    ...
    sget-boolean v17, Lmf/javax/xml/xpath/XPathFactoryFinder;->debug:Z
    ...
    :cond_4
    :try_start_4
    sget-object v4, Lmf/javax/xml/xpath/XPathFactoryFinder;->cacheProps:Ljava/util/Properties;
    ...
    sput-boolean v17, Lmf/javax/xml/xpath/XPathFactoryFinder;->firstTime:Z

    sget-object v17, Lmf/javax/xml/xpath/XPathFactoryFinder;->ss:Lmf/javax/xml/xpath/SecuritySupport;

    move-object/from16 v0, v17

    invoke-virtual {v0, v8}, Lmf/javax/xml/xpath/SecuritySupport;->doesFileExist(Ljava/io/File;)Z
    ...
    invoke-virtual {v0, v8}, Lmf/javax/xml/xpath/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;
    ...
    invoke-virtual {v0, v9, v1}, Lmf/javax/xml/xpath/XPathFactoryFinder;->createInstance(Ljava/lang/String;Z)Lmf/javax/xml/xpath/XPathFactory;
    :try_end_8
    ...
    :cond_8
    const-string/jumbo v17, "http://java.sun.com/jaxp/xpath/dom"
    ...
    :cond_9
    const-string/jumbo v17, "attempting to use the platform default W3C DOM XPath lib"

    invoke-static/range {v17 .. v17}, Lmf/javax/xml/xpath/XPathFactoryFinder;->debugPrintln(Ljava/lang/String;)V

    const-string/jumbo v17, "com.sun.org.apache.xpath.internal.jaxp.XPathFactoryImpl"
    ...
    invoke-virtual {v0, v1, v2}, Lmf/javax/xml/xpath/XPathFactoryFinder;->createInstance(Ljava/lang/String;Z)Lmf/javax/xml/xpath/XPathFactory;
...
.method private createServiceFileIterator()Ljava/util/Iterator;
    ...
    iget-object v3, p0, Lmf/javax/xml/xpath/XPathFactoryFinder;->classLoader:Ljava/lang/ClassLoader;

    sget-object v4, Lmf/javax/xml/xpath/XPathFactoryFinder;->SERVICE_ID:Ljava/lang/String;

    invoke-virtual {v2, v3, v4}, Lmf/javax/xml/xpath/SecuritySupport;->getResources(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/util/Enumeration;
    ...
    :goto_0
    new-instance v2, Lmf/javax/xml/xpath/XPathFactoryFinder$2;

    invoke-direct {v2, p0, v1}, Lmf/javax/xml/xpath/XPathFactoryFinder$2;-><init>(Lmf/javax/xml/xpath/XPathFactoryFinder;Ljava/util/Enumeration;)V
    :try_end_0
    ...
    :cond_0
    new-instance v2, Lmf/javax/xml/xpath/XPathFactoryFinder$1;

    invoke-direct {v2, p0}, Lmf/javax/xml/xpath/XPathFactoryFinder$1;-><init>(Lmf/javax/xml/xpath/XPathFactoryFinder;)V
...
.method private loadFromService(Ljava/lang/String;Ljava/lang/String;Ljava/io/InputStream;)Lmf/javax/xml/xpath/XPathFactory;
    ...
    const-string/jumbo v9, "isObjectModelSupported"
    ...
    invoke-static {v15}, Lmf/javax/xml/xpath/XPathFactoryFinder;->debugPrintln(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v10}, Lmf/javax/xml/xpath/XPathFactoryFinder;->createClass(Ljava/lang/String;)Ljava/lang/Class;
    ...
    check-cast v14, Lmf/javax/xml/xpath/XPathFactory;
    :try_end_0
    ...
    :try_start_1
    const-string/jumbo v15, "isObjectModelSupported"
...
.method private static newInstanceNoServiceLoader(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    const-string/jumbo v4, "newXPathFactoryNoServiceLoader"
