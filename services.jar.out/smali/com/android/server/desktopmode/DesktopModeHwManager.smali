...
.method static synthetic -get16(Lcom/android/server/desktopmode/DesktopModeHwManager;)Z
    .locals 1
...
.method static synthetic -get17(Lcom/android/server/desktopmode/DesktopModeHwManager;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/desktopmode/DesktopModeHwManager;->mTouchpadEnabled:Z

    return v0
.end method

.method static synthetic -get18(Lcom/android/server/desktopmode/DesktopModeHwManager;)Lcom/android/server/wm/WindowManagerService;
    .locals 1
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/desktopmode/SettingsHelper;Landroid/os/Looper;)V
    ...
    iput-boolean v1, p0, Lcom/android/server/desktopmode/DesktopModeHwManager;->mTouchpadEnabled:Z
    ...
    invoke-direct {v0, p0}, Lcom/android/server/desktopmode/DesktopModeHwManager$4;-><init>(Lcom/android/server/desktopmode/DesktopModeHwManager;)V
    ...
    invoke-virtual {p2, v0}, Lcom/android/server/desktopmode/SettingsHelper;->registerListener(Lcom/android/server/desktopmode/SettingsHelper$OnSettingChangedListener;)V
    ...
    new-instance v1, Lcom/android/server/desktopmode/DesktopModeHwManager$5;

    invoke-direct {v1, p0}, Lcom/android/server/desktopmode/DesktopModeHwManager$5;-><init>(Lcom/android/server/desktopmode/DesktopModeHwManager;)V
...
.method private updateDockStatus()Z
    ...
    :cond_a
    :goto_2
    invoke-virtual {p0}, Lcom/android/server/desktopmode/DesktopModeHwManager;->updateTouchpadFeature()V
...
.method dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string/jumbo v0, "mTouchpadEnabled"

    iget-boolean v1, p0, Lcom/android/server/desktopmode/DesktopModeHwManager;->mTouchpadEnabled:Z
...
.method isTouchpadAvailable()Z
    ...
    const-string/jumbo v3, "isTouchpadAvailable(), mTouchpadEnabled="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/desktopmode/DesktopModeHwManager;->mTouchpadEnabled:Z
    ...
    iget-boolean v3, p0, Lcom/android/server/desktopmode/DesktopModeHwManager;->mIsExternalDisplayConnected:Z
...
.method synthetic lambda$-com_android_server_desktopmode_DesktopModeHwManager_31014(Z)V
    .locals 1
...
.method synthetic lambda$-com_android_server_desktopmode_DesktopModeHwManager_9012(Landroid/view/MotionEvent;)V
    .locals 6
...
.method updateTouchpadFeature()V
    .locals 1
    ...
    iput-boolean v0, p0, Lcom/android/server/desktopmode/DesktopModeHwManager;->mTouchpadEnabled:Z
