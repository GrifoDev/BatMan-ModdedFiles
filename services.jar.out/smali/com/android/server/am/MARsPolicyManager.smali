...
.method private isForegroundPackage(Lcom/android/server/am/MARsPackageStatus;)Z
    ...
    iget-boolean v2, p1, Lcom/android/server/am/MARsPackageStatus;->isTop:Z

    if-eqz v2, :cond_3

    iget-object v2, p0, Lcom/android/server/am/MARsPolicyManager;->mWindowManager:Lcom/android/server/wm/WindowManagerService;

    if-eqz v2, :cond_2

    iget-object v2, p0, Lcom/android/server/am/MARsPolicyManager;->mWindowManager:Lcom/android/server/wm/WindowManagerService;

    invoke-virtual {v2}, Lcom/android/server/wm/WindowManagerService;->getTopFullscreenOpaquePackage()Ljava/lang/String;

    move-result-object v0

    iget-object v2, p0, Lcom/android/server/am/MARsPolicyManager;->mWindowManager:Lcom/android/server/wm/WindowManagerService;

    invoke-virtual {v2}, Lcom/android/server/wm/WindowManagerService;->getTopFullscreenOpaqueUid()I
    ...
    :cond_1
    iput-boolean v4, p1, Lcom/android/server/am/MARsPackageStatus;->isAliveEmptyActivity:Z

    return v3

    :cond_2
    iput-boolean v3, p1, Lcom/android/server/am/MARsPackageStatus;->isAliveEmptyActivity:Z
...
.method private isLockScreenPackage(Lcom/android/server/am/MARsPackageStatus;Z)Z
    ...
    invoke-virtual {p0, v1, v3}, Lcom/android/server/am/MARsPolicyManager;->isRunningPackage(Ljava/lang/String;I)Z
...
.method public dumpMARs(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;)V
    ...
    :try_start_0
    const-string/jumbo v15, "ACTIVITY MANAGER MARs (dumpsys activity mars)"
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/am/MARsPolicyManager;->formatDateTime(J)Ljava/lang/String;
    ...
    const-string/jumbo v15, "--lastTriggerTime "
    ...
    iget-wide v0, v0, Lcom/android/server/am/MARsPolicyManager;->mLastTriggerTime:J
    ...
    const-string/jumbo v15, "mManagedPackages --- size "
    ...
    invoke-virtual {v15}, Lcom/android/server/am/MARsPolicyManager$MARsPkgMap;->size()I
    ...
    invoke-virtual {v15}, Lcom/android/server/am/MARsPolicyManager$MARsPkgMap;->getMap()Landroid/util/ArrayMap;
    ...
    iget-object v15, v0, Lcom/android/server/am/MARsPolicyManager;->appLockerPolicy:Lcom/android/server/am/MARsPolicyManager$Policy;
    ...
    iget-boolean v15, v15, Lcom/android/server/am/MARsPolicyManager$Policy;->enabled:Z
    ...
    iget-object v15, v0, Lcom/android/server/am/MARsPolicyManager;->autoRunPolicy:Lcom/android/server/am/MARsPolicyManager$Policy;
    ...
    iget v0, v11, Lcom/android/server/am/MARsPackageStatus;->state:I
    ...
    invoke-direct {v0, v1}, Lcom/android/server/am/MARsPolicyManager;->policyStateToString(I)Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Lcom/android/server/am/MARsPolicyManager;->policyStateToExtraValue(I)Ljava/lang/String;
    ...
    const-string/jumbo v15, "--RST "

    move-object/from16 v0, p2

    invoke-virtual {v0, v15}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-wide v0, v11, Lcom/android/server/am/MARsPackageStatus;->resetTime:J
    ...
    :cond_2
    const-string/jumbo v15, "--PkgType "

    move-object/from16 v0, p2

    invoke-virtual {v0, v15}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    const-string/jumbo v15, "%3d"
    ...
    iget v0, v11, Lcom/android/server/am/MARsPackageStatus;->packageType:I
    ...
    const-string/jumbo v15, "--IPT(A/L) "

    move-object/from16 v0, p2

    invoke-virtual {v0, v15}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    const-string/jumbo v15, "%5d"
    ...
    invoke-virtual {v0, v11, v1}, Lcom/android/server/am/MARsPolicyManager;->isCurrentImportantPackageForDump(Lcom/android/server/am/MARsPackageStatus;I)I
    ...
    const-string/jumbo v15, "--IPT(A/R) "
    ...
    const-string/jumbo v15, "--A/R "

    move-object/from16 v0, p2

    invoke-virtual {v0, v15}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget v15, v11, Lcom/android/server/am/MARsPackageStatus;->autorun:I
    ...
    iget-object v15, v0, Lcom/android/server/am/MARsPolicyManager;->freecessPolicy:Lcom/android/server/am/MARsPolicyManager$Policy;
    ...
    const-string/jumbo v15, "--ShareUid "

    move-object/from16 v0, p2

    invoke-virtual {v0, v15}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-object v15, v11, Lcom/android/server/am/MARsPackageStatus;->sharedUidName:Ljava/lang/String;
    ...
    iget-object v15, v11, Lcom/android/server/am/MARsPackageStatus;->skipReason:Ljava/lang/String;

    if-eqz v15, :cond_7

    const-string/jumbo v15, "--SkipReason "
    ...
    :cond_7
    iget-boolean v15, v11, Lcom/android/server/am/MARsPackageStatus;->isFreezed:Z

    if-eqz v15, :cond_c

    const-string/jumbo v15, "--Freezing"
    ...
    :cond_8
    :goto_3
    iget-boolean v15, v11, Lcom/android/server/am/MARsPackageStatus;->isOngoingNotification:Z
    ...
    :cond_9
    iget-boolean v15, v11, Lcom/android/server/am/MARsPackageStatus;->isVpn:Z
    ...
    invoke-virtual {v0, v15, v1}, Lcom/android/server/am/MARsPolicyManager;->isRunningPackage(Ljava/lang/String;I)Z
    ...
    :cond_e
    const-string/jumbo v15, "mRestrictedPackages --- size "
    ...
    iget-object v15, v0, Lcom/android/server/am/MARsPolicyManager;->mRestrictedPackages:Lcom/android/server/am/MARsPolicyManager$MARsPkgMap;
    ...
    const-string/jumbo v15, "--FZT "

    move-object/from16 v0, p2

    invoke-virtual {v0, v15}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-wide v0, v11, Lcom/android/server/am/MARsPackageStatus;->freezedTime:J
    ...
    const-string/jumbo v15, "--UFZT "

    move-object/from16 v0, p2

    invoke-virtual {v0, v15}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-wide v0, v11, Lcom/android/server/am/MARsPackageStatus;->unfreezedTime:J
    ...
    const-string/jumbo v15, "--FZR "

    move-object/from16 v0, p2

    invoke-virtual {v0, v15}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-object v15, v11, Lcom/android/server/am/MARsPackageStatus;->freezedReason:Ljava/lang/String;
    ...
    :cond_f
    const-string/jumbo v15, "--FST "

    move-object/from16 v0, p2

    invoke-virtual {v0, v15}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-wide v0, v11, Lcom/android/server/am/MARsPackageStatus;->forceStopTime:J
    ...
    iget-object v15, v11, Lcom/android/server/am/MARsPackageStatus;->appliedPolicies:Ljava/util/ArrayList;
    ...
    check-cast v15, Lcom/android/server/am/MARsPolicyManager$Policy;

    invoke-virtual {v15}, Lcom/android/server/am/MARsPolicyManager$Policy;->toString()Ljava/lang/String;
    ...
    iget v0, v11, Lcom/android/server/am/MARsPackageStatus;->isAREsTriggeredReason:I
    ...
    iget-object v15, v0, Lcom/android/server/am/MARsPolicyManager;->mWallpaperPackage:Ljava/lang/String;

    if-eqz v15, :cond_15

    const-string/jumbo v15, "mWallpaperPackage ---  "
    ...
    iget-object v15, v0, Lcom/android/server/am/MARsPolicyManager;->mCurrentHomePackage:Ljava/lang/String;

    if-eqz v15, :cond_16

    const-string/jumbo v15, "CurrentHomePackage ---  "
    ...
    iget-object v15, v0, Lcom/android/server/am/MARsPolicyManager;->aresPolicy:Lcom/android/server/am/MARsPolicyManager$Policy;
    ...
    iget-object v15, v0, Lcom/android/server/am/MARsPolicyManager;->mLatestProtectedPackages:Landroid/util/ArrayMap;

    if-eqz v15, :cond_18

    const-string/jumbo v15, "mLatestProtectedPackages "
    ...
    iget-object v15, v0, Lcom/android/server/am/MARsPolicyManager;->mDefaultIMEList:Landroid/util/ArrayMap;
    ...
    const-string/jumbo v15, "DefaultIMEPackage ---  "
    ...
    iget-boolean v15, v0, Lcom/android/server/am/MARsPolicyManager;->mSecureFolderEnabled:Z
    ...
    iget v0, v0, Lcom/android/server/am/MARsPolicyManager;->mSecureFolderUserId:I
    ...
    iget-object v15, v0, Lcom/android/server/am/MARsPolicyManager;->mFreezeTargetPackages:Landroid/util/ArrayMap;

    if-eqz v15, :cond_1c

    const-string/jumbo v15, "mFreezeTargetPackages "
    ...
    :cond_1c
    const-string/jumbo v15, "LockScreenPackage ---  "
    ...
    iget-object v15, v0, Lcom/android/server/am/MARsPolicyManager;->mLockScreenList:Landroid/util/ArrayMap;
...
.method public isAliveEmptyActivity(Ljava/lang/String;I)Z
    ...
    iget-boolean v2, v1, Lcom/android/server/am/MARsPackageStatus;->isAliveEmptyActivity:Z

    if-nez v2, :cond_0

    iget-boolean v2, v1, Lcom/android/server/am/MARsPackageStatus;->isInBlackListTopActivity:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
