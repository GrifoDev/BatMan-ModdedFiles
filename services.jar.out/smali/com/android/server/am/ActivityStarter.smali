...
.method private computeStackFocus(Lcom/android/server/am/ActivityRecord;ZLandroid/graphics/Rect;ILandroid/app/ActivityOptions;)Lcom/android/server/am/ActivityStack;
    ...
    invoke-virtual {v10}, Lcom/android/server/am/ActivityManagerService;->isKnoxDesktopModeLocked()Z
...
.method private getLaunchStack(Lcom/android/server/am/ActivityRecord;ILcom/android/server/am/TaskRecord;Landroid/app/ActivityOptions;)Lcom/android/server/am/ActivityStack;
    ...
    iget-object v10, v10, Lcom/android/server/am/ActivityStackSupervisor;->mBridge:Lcom/android/server/am/IActivityManagerServiceBridge;

    iget-object v11, p0, Lcom/android/server/am/ActivityStarter;->mStartActivity:Lcom/android/server/am/ActivityRecord;

    invoke-interface {v10, v11}, Lcom/android/server/am/IActivityManagerServiceBridge;->getLaunchStackVS(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityStack;
    ...
    :cond_2
    invoke-direct {p0, v4, p1}, Lcom/android/server/am/ActivityStarter;->isValidLaunchStackId(ILcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v10, v4, v11, v12}, Lcom/android/server/am/ActivityStackSupervisor;->getStack(IZZ)Lcom/android/server/am/ActivityStack;
    ...
    iget-object v10, p1, Lcom/android/server/am/ActivityRecord;->launchedFromPackage:Ljava/lang/String;
    ...
    iget v10, v7, Lcom/android/server/am/TaskRecord;->mHiddenState:I
    ...
    iget-object v5, v10, Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;->mStack:Lcom/android/server/am/ActivityStack;
    ...
    iget-object v5, v10, Lcom/android/server/am/ActivityStackSupervisor;->mFocusedStack:Lcom/android/server/am/ActivityStack;
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/am/ActivityStack;->getStackVisibilityLocked(Lcom/android/server/am/ActivityRecord;)I
...
.method private isValidLaunchStackId(ILcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v1}, Lcom/android/server/am/ActivityManagerService;->isKnoxDesktopModeLocked()Z
...
.method private setInitialState(Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/am/TaskRecord;ZILcom/android/server/am/ActivityRecord;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/am/ActivityStarter;->reset()V

    move-object/from16 v0, p1

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/server/am/ActivityStarter;->mStartActivity:Lcom/android/server/am/ActivityRecord;
    ...
    iput-object v0, v1, Lcom/android/server/am/ActivityStarter;->mIntent:Landroid/content/Intent;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/server/am/ActivityManagerService;->isKnoxDesktopModeLocked()Z
    ...
    iput-object v0, v1, Lcom/android/server/am/ActivityStarter;->mOptions:Landroid/app/ActivityOptions;
    ...
    iput v0, v1, Lcom/android/server/am/ActivityStarter;->mCallingUid:I

    move-object/from16 v0, p6

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/server/am/ActivityStarter;->mSourceRecord:Lcom/android/server/am/ActivityRecord;

    move-object/from16 v0, p7

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/server/am/ActivityStarter;->mVoiceSession:Landroid/service/voice/IVoiceInteractionSession;

    move-object/from16 v0, p8

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/server/am/ActivityStarter;->mVoiceInteractor:Lcom/android/internal/app/IVoiceInteractor;
    ...
    iput-object v0, v1, Lcom/android/server/am/ActivityStarter;->mLaunchBounds:Landroid/graphics/Rect;
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityStarter;->mLaunchSingleTop:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityStarter;->mLaunchSingleInstance:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityStarter;->mLaunchSingleTask:Z

    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/android/server/am/ActivityStarter;->mLaunchSingleInstance:Z

    move/from16 v17, v0

    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/android/server/am/ActivityStarter;->mLaunchSingleTask:Z
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/server/am/ActivityStarter;->adjustLaunchFlagsToDocumentMode(Lcom/android/server/am/ActivityRecord;ZZI)I
    ...
    iput v0, v1, Lcom/android/server/am/ActivityStarter;->mLaunchFlags:I
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityStarter;->mLaunchTaskBehind:Z

    invoke-direct/range {p0 .. p0}, Lcom/android/server/am/ActivityStarter;->sendNewTaskResultRequestIfNeeded()V

    move-object/from16 v0, p0

    iget v0, v0, Lcom/android/server/am/ActivityStarter;->mLaunchFlags:I
    ...
    iput-boolean v7, v0, Lcom/android/server/am/ActivityStarter;->mCanLaunchAsNewInstance:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityStarter;->mForceCreateNewInstance:Z
    ...
    iget-boolean v0, v0, Lcom/android/server/am/ActivityStarter;->mLaunchTaskBehind:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityStarter;->mDoResume:Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ActivityStackSupervisor;->okToShowLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    iget-object v0, v0, Lcom/android/server/am/ActivityStarter;->mOptions:Landroid/app/ActivityOptions;
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/app/ActivityOptions;->getLaunchTaskId()I
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/app/ActivityOptions;->getTaskOverlay()Z
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityRecord;->mTaskOverlay:Z
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/app/ActivityOptions;->getLaunchTaskId()I

    move-result v18

    invoke-virtual/range {v17 .. v18}, Lcom/android/server/am/ActivityStackSupervisor;->anyTaskForIdLocked(I)Lcom/android/server/am/TaskRecord;
    ...
    iget-object v0, v0, Lcom/android/server/am/ActivityRecord;->multiScreenAttrs:Lcom/android/server/am/MultiScreenAttrs;

    move-object/from16 v18, v0

    invoke-virtual/range {v18 .. v18}, Lcom/android/server/am/MultiScreenAttrs;->getDisplayId()I

    move-result v18

    invoke-interface/range {v17 .. v18}, Lcom/android/server/am/IMultiScreenManagerServiceBridge;->isVirtualScreen(I)Z
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityStarter;->mAvoidMoveToFront:Z
    ...
    iput-object v0, v1, Lcom/android/server/am/ActivityStarter;->mNotTop:Lcom/android/server/am/ActivityRecord;

    move-object/from16 v0, p3

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/server/am/ActivityStarter;->mInTask:Lcom/android/server/am/TaskRecord;
    ...
    iput v0, v1, Lcom/android/server/am/ActivityStarter;->mStartFlags:I
    ...
    iget-object v0, v0, Lcom/android/server/am/ActivityStarter;->mNotTop:Lcom/android/server/am/ActivityRecord;

    move-object/from16 v18, v0

    invoke-virtual/range {v17 .. v18}, Lcom/android/server/am/ActivityStack;->topRunningNonDelayedActivityLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;

    move-result-object v5

    :cond_a
    iget-object v0, v5, Lcom/android/server/am/ActivityRecord;->realActivity:Landroid/content/ComponentName;
    ...
    iget v0, v0, Lcom/android/server/am/ActivityStarter;->mStartFlags:I
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityStarter;->mNoAnimation:Z
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/server/am/ActivityStackSupervisor;->getStacks()Ljava/util/ArrayList;
    ...
    invoke-virtual {v11}, Lcom/android/server/am/ActivityStack;->isDockedStack()Z
    ...
    iget-boolean v8, v0, Lcom/android/server/am/ActivityStackSupervisor;->mIsDockMinimized:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityStarter;->mCanLaunchAsNewInstance:Z

    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/android/server/am/ActivityStarter;->mCanLaunchAsNewInstance:Z
    ...
    :cond_29
    sget-object v17, Lcom/android/server/am/ActivityStarter;->TAG:Ljava/lang/String;

    new-instance v18, Ljava/lang/StringBuilder;

    invoke-direct/range {v18 .. v18}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v19, "Starting activity in task not in recents: "
...
.method private setTargetStackAndMoveToFrontIfNeeded(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v12, v1}, Lcom/android/server/am/ActivityStack;->topRunningNonDelayedActivityLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-direct {v0, v1, v2, v12}, Lcom/android/server/am/ActivityStarter;->updateTaskReturnToType(Lcom/android/server/am/TaskRecord;ILcom/android/server/am/ActivityStack;)V
    ...
    :cond_13
    iget v1, v13, Lcom/android/server/am/ActivityStack;->mStackId:I
    ...
    iget v3, v13, Lcom/android/server/am/ActivityStack;->mStackId:I
...
.method private setTaskFromReuseOrCreateNewTask(Lcom/android/server/am/TaskRecord;)V
    ...
    invoke-interface {v0, v10}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->getBoundsInDeXFromRecentTasks(Lcom/android/server/am/TaskRecord;)Landroid/graphics/Rect;
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/pm/ResolveInfo;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Landroid/os/IBinder;Ljava/lang/String;IIILjava/lang/String;IIILandroid/app/ActivityOptions;ZZ[Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;Lcom/android/server/am/TaskRecord;)I
    ...
    invoke-virtual {v4}, Lcom/android/server/am/ActivityManagerService;->isKnoxDesktopModeLocked()Z
