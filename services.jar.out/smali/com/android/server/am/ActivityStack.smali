...
.method private insertTaskAtTop(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;)V
    ...
    iget-boolean v7, v7, Lcom/android/server/am/ActivityStackSupervisor;->mSnapWindowRunning:Z
    ...
    iget-object v7, v7, Lcom/android/server/am/ActivityManagerService;->mSamsungWindowManager:Lcom/android/server/wm/IWindowManagerServiceBridge;
    ...
    invoke-interface {v7, v11, v10, v8, v9}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->setSnapWindowLocked(ZLandroid/graphics/Rect;Ljava/lang/String;Ljava/lang/String;)V
...
.method private startLaunchTraces(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/android/server/am/SluggishInfo;->addStartLaunchLog(Ljava/lang/String;)V
...
.method public checkBelowTasksToGoHomeStack(Lcom/android/server/am/TaskRecord;)Z
    .locals 5
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/ActivityStack;->isAllActivitiesFinishing(Lcom/android/server/am/TaskRecord;)Z
...
.method createTaskRecord(ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Z)Lcom/android/server/am/TaskRecord;
    ...
    invoke-interface {v1, v0, p2}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->updateDexCompatEnabled(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo;)V
...
.method ensureActivityConfigurationLocked(Lcom/android/server/am/ActivityRecord;IZ)Z
    ...
    invoke-interface {v0, v1}, Lcom/android/server/am/IActivityManagerServiceBridge;->applyConventionalMode(Lcom/android/server/am/ActivityRecord;)Z
...
.method final finishActivityLocked(Lcom/android/server/am/ActivityRecord;ILandroid/content/Intent;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v11}, Lcom/android/server/am/TaskRecord;->isReuseTask()Z
    ...
    invoke-virtual {v11}, Lcom/android/server/am/TaskRecord;->getBaseIntent()Landroid/content/Intent;
    ...
    iget-object v3, v11, Lcom/android/server/am/TaskRecord;->mCallingPackage:Ljava/lang/String;

    const/4 v5, 0x1

    invoke-virtual {v1, v5, v11, v2, v3}, Lcom/android/server/am/ActivityStackSupervisor;->notifyAppsStatusToTaskBar(ILcom/android/server/am/TaskRecord;Landroid/content/ComponentName;Ljava/lang/String;)V
...
.method getDefaultTaskBoundsInStack(Lcom/android/server/am/TaskRecord;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/android/server/am/ActivityStack;->getDefaultTaskBoundsInStack(Lcom/android/server/am/TaskRecord;Landroid/graphics/Rect;Landroid/content/pm/ActivityInfo$WindowLayout;)V

    return-void
.end method

.method getDefaultTaskBoundsInStack(Lcom/android/server/am/TaskRecord;Landroid/graphics/Rect;Landroid/content/pm/ActivityInfo$WindowLayout;)V
    .locals 2
    ...
    invoke-virtual {v0, p1, v1, p2, p3}, Lcom/android/server/am/LaunchingTaskPositioner;->getDefaultTaskBounds(Lcom/android/server/am/TaskRecord;Ljava/util/ArrayList;Landroid/graphics/Rect;Landroid/content/pm/ActivityInfo$WindowLayout;)V
...
.method layoutTaskInStack(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo$WindowLayout;)Z
    ...
    iget v0, p1, Lcom/android/server/am/TaskRecord;->mDexCompatLaunchPolicy:I
    ...
    invoke-interface {v0, p1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->updateDexCompatEnabled(Lcom/android/server/am/TaskRecord;)V
    ...
    invoke-interface {v0, p1, v6}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->getSupportScreenBounds(Lcom/android/server/am/TaskRecord;Landroid/graphics/Rect;)V
...
.method moveToFront(Ljava/lang/String;Lcom/android/server/am/TaskRecord;)V
    ...
    invoke-virtual {v5}, Lcom/android/server/am/ActivityManagerService;->isKnoxDesktopModeLocked()Z
    ...
    iget-object v7, p2, Lcom/android/server/am/TaskRecord;->mCallingPackage:Ljava/lang/String;

    const/4 v8, 0x3

    invoke-virtual {v5, v8, p2, v6, v7}, Lcom/android/server/am/ActivityStackSupervisor;->notifyAppsStatusToTaskBar(ILcom/android/server/am/TaskRecord;Landroid/content/ComponentName;Ljava/lang/String;)V
...
.method removeTask(Lcom/android/server/am/TaskRecord;Ljava/lang/String;I)V
    ...
    invoke-virtual {v7}, Lcom/android/server/am/ActivityManagerService;->isKnoxDesktopModeLocked()Z
    ...
    iget-object v9, p1, Lcom/android/server/am/TaskRecord;->mCallingPackage:Ljava/lang/String;

    const/4 v10, 0x1

    invoke-virtual {v7, v10, p1, v8, v9}, Lcom/android/server/am/ActivityStackSupervisor;->notifyAppsStatusToTaskBar(ILcom/android/server/am/TaskRecord;Landroid/content/ComponentName;Ljava/lang/String;)V
...
.method final startActivityLocked(Lcom/android/server/am/ActivityRecord;ZZLandroid/app/ActivityOptions;)V
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/am/TaskRecord;->getBaseIntent()Landroid/content/Intent;
    ...
    iget-object v5, v0, Lcom/android/server/am/TaskRecord;->mCallingPackage:Ljava/lang/String;

    const/4 v6, 0x0

    move-object/from16 v0, v21

    invoke-virtual {v3, v6, v0, v4, v5}, Lcom/android/server/am/ActivityStackSupervisor;->notifyAppsStatusToTaskBar(ILcom/android/server/am/TaskRecord;Landroid/content/ComponentName;Ljava/lang/String;)V
