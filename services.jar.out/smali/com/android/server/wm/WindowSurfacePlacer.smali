...
.method private applySurfaceChangesTransaction(ZIII)V
    ...
    instance-of v4, v4, Lcom/android/server/wm/AppWindowToken;
    ...
    iget-object v6, v4, Lcom/android/server/wm/WindowManagerService;->mMultiWindowManagerInternal:Lcom/android/server/wm/IMultiWindowManagerInternalBridge;
    ...
    invoke-interface {v6, v4}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->appTokenDrawnLocked(Lcom/android/server/wm/AppWindowToken;)V
    ...
    invoke-virtual/range {v38 .. v38}, Lcom/android/server/wm/WindowStateAnimator;->deferToPendingTransaction()V
...
.method private handleAppTransitionReadyLocked(Lcom/android/server/wm/WindowList;)I
    ...
    const-string/jumbo v29, "**** GOOD TO GO"
    ...
    invoke-interface/range {v29 .. v29}, Lcom/android/server/wm/IWindowManagerServiceBridge;->findWallpaperLocked()Lcom/android/server/wm/WindowState;
    ...
    invoke-interface {v3, v0, v1, v2, v4}, Lcom/android/server/wm/IWindowManagerServiceBridge;->setAppEnterExitAnimationForWallpaperLocked(Lcom/android/server/wm/WindowState;Landroid/util/ArraySet;Landroid/util/ArraySet;I)V
    ...
    const-string/jumbo v29, "Animations disallowed by keyguard or dream."
    ...
    invoke-interface {v3, v0}, Lcom/android/server/wm/IWindowManagerServiceBridge;->setBackgroundAnimationNeeded(Z)V
    ...
    const-string/jumbo v29, "handle_transit_done"
    ...
    iget-object v0, v14, Lcom/android/server/wm/AppWindowToken;->mTask:Lcom/android/server/wm/Task;
    ...
    iput-boolean v0, v3, Lcom/android/server/wm/AppWindowAnimator;->mIsAnimatingInTask:Z
...
.method final performLayoutLockedInner(Lcom/android/server/wm/DisplayContent;ZZ)V
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/wm/WindowState;->setInsetsChanged()Z
