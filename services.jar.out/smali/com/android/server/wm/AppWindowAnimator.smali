...
.method public setAnimation(Landroid/view/animation/Animation;IIZI)V
    ...
    sget-object v14, Lcom/android/server/wm/AppWindowAnimator;->TAG:Ljava/lang/String;
    ...
    const-string/jumbo v16, " isVisible="
    ...
    iput-object v0, v1, Lcom/android/server/wm/AppWindowAnimator;->animation:Landroid/view/animation/Animation;

    const/4 v14, 0x0

    move-object/from16 v0, p0

    iput-boolean v14, v0, Lcom/android/server/wm/AppWindowAnimator;->animating:Z

    invoke-virtual/range {p1 .. p1}, Landroid/view/animation/Animation;->isInitialized()Z
    ...
    invoke-virtual {v0, v14, v15}, Landroid/view/animation/Animation;->restrictDuration(J)V

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/wm/AppWindowAnimator;->mService:Lcom/android/server/wm/WindowManagerService;

    invoke-virtual {v14}, Lcom/android/server/wm/WindowManagerService;->getTransitionAnimationScaleLocked()F

    move-result v14

    move-object/from16 v0, p1

    invoke-virtual {v0, v14}, Landroid/view/animation/Animation;->scaleCurrentDuration(F)V

    invoke-virtual/range {p1 .. p1}, Landroid/view/animation/Animation;->getZAdjustment()I
    ...
    iget v14, v0, Lcom/android/server/wm/AppWindowAnimator;->animLayerAdjustment:I

    if-eq v14, v8, :cond_4

    move-object/from16 v0, p0

    iput v8, v0, Lcom/android/server/wm/AppWindowAnimator;->animLayerAdjustment:I

    invoke-virtual/range {p0 .. p0}, Lcom/android/server/wm/AppWindowAnimator;->updateLayers()V

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/wm/AppWindowAnimator;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-boolean v14, v14, Lcom/android/server/wm/WindowManagerService;->mAdjFullScreenStackLayer:Z
    ...
    iget-object v14, v0, Lcom/android/server/wm/AppWindowAnimator;->mAppToken:Lcom/android/server/wm/AppWindowToken;

    iget-object v14, v14, Lcom/android/server/wm/AppWindowToken;->mTask:Lcom/android/server/wm/Task;
    ...
    invoke-virtual {v14}, Lcom/android/server/wm/Task;->inDockedWorkspace()Z
    ...
    iput-boolean v14, v0, Lcom/android/server/wm/AppWindowAnimator;->mDockedActivityTransitionTarget:Z
    ...
    iget-object v6, v14, Lcom/android/server/wm/Task;->mAppTokens:Lcom/android/server/wm/AppTokenList;
    ...
    iput v8, v14, Lcom/android/server/wm/AppWindowAnimator;->animLayerAdjustment:I

    iget-object v14, v9, Lcom/android/server/wm/AppWindowToken;->mAppAnimator:Lcom/android/server/wm/AppWindowAnimator;

    invoke-virtual {v14}, Lcom/android/server/wm/AppWindowAnimator;->updateLayers()V
    ...
    iget-object v14, v0, Lcom/android/server/wm/AppWindowAnimator;->transformation:Landroid/view/animation/Transformation;

    invoke-virtual {v14}, Landroid/view/animation/Transformation;->clear()V

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/server/wm/AppWindowAnimator;->transformation:Landroid/view/animation/Transformation;

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/wm/AppWindowAnimator;->mAppToken:Lcom/android/server/wm/AppWindowToken;

    invoke-virtual {v14}, Lcom/android/server/wm/AppWindowToken;->isVisible()Z
    ...
    iput-boolean v14, v0, Lcom/android/server/wm/AppWindowAnimator;->hasTransformation:Z

    move/from16 v0, p5

    move-object/from16 v1, p0

    iput v0, v1, Lcom/android/server/wm/AppWindowAnimator;->mStackClip:I

    move/from16 v0, p4

    move-object/from16 v1, p0

    iput-boolean v0, v1, Lcom/android/server/wm/AppWindowAnimator;->mSkipFirstFrame:Z
    ...
    invoke-virtual {v0, v14}, Landroid/view/animation/Animation;->setBackgroundColor(I)V

    :cond_5
    move-object/from16 v0, p0

    iget-boolean v14, v0, Lcom/android/server/wm/AppWindowAnimator;->mClearProlongedAnimation:Z
    ...
    iput v14, v0, Lcom/android/server/wm/AppWindowAnimator;->mProlongAnimation:I
    ...
    invoke-virtual {v14, v11}, Lcom/android/server/wm/WindowList;->get(I)Ljava/lang/Object;
    ...
    iput-boolean v14, v0, Lcom/android/server/wm/AppWindowAnimator;->mClearProlongedAnimation:Z
    ...
    iget v14, v14, Lcom/android/server/wm/AppWindowToken;->DimBetweenTwoWindow:I
    ...
    iget-object v14, v14, Lcom/android/server/wm/AppWindowToken;->mDepthInOutDimAnimation:Landroid/view/animation/Animation;

    move-object/from16 v0, p0

    iput-object v14, v0, Lcom/android/server/wm/AppWindowAnimator;->mDimAnimation:Landroid/view/animation/Animation;

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/wm/AppWindowAnimator;->mDimAnimation:Landroid/view/animation/Animation;
    ...
    invoke-virtual {v14}, Landroid/view/animation/Animation;->isInitialized()Z
    ...
    iget-object v15, v0, Lcom/android/server/wm/AppWindowAnimator;->mService:Lcom/android/server/wm/WindowManagerService;

    invoke-virtual {v15}, Lcom/android/server/wm/WindowManagerService;->getTransitionAnimationScaleLocked()F
    ...
    iget-object v14, v0, Lcom/android/server/wm/AppWindowAnimator;->mDimTransform:Landroid/view/animation/Transformation;

    invoke-virtual {v14}, Landroid/view/animation/Transformation;->clear()V

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/server/wm/AppWindowAnimator;->mDimTransform:Landroid/view/animation/Transformation;
...
.method setNullAnimation()V
    ...
    iput-boolean v7, p0, Lcom/android/server/wm/AppWindowAnimator;->usingTransferredAnimation:Z

    iput-object v5, p0, Lcom/android/server/wm/AppWindowAnimator;->mDimAnimation:Landroid/view/animation/Animation;

    iget-object v5, p0, Lcom/android/server/wm/AppWindowAnimator;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-boolean v5, v5, Lcom/android/server/wm/WindowManagerService;->mAdjFullScreenStackLayer:Z

    if-eqz v5, :cond_1

    iget-boolean v5, p0, Lcom/android/server/wm/AppWindowAnimator;->mDockedActivityTransitionTarget:Z
    ...
    iget-object v5, v2, Lcom/android/server/wm/AppWindowToken;->mAppAnimator:Lcom/android/server/wm/AppWindowAnimator;

    iput v7, v5, Lcom/android/server/wm/AppWindowAnimator;->animLayerAdjustment:I

    iget-object v5, v2, Lcom/android/server/wm/AppWindowToken;->mAppAnimator:Lcom/android/server/wm/AppWindowAnimator;

    invoke-virtual {v5}, Lcom/android/server/wm/AppWindowAnimator;->updateLayers()V
    ...
    :cond_0
    iput-boolean v7, p0, Lcom/android/server/wm/AppWindowAnimator;->mDockedActivityTransitionTarget:Z

    iget-object v5, p0, Lcom/android/server/wm/AppWindowAnimator;->mService:Lcom/android/server/wm/WindowManagerService;

    iput-boolean v7, v5, Lcom/android/server/wm/WindowManagerService;->mAdjFullScreenStackLayer:Z

    :cond_1
    iput-boolean v7, p0, Lcom/android/server/wm/AppWindowAnimator;->clipConventionalFrame:Z
