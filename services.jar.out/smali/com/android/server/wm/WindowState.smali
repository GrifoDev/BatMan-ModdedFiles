...
.method private shouldSaveSurface()Z
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/WindowSurfaceController;->shouldSaveSurface()Z
...
.method public computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v43 .. v43}, Lcom/android/server/wm/Task;->getDisplayContent()Lcom/android/server/wm/DisplayContent;
    ...
    invoke-virtual/range {v43 .. v43}, Lcom/android/server/wm/Task;->isFloating()Z
    ...
    sget-boolean v47, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SAMSUNG_MULTIWINDOW_DYNAMIC_ENABLED:Z

    if-eqz v47, :cond_2

    sget-boolean v47, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_SLIDE_MODE:Z
    ...
    invoke-interface/range {v47 .. v47}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->getStatusBarHeight()I
    ...
    invoke-interface/range {v47 .. v47}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->getDecorCaptionWindowHeight()I
    ...
    invoke-virtual/range {v47 .. v47}, Landroid/graphics/Rect;->setEmpty()V
    ...
    invoke-virtual/range {v43 .. v43}, Lcom/android/server/wm/Task;->isResizeableByDockedStack()Z
    ...
    invoke-virtual/range {v47 .. v48}, Landroid/graphics/Rect;->contains(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/WindowState;->isVisibleLw()Z
    ...
    invoke-virtual/range {v47 .. v47}, Landroid/graphics/Rect;->isEmpty()Z
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/WindowStateAnimator;->getShown()Z
    ...
    invoke-static/range {v51 .. v52}, Ljava/lang/Math;->max(II)I

    move-result v51

    invoke-virtual/range {v47 .. v51}, Landroid/graphics/Rect;->set(IIII)V
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/DisplayContent;->getDockedDividerController()Lcom/android/server/wm/DockedStackDividerController;
    ...
    invoke-virtual/range {v47 .. v48}, Lcom/android/server/wm/DockedStackDividerController;->positionDockedStackedDivider(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v47 .. v48}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v47 .. v48}, Landroid/graphics/Rect;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual/range {v47 .. v49}, Landroid/graphics/Rect;->offset(II)V
    ...
    invoke-virtual/range {v47 .. v48}, Landroid/graphics/Rect;->scale(F)V
    ...
    invoke-static/range {v47 .. v48}, Lcom/android/server/DssController$Tools;->applyScaleToCompatFrame(Landroid/graphics/Rect;F)V
    ...
    invoke-interface/range {v47 .. v47}, Lcom/samsung/android/view/IWindowStateBridge;->configureReducedScreenSpec()V
    ...
    :cond_12
    sget-boolean v47, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_LAYOUT:Z

    if-nez v47, :cond_13

    sget-boolean v47, Lcom/android/server/wm/WindowManagerService;->localLOGV:Z

    if-eqz v47, :cond_14

    :cond_13
    sget-object v47, Lcom/android/server/wm/WindowState;->TAG:Ljava/lang/String;

    new-instance v48, Ljava/lang/StringBuilder;

    invoke-direct/range {v48 .. v48}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v49, "Resolving (mRequestedWidth="
    ...
    const-string/jumbo v49, ", mRequestedheight="
    ...
    const-string/jumbo v49, ") to"

    invoke-virtual/range {v48 .. v49}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v48

    const-string/jumbo v49, " (pw="
    ...
    invoke-virtual/range {v49 .. v49}, Landroid/graphics/Rect;->toShortString()Ljava/lang/String;
    ...
    invoke-static/range {v47 .. v48}, Landroid/util/Slog;->v(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual/range {v47 .. v47}, Ljava/util/ArrayDeque;->isEmpty()Z
    ...
    invoke-interface/range {v47 .. v47}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->getCurrentInputMethodClient()Lcom/android/server/wm/WindowState;
    ...
    invoke-interface/range {v47 .. v48}, Landroid/view/WindowManagerPolicy;->getContentRectLw(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/AppWindowToken;->findMainWindow()Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/DockedStackDividerController;->isResizing()Z
    ...
    invoke-virtual/range {v48 .. v48}, Lcom/android/server/wm/DisplayContent;->getDisplayInfo()Landroid/view/DisplayInfo;
    ...
    invoke-virtual/range {v49 .. v49}, Lcom/android/server/wm/DisplayContent;->getDisplayInfo()Landroid/view/DisplayInfo;
    ...
    invoke-virtual/range {v47 .. v47}, Ljava/util/ArrayDeque;->peek()Ljava/lang/Object;
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/WindowState;->getTask()Lcom/android/server/wm/Task;
    ...
    invoke-virtual/range {v43 .. v43}, Lcom/android/server/wm/Task;->inDockedWorkspace()Z
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/DisplayContent;->getDisplayMetrics()Landroid/util/DisplayMetrics;
    ...
    invoke-static {v0, v14}, Lcom/android/server/wm/WindowManagerService;->dipToPixel(ILandroid/util/DisplayMetrics;)I
    ...
    invoke-static/range {v48 .. v49}, Ljava/lang/Math;->min(II)I
    ...
    invoke-virtual {v0, v1, v9, v2, v3}, Landroid/graphics/Rect;->inset(IIII)V
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/DisplayContent;->getMultiWindowFocusedFrameController()Lcom/android/server/wm/IMultiWindowFocusedFramePolicy;
    ...
    invoke-interface/range {v49 .. v49}, Landroid/view/WindowManagerPolicy;->isStatusBarTransparent()Z
    ...
    invoke-virtual/range {v47 .. v48}, Lcom/android/server/wm/DockedStackDividerController;->positionDividerPanel(Landroid/graphics/Rect;)V
    ...
    :cond_4d
    sget-boolean v47, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SNAP_WINDOW_SUPPORT:Z
    ...
    invoke-virtual/range {v47 .. v48}, Lcom/android/server/wm/DisplayContent;->getLogicalDisplayRect(Landroid/graphics/Rect;)V
...
.method getTouchableRegion(Landroid/graphics/Region;I)I
    ...
    invoke-interface {v2, v8}, Lcom/android/server/wm/DimLayer$DimLayerUser;->getDimBounds(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v8}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->isMouseConnectedForDesktopMode()Z
    ...
    invoke-static {v8, v3}, Lcom/android/server/wm/WindowManagerService;->dipToPixel(ILandroid/util/DisplayMetrics;)I
    ...
    invoke-interface {v8, p0}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->isFreeformAlphaModeLocked(Lcom/android/server/wm/WindowState;)Z
    ...
    iget-object v10, v10, Lcom/android/server/wm/AppWindowToken;->mTask:Lcom/android/server/wm/Task;

    iget v10, v10, Lcom/android/server/wm/Task;->mCurrentCaptionHieght:I
    ...
    invoke-interface {v8, v9}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->findMaxVisibleAppWindow(Lcom/android/server/wm/AppWindowToken;)Lcom/android/server/wm/WindowState;

    move-result-object v6

    if-eqz v6, :cond_5

    iget-object v8, v6, Lcom/android/server/wm/WindowState;->mVisibleFrame:Landroid/graphics/Rect;

    sget-object v9, Landroid/graphics/Region$Op;->XOR:Landroid/graphics/Region$Op;
    ...
    invoke-interface {v8, p1}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->exludedRegionFromFreefomTasksLocked(Landroid/graphics/Region;)V
    :try_end_0
...
.method public reportFocusChangedSerialized(ZZ)V
    ...
    invoke-interface {v4}, Lcom/android/server/wm/IWindowManagerServiceBridge;->isKnoxDesktopModeLocked()Z
