...
.method private updateWindowsLocked(I)V
    ...
    invoke-interface/range {v34 .. v35}, Landroid/view/WindowManagerPolicy;->isKeyguardHostWindow(Landroid/view/WindowManager$LayoutParams;)Z
    ...
    sget-boolean v34, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_KEYGUARD:Z

    if-eqz v34, :cond_5

    sget-object v34, Lcom/android/server/wm/WindowAnimator;->TAG:Ljava/lang/String;

    const-string/jumbo v35, "updateWindowsLocked: creating delay animation"

    invoke-static/range {v34 .. v35}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_5
    new-instance v34, Landroid/view/animation/AlphaAnimation;

    const/high16 v35, 0x3f800000    # 1.0f

    const/high16 v36, 0x3f800000    # 1.0f

    invoke-direct/range {v34 .. v36}, Landroid/view/animation/AlphaAnimation;-><init>(FF)V
    ...
    invoke-virtual/range {v34 .. v34}, Lcom/android/server/wm/DisplayContent;->getDockedDividerController()Lcom/android/server/wm/DockedStackDividerController;

    move-result-object v34

    invoke-virtual/range {v34 .. v34}, Lcom/android/server/wm/DockedStackDividerController;->isMinimizedDock()Z
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/server/wm/WindowStateAnimator;->hasSurface()Z
    ...
    sget-boolean v34, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_WALLPAPER:Z
    ...
    const-string/jumbo v36, ": wasAnimating="
    ...
    const-string/jumbo v36, ", nowAnimating="
    ...
    sget-boolean v34, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_VISIBILITY:Z
    ...
    const-string/jumbo v36, "make invisible or uphold invisible: "
    ...
    :cond_c
    invoke-virtual/range {v32 .. v32}, Lcom/android/server/wm/WindowStateAnimator;->performShowLocked()Z
    ...
    sget-boolean v34, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_LAYOUT_REPEATS:Z
    ...
    const-string/jumbo v35, "updateWindowsAndWallpaperLocked 5"

    invoke-virtual/range {p0 .. p1}, Lcom/android/server/wm/WindowAnimator;->getPendingLayoutChanges(I)I

    move-result v36

    invoke-virtual/range {v34 .. v36}, Lcom/android/server/wm/WindowSurfacePlacer;->debugLayoutRepeats(Ljava/lang/String;I)V
    ...
    const-string/jumbo v35, "updateWindowsLocked: StatusBar is no longer keyguard"
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/server/wm/WindowStateAnimator;->clearAnimation()V
    ...
    const-string/jumbo v35, "updateWindowsAndWallpaperLocked 2"
    ...
    invoke-interface/range {v34 .. v34}, Lcom/android/server/wm/IWindowManagerServiceBridge;->inVSMode()Z
    ...
    const-string/jumbo v36, "VS Force hiding window: "
    ...
    invoke-interface/range {v34 .. v35}, Landroid/view/WindowManagerPolicy;->isForceHiding(Landroid/view/WindowManager$LayoutParams;)Z
    ...
    sget-boolean v34, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_ANIM:Z
    ...
    const-string/jumbo v36, "Animation started that could impact force hide: "
    ...
    const-string/jumbo v35, "updateWindowsAndWallpaperLocked 3"
    ...
    :cond_19
    :goto_a
    invoke-virtual/range {v31 .. v31}, Lcom/android/server/wm/WindowState;->isReadyForDisplay()Z
    ...
    const-string/jumbo v36, "Force hide "
    ...
    const-string/jumbo v36, " hasSurface="
    ...
    const-string/jumbo v36, " policyVis="
    ...
    const-string/jumbo v36, " destroying="
    ...
    const-string/jumbo v36, " attHidden="
    ...
    const-string/jumbo v35, "Timeout waiting for animation to startup"
    ...
    const-string/jumbo v36, "Now policy hidden: "
    ...
    const-string/jumbo v35, "updateWindowsAndWallpaperLocked 4"
    ...
    invoke-virtual/range {v34 .. v34}, Landroid/view/animation/Animation;->hasEnded()Z
    ...
    :goto_e
    invoke-virtual/range {v31 .. v31}, Lcom/android/server/wm/WindowState;->isAdjustedForMinimizedDock()Z
    ...
    :cond_28
    invoke-virtual/range {v31 .. v31}, Lcom/android/server/wm/WindowState;->isVisibleNow()Z
    ...
    invoke-virtual/range {v31 .. v31}, Lcom/android/server/wm/WindowState;->hasDrawnLw()Z
    ...
    const-string/jumbo v36, "shown win="
    ...
    const-string/jumbo v36, " start KeguardExitAnimation"
    ...
    const-string/jumbo v36, "Now policy shown: "
    ...
    const-string/jumbo v36, "Starting Window of FLAG_SHOW_WHEN_LOCKED app does not apply unlock animation : "
    ...
    :cond_33
    sget-boolean v34, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_FOCUS_LIGHT:Z

    if-eqz v34, :cond_34

    sget-object v34, Lcom/android/server/wm/WindowAnimator;->TAG:Ljava/lang/String;

    const-string/jumbo v35, "updateWindowsLocked: setting mFocusMayChange true"
    ...
    const-string/jumbo v36, "Applying existing Keyguard exit animation to new window: win="
    ...
    check-cast v32, Lcom/android/server/wm/WindowStateAnimator;
    ...
    invoke-virtual/range {v34 .. v34}, Lcom/android/server/wm/WindowState;->isAdjustedForMinimizedDock()Z
    ...
    const-string/jumbo v36, "Starting keyguard exit animation on window "
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/view/animation/Animation;->getStartOffset()J
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/view/animation/Animation;->getDuration()J
    ...
    invoke-interface/range {v34 .. v34}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->isForceHidingFloatingMultiWindow()Z
    ...
    const-string/jumbo v35, "updateWindowsLocked: wallpaper animating away"
    ...
    const-string/jumbo v35, "start KeyguardExitAnimation with shown window"
    ...
    invoke-virtual/range {v36 .. v36}, Landroid/view/animation/Animation;->getStartTime()J
    ...
    const-string/jumbo v35, "Done with Keyguard exit animations."
