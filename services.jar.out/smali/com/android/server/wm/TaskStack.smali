...
.method private adjustForIME(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/server/wm/DockedStackDividerController;->getContentWidth()I
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/server/wm/DockedStackDividerController;->getContentWidthInactive()I
    ...
    invoke-interface/range {v25 .. v26}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->getTopVisibleWindowLocked(I)Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual/range {v26 .. v27}, Lcom/android/server/wm/DockedStackDividerController;->getMinimalSizeResizableTask(I)I
    ...
    invoke-interface/range {v25 .. v25}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->isAutoResizingEnabled()Z
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/server/wm/WindowManagerService;->getImeFocusStackLocked()Lcom/android/server/wm/TaskStack;
    ...
    sget-boolean v25, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->ENSURE_DOCKED_VIEW_SUPPORT:Z
...
.method private alignTasksToAdjustedBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iget-boolean v7, v7, Lcom/android/server/wm/WindowManagerService;->mSnapWindowRunning:Z
    ...
    invoke-virtual {v4}, Lcom/android/server/wm/Task;->isSnapWindowTarget()Z
    ...
    iget-object v7, p0, Lcom/android/server/wm/TaskStack;->mOrigDockStackBounds:Landroid/graphics/Rect;
    ...
    :goto_2
    iput v7, p0, Lcom/android/server/wm/TaskStack;->mPrevInputTargetStackId:I
    ...
    iget-object v11, p0, Lcom/android/server/wm/TaskStack;->mBounds:Landroid/graphics/Rect;

    iget v11, v11, Landroid/graphics/Rect;->right:I

    iget v12, p0, Lcom/android/server/wm/TaskStack;->mEnsureDockStackBottom:I

    invoke-direct {v8, v9, v10, v11, v12}, Landroid/graphics/Rect;-><init>(IIII)V

    const/4 v9, 0x1

    invoke-interface {v7, v8, v9}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->ensureDockedResize(Landroid/graphics/Rect;Z)V

    const/4 v7, 0x1

    iput-boolean v7, p0, Lcom/android/server/wm/TaskStack;->mIsEnsured:Z
    ...
    iget v7, p0, Lcom/android/server/wm/TaskStack;->mPrevInputTargetStackId:I
    ...
    iget v8, p0, Lcom/android/server/wm/TaskStack;->mPrevInputTargetStackId:I
    ...
    iget-object v8, p0, Lcom/android/server/wm/TaskStack;->mOrigDockStackBounds:Landroid/graphics/Rect;
    ...
    :cond_7
    iget-boolean v7, p0, Lcom/android/server/wm/TaskStack;->mIsEnsured:Z
...
.method private setBounds(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {v5, v8}, Lcom/android/server/wm/DisplayContent;->getLogicalDisplayRect(Landroid/graphics/Rect;)V
    ...
    iget v5, v5, Lcom/android/server/wm/DisplayContent;->mPrevDisplayWidth:I

    if-nez v5, :cond_4

    iget-object v5, p0, Lcom/android/server/wm/TaskStack;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    iget v5, v5, Lcom/android/server/wm/DisplayContent;->mPrevDisplayHeight:I

    if-nez v5, :cond_4

    iget-object v5, p0, Lcom/android/server/wm/TaskStack;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    iget-object v5, v5, Lcom/android/server/wm/DisplayContent;->mDimLayerController:Lcom/android/server/wm/DimLayerController;
    ...
    :cond_4
    iget-object v5, p0, Lcom/android/server/wm/TaskStack;->mAnimationBackgroundSurface:Lcom/android/server/wm/DimLayer;

    invoke-virtual {v5, p1}, Lcom/android/server/wm/DimLayer;->setBounds(Landroid/graphics/Rect;)V
    ...
    iput v3, p0, Lcom/android/server/wm/TaskStack;->mScreenHeight:I

    iput v4, p0, Lcom/android/server/wm/TaskStack;->mScreenWidth:I
    ...
    invoke-interface {v5}, Lcom/android/server/wm/IMultiWindowStackColorLayer;->getBounds()Landroid/graphics/Rect;
    ...
    invoke-interface {v5, p1}, Lcom/android/server/wm/IMultiWindowStackColorLayer;->setBounds(Landroid/graphics/Rect;)V
    ...
    iget-object v7, p0, Lcom/android/server/wm/TaskStack;->mAdjustedBounds:Landroid/graphics/Rect;

    invoke-interface {v5, v7}, Lcom/android/server/wm/IMultiWindowStackColorLayer;->setSurfacePosition(Landroid/graphics/Rect;)V
...
.method private snapDockedStackAfterRotation(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v2}, Lcom/android/internal/policy/DividerSnapAlgorithm;->isFirstSplitTargetAvailable()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {v2}, Lcom/android/internal/policy/DividerSnapAlgorithm;->isLastSplitTargetAvailable()Z
...
.method private updateBoundsAfterConfigChange()Z
    ...
    iget v2, v12, Landroid/view/DisplayInfo;->rotation:I
    ...
    iget v3, v12, Landroid/view/DisplayInfo;->logicalHeight:I
    ...
    iget v12, p0, Lcom/android/server/wm/TaskStack;->mRotation:I

    if-ne v12, v2, :cond_1

    iget v12, p0, Lcom/android/server/wm/TaskStack;->mDensity:I

    if-ne v12, v0, :cond_1

    iget-object v12, p0, Lcom/android/server/wm/TaskStack;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-interface {v12}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->isOrientationChanging()Z

    move-result v12

    if-nez v12, :cond_1

    iget v12, p0, Lcom/android/server/wm/TaskStack;->mScreenHeight:I

    if-ne v3, v12, :cond_1

    iget v12, p0, Lcom/android/server/wm/TaskStack;->mScreenWidth:I
    ...
    :cond_1
    iget-boolean v12, p0, Lcom/android/server/wm/TaskStack;->mFullscreen:Z

    if-eqz v12, :cond_2

    const/4 v12, 0x0

    invoke-direct {p0, v12}, Lcom/android/server/wm/TaskStack;->setBounds(Landroid/graphics/Rect;)Z
    ...
    sget-boolean v12, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->ENSURE_DOCKED_VIEW_SUPPORT:Z
    ...
    iget-object v12, p0, Lcom/android/server/wm/TaskStack;->mOrigDockStackBounds:Landroid/graphics/Rect;
    ...
    iput v12, p0, Lcom/android/server/wm/TaskStack;->mPrevInputTargetStackId:I

    const/4 v12, 0x0

    iput-boolean v12, p0, Lcom/android/server/wm/TaskStack;->mIsEnsured:Z

    :cond_3
    iget v12, p0, Lcom/android/server/wm/TaskStack;->mStackId:I
    ...
    iget-boolean v12, p0, Lcom/android/server/wm/TaskStack;->mAdjBoundsForSnapWindow:Z

    if-eqz v12, :cond_4

    iget-object v12, p0, Lcom/android/server/wm/TaskStack;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-boolean v12, v12, Lcom/android/server/wm/WindowManagerService;->mSnapWindowRunning:Z
    ...
    iget-object v13, p0, Lcom/android/server/wm/TaskStack;->mTmpRect2:Landroid/graphics/Rect;

    invoke-interface {v12, v13}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->getMiddleTargetDockedBounds(Landroid/graphics/Rect;)V
    ...
    :cond_5
    :goto_3
    iget-object v12, p0, Lcom/android/server/wm/TaskStack;->mBoundsAfterRotation:Landroid/graphics/Rect;
    ...
    iput-boolean v12, p0, Lcom/android/server/wm/TaskStack;->mAdjBoundsForSnapWindow:Z

    goto :goto_1

    :cond_8
    iget-object v12, p0, Lcom/android/server/wm/TaskStack;->mTmpRect2:Landroid/graphics/Rect;

    iget-object v13, p0, Lcom/android/server/wm/TaskStack;->mBounds:Landroid/graphics/Rect;

    invoke-virtual {v12, v13}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object v12, p0, Lcom/android/server/wm/TaskStack;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    iget v13, p0, Lcom/android/server/wm/TaskStack;->mRotation:I

    iget-object v14, p0, Lcom/android/server/wm/TaskStack;->mTmpRect2:Landroid/graphics/Rect;

    invoke-virtual {v12, v13, v2, v14}, Lcom/android/server/wm/DisplayContent;->rotateBounds(IILandroid/graphics/Rect;)V
    ...
    invoke-direct {p0, v12}, Lcom/android/server/wm/TaskStack;->repositionDockedStackAfterRotation(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v12, v6, v13, v2, v14}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->adjustBoundsForNaviBarForConfigChange(ILandroid/graphics/Rect;ILandroid/graphics/Rect;)V

    iget-object v12, p0, Lcom/android/server/wm/TaskStack;->mTmpRect2:Landroid/graphics/Rect;

    invoke-direct {p0, v12}, Lcom/android/server/wm/TaskStack;->snapDockedStackAfterRotation(Landroid/graphics/Rect;)V

    iget-object v12, p0, Lcom/android/server/wm/TaskStack;->mTmpRect2:Landroid/graphics/Rect;

    invoke-virtual {p0, v12}, Lcom/android/server/wm/TaskStack;->getDockSide(Landroid/graphics/Rect;)I
    ...
    iget-object v13, p0, Lcom/android/server/wm/TaskStack;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-virtual {v13, v12, v14}, Lcom/android/server/wm/WindowManagerService;->setDockedStackCreateStateLocked(ILandroid/graphics/Rect;)V
    ...
    invoke-virtual {v12, v1}, Lcom/android/server/wm/DockedStackDividerController;->notifyDockSideChanged(I)V
    ...
    const-string/jumbo v14, "Display size can not be 0 ! Caller = "
    ...
    iget v10, p0, Lcom/android/server/wm/TaskStack;->mScreenWidth:I

    iget v12, p0, Lcom/android/server/wm/TaskStack;->mScreenHeight:I

    iput v12, p0, Lcom/android/server/wm/TaskStack;->mScreenWidth:I

    iput v10, p0, Lcom/android/server/wm/TaskStack;->mScreenHeight:I
    ...
    iget v13, p0, Lcom/android/server/wm/TaskStack;->mScreenHeight:I
    ...
    invoke-interface {v12, v13, v1, v7}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->adjustDockedStackBoundAfterDisplaySizeChange(Landroid/graphics/Rect;IF)V
    ...
    iget v13, p0, Lcom/android/server/wm/TaskStack;->mScreenWidth:I
