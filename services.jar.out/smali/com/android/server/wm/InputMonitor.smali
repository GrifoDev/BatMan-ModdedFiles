...
.method private addInputWindowHandleLw(Lcom/android/server/input/InputWindowHandle;Lcom/android/server/wm/WindowState;IIZZZ)V
    ...
    invoke-virtual {p2, v4, p3}, Lcom/android/server/wm/WindowState;->getTouchableRegion(Landroid/graphics/Region;I)I
    ...
    invoke-interface {v3}, Lcom/samsung/android/view/IWindowStateBridge;->getAspectRatioFrame()Landroid/graphics/Rect;
    ...
    invoke-interface {v3}, Lcom/samsung/android/view/IWindowStateBridge;->getReducedScreenScaleSpecLocked()Landroid/view/MagnificationSpec;
    ...
    invoke-static {p1, v3, v4, v5}, Lcom/android/server/PackageConfigurationController$Tools;->applyReducedScreenParamsToInputWindowHandle(Lcom/android/server/input/InputWindowHandle;FFF)V

    :cond_3
    iget-object v3, p2, Lcom/android/server/wm/WindowState;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    iget v3, v3, Lcom/android/server/wm/DisplayContent;->mBaseDisplayWidth:I
    ...
    invoke-interface {v5}, Lcom/samsung/android/view/IWindowStateBridge;->getReducedSideTouchArea()I

    move-result v5

    invoke-static {p1, v3, v4, v5}, Lcom/android/server/PackageConfigurationController$Tools;->applyReducedSideTouchAreaToInputWindowHandle(Lcom/android/server/input/InputWindowHandle;III)V

    iget v3, p1, Lcom/android/server/input/InputWindowHandle;->layoutParamsSamsungFlags:I
    ...
    iget v3, p0, Lcom/android/server/wm/InputMonitor;->mInputWindowHandleCount:I

    iput v3, p0, Lcom/android/server/wm/InputMonitor;->mImeWindowHandleIndex:I
    ...
    iget v3, p0, Lcom/android/server/wm/InputMonitor;->mImeWindowHandleIndex:I

    invoke-direct {p0, p1, v3}, Lcom/android/server/wm/InputMonitor;->insertInputWindowHandleLw(Lcom/android/server/input/InputWindowHandle;I)V
    ...
    iget v4, p2, Lcom/android/server/wm/WindowState;->mXOffset:I
    ...
    iget v4, p2, Lcom/android/server/wm/WindowState;->mYOffset:I
