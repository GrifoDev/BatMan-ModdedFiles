...
.method static synthetic -get12(Lcom/android/server/fingerprint/FingerprintService;)Lcom/android/server/fingerprint/FingerprintService$SemSettingObserver;
    .locals 1
...
.method static synthetic -get13(Lcom/android/server/fingerprint/FingerprintService;)I
    .locals 1
...
.method static synthetic -get14(Lcom/android/server/fingerprint/FingerprintService;)Ljava/lang/Object;
    .locals 1
...
.method static synthetic -get4(Lcom/android/server/fingerprint/FingerprintService;)Lcom/android/server/fingerprint/FingerprintUtils;
    .locals 1
...
.method static synthetic -get5(Lcom/android/server/fingerprint/FingerprintService;)J
    .locals 2
...
.method static synthetic -get6(Lcom/android/server/fingerprint/FingerprintService;)Landroid/os/Handler;
    .locals 1
...
.method private canStopExclusiveIdentify(Lcom/android/server/fingerprint/ClientMonitor;Landroid/os/Bundle;ZLjava/lang/String;)Z
    ...
    sget-object v2, Lcom/android/server/fingerprint/FingerprintService;->mKeyguardPackage:Ljava/lang/String;
    ...
    const-string/jumbo v3, "canStopExclusiveIdentify : Keyguard client"
    ...
    const-string/jumbo v3, "canStopExclusiveIdentify : have PRIVILEGED_ATTR_EXCLUSIVE_IDENTIFY attr"
    ...
    const-string/jumbo v3, "canStopExclusiveIdentify: no fingeprintd!"
    ...
    const-string/jumbo v3, "canStopExclusiveIdentify : sensor is working"
    ...
    const-string/jumbo v3, "canStopExclusiveIdentify: failed"
    ...
    const-string/jumbo v3, "canStopExclusiveIdentify : false"
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    iget v14, v0, Lcom/android/server/fingerprint/FingerprintService;->mTouchCount:I
...
.method private startAuthentication(Landroid/os/IBinder;JIILandroid/hardware/fingerprint/IFingerprintServiceReceiver;IZLjava/lang/String;Landroid/os/Bundle;)V
    ...
    iput v4, v0, Lcom/android/server/fingerprint/FingerprintService;->mNumberOfNoMatches:I

    const/4 v4, 0x0

    move-object/from16 v0, p0

    iput v4, v0, Lcom/android/server/fingerprint/FingerprintService;->mNumberOfQualityFailes:I
...
.method protected handleAcquired(JI)V
    ...
    invoke-virtual {v3}, Lcom/android/server/fingerprint/FingerprintMaskView;->show()V
...
.method protected handleAuthenticated(JII)V
    ...
    const-string/jumbo v4, "handleAuthenticated : deviceId="
...
.method handleUserSwitching(I)V
    ...
    :cond_0
    invoke-direct {p0, v3}, Lcom/android/server/fingerprint/FingerprintService;->stopPendingClient(Z)V
...
.method public onStart()V
    ...
    iput-object v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mSemStatusBarManager:Landroid/app/SemStatusBarManager;
    ...
    invoke-virtual {v2}, Lcom/android/server/fingerprint/FingerprintService$SemSettingObserver;->readValue()V

    iget-object v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mSettingObserver:Lcom/android/server/fingerprint/FingerprintService$SemSettingObserver;

    const/4 v3, 0x1

    invoke-virtual {v2, v3}, Lcom/android/server/fingerprint/FingerprintService$SemSettingObserver;->observe(Z)V
    ...
    new-instance v3, Lcom/android/server/fingerprint/FingerprintService$12;

    invoke-direct {v3, p0}, Lcom/android/server/fingerprint/FingerprintService$12;-><init>(Lcom/android/server/fingerprint/FingerprintService;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/fingerprint/FingerprintUtils;->semGetTouchCount(Landroid/content/Context;)I

    move-result v2

    iput v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mTouchCount:I
