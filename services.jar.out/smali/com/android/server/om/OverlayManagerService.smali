...
.method private updateOverlayPaths(ILjava/util/List;)V
    ...
    sget-boolean v12, Lcom/android/server/om/OverlayManagerService;->DEBUG:Z

    if-eqz v12, :cond_0

    const-string/jumbo v12, "OverlayManager"

    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v14, "Updating overlay assets contains overlay for android ?"
    ...
    iget-object v13, v0, Lcom/android/server/om/OverlayManagerService;->mLock:Ljava/lang/Object;
    ...
    iget-object v12, v0, Lcom/android/server/om/OverlayManagerService;->mImpl:Lcom/android/server/om/OverlayManagerServiceImpl;

    const-string/jumbo v14, "android"

    move/from16 v0, p1

    invoke-virtual {v12, v14, v0}, Lcom/android/server/om/OverlayManagerServiceImpl;->getOverlayInfosForTarget(Ljava/lang/String;I)Ljava/util/List;
    ...
    iget-object v12, v6, Landroid/content/om/OverlayInfo;->baseCodePath:Ljava/lang/String;

    if-eqz v12, :cond_4

    iget-object v12, v6, Landroid/content/om/OverlayInfo;->baseCodePath:Ljava/lang/String;

    const-string/jumbo v14, "/data/overlays/currentstyle"
    ...
    invoke-virtual {v9, v0}, Landroid/content/pm/PackageManagerInternal;->getTargetPackageNames(I)Ljava/util/List;
    ...
    invoke-direct {v8, v12}, Landroid/util/ArrayMap;-><init>(I)V
    ...
    invoke-virtual {v12, v14, v0}, Lcom/android/server/om/OverlayManagerServiceImpl;->getEnabledOverlayPackageNames(Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-virtual {v12, v10, v0}, Lcom/android/server/om/OverlayManagerServiceImpl;->getEnabledOverlayPackageNames(Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-virtual {v9, v0}, Landroid/content/pm/PackageManagerInternal;->getOpenThemeTargetPackageNames(I)Ljava/util/List;
    ...
    const-string/jumbo v14, "updateAssetsLocked for fwk, targets "
    ...
    const-string/jumbo v13, "OverlayManager"

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v14, "-> Updating overlay: target="
    ...
    const-string/jumbo v14, " overlays=["
    ...
    invoke-virtual {v9, v0, v10, v12}, Landroid/content/pm/PackageManagerInternal;->setEnabledOverlayPackages(ILjava/lang/String;Ljava/util/List;)Z
    ...
    const-string/jumbo v13, "Failed to change enabled overlays for %s user %d"
...
.method synthetic lambda$-com_android_server_om_OverlayManagerService_39384()V
    .locals 5
