...
.method static synthetic -get5(Lcom/android/server/cover/CoverManagerService;)I
    .locals 1

    iget v0, p0, Lcom/android/server/cover/CoverManagerService;->mLedCoverServiceDisconnectCount:I
...
.method static synthetic -set2(Lcom/android/server/cover/CoverManagerService;I)I
    .locals 0

    iput p1, p0, Lcom/android/server/cover/CoverManagerService;->mLedCoverServiceDisconnectCount:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;Lcom/android/server/input/InputManagerService;)V
    ...
    iput-object v3, p0, Lcom/android/server/cover/CoverManagerService;->mGenericCoverServiceController:Lcom/android/server/cover/GenericCoverServiceController;
...
.method private sendCoverAttachStateLocked(ZLcom/samsung/android/cover/CoverState;)V
    ...
    iput-object v7, p0, Lcom/android/server/cover/CoverManagerService;->mLedCoverController:Lcom/android/server/cover/LedCoverController;
    ...
    invoke-virtual {v4}, Lcom/android/server/cover/Feature;->isSupportFlipCover()Z
    ...
    :cond_11
    iget-object v4, p0, Lcom/android/server/cover/CoverManagerService;->mGenericCoverServiceController:Lcom/android/server/cover/GenericCoverServiceController;

    if-nez v4, :cond_8

    new-instance v4, Lcom/android/server/cover/GenericCoverServiceController;
    ...
    invoke-direct {v4, v5, v6}, Lcom/android/server/cover/GenericCoverServiceController;-><init>(Landroid/os/Looper;Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/server/cover/CoverManagerService;->mGenericCoverServiceController:Lcom/android/server/cover/GenericCoverServiceController;
    ...
    iput-object v7, p0, Lcom/android/server/cover/CoverManagerService;->mNfcLedCoverController:Lcom/android/server/cover/BaseNfcLedCoverController;
    ...
    iput-object v7, p0, Lcom/android/server/cover/CoverManagerService;->mGenericCoverServiceController:Lcom/android/server/cover/GenericCoverServiceController;
...
.method public disableLcdOffByCover(Landroid/os/IBinder;Landroid/content/ComponentName;)Z
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/server/cover/CoverManagerService;->mGenericCoverServiceController:Lcom/android/server/cover/GenericCoverServiceController;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :cond_2
    iget-object v0, p0, Lcom/android/server/cover/CoverManagerService;->mGenericCoverServiceController:Lcom/android/server/cover/GenericCoverServiceController;
...
.method public notifySmartCoverAttachStateChanged(JZLcom/samsung/android/cover/CoverState;)V
    ...
    iget-object v3, p0, Lcom/android/server/cover/CoverManagerService;->mNfcLedCoverController:Lcom/android/server/cover/BaseNfcLedCoverController;

    if-eqz v3, :cond_3

    iget-object v3, p0, Lcom/android/server/cover/CoverManagerService;->mNfcLedCoverController:Lcom/android/server/cover/BaseNfcLedCoverController;

    invoke-virtual {v3}, Lcom/android/server/cover/BaseNfcLedCoverController;->notifyAuthenticationResponse()V
...
.method public requestCoverAuthentication(Landroid/os/IBinder;Landroid/content/ComponentName;)Z
    ...
    const-string/jumbo v4, "requestCoverAuthentication: whenNanos="
    ...
    const-string/jumbo v3, "requestCoverAuthentication : caller is invalid"
...
.method public setFotaInProgress(ZLandroid/os/IBinder;Landroid/content/ComponentName;)Z
    ...
    const-string/jumbo v2, "setFotaInProgress: inProgress="
...
.method public unregisterNfcTouchListenerCallback(Landroid/os/IBinder;)Z
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/server/cover/CoverManagerService;->mGenericCoverServiceController:Lcom/android/server/cover/GenericCoverServiceController;
