...
.method public getUserIconForBitmap(I)Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v9, "getUserIcon: unknown user #"
    ...
    iget v0, v6, Landroid/content/pm/UserInfo;->profileGroupId:I
    ...
    :cond_5
    const-string/jumbo v6, "get the icon of a user who is not related"
    ...
    :cond_7
    iget-object v6, v3, Landroid/content/pm/UserInfo;->iconPath:Ljava/lang/String;
    ...
    const-string/jumbo v6, "UserIcon"
    ...
    const-string/jumbo v9, "primary user in BMode"
    ...
    invoke-static {p1, v6, v8}, Lcom/android/internal/util/UserIcons;->getDefaultUserIconForBMode(IZZ)Landroid/graphics/drawable/Drawable;
    ...
    const-string/jumbo v9, "BMode user in BMode"
    ...
    const-string/jumbo v9, "load Default User Icon"
    ...
    invoke-static {p1, v6}, Lcom/android/internal/util/UserIcons;->getDefaultUserIcon(IZ)Landroid/graphics/drawable/Drawable;
