...
.method private canAddMoreDualApp(I)Z
    ...
    const-string/jumbo v4, "check if more managed profiles can be added."
    ...
    const-string/jumbo v5, "android.software.managed_users"
...
.method private createUserInternalUnchecked(Ljava/lang/String;II)Landroid/content/pm/UserInfo;
    ...
    invoke-direct {v0, v1, v2, v3, v11}, Lcom/android/server/pm/UserManagerService;->getNextAvailableId(ZZZZ)I
    ...
    const-string/jumbo v26, "Cannot add more dual app for user "
...
.method public createKnoxContainer(Ljava/lang/String;IZZ)Landroid/content/pm/UserInfo;
    ...
    const-string/jumbo v18, "Only the system can create users"

    invoke-static/range {v18 .. v18}, Lcom/android/server/pm/UserManagerService;->checkManageUsersPermission(Ljava/lang/String;)V

    if-eqz p2, :cond_0

    const-string/jumbo v18, "UserManagerService"

    const-string/jumbo v19, "Only user owner can have profiles"
    ...
    const-string/jumbo v19, "no_add_user"
    ...
    const-string/jumbo v19, "Cannot add user. DISALLOW_ADD_USER is enabled."
    ...
    const-string/jumbo v21, "UserInfo for parent is null, hence exiting container creation!"
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/server/pm/UserManagerService;->getNextAvailableId(ZZZZ)I
    ...
    invoke-direct {v0, v15, v1, v2, v7}, Landroid/content/pm/UserInfo;-><init>(ILjava/lang/String;Ljava/lang/String;I)V
    :try_end_5
    ...
    iput v15, v0, Landroid/content/pm/UserInfo;->serialNumber:I
    ...
    invoke-direct {v0, v14}, Lcom/android/server/pm/UserManagerService;->writeUserLP(Lcom/android/server/pm/UserManagerService$UserData;)V
    ...
    invoke-virtual {v0, v15, v6}, Landroid/util/SparseArray;->append(ILjava/lang/Object;)V

    new-instance v13, Landroid/os/Bundle;

    invoke-direct {v13}, Landroid/os/Bundle;-><init>()V

    const-string/jumbo v18, "no_outgoing_beam"
    ...
    const-string/jumbo v18, "no_add_user"
    ...
    invoke-virtual {v0, v13, v15}, Lcom/android/server/pm/UserManagerService;->setKnoxRestrictions(Landroid/os/Bundle;I)V
    :try_end_6
