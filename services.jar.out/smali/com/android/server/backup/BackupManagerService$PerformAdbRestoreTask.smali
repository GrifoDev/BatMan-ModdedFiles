...
.method constructor <init>(Lcom/android/server/backup/BackupManagerService;Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Ljava/lang/String;Landroid/app/backup/IFullBackupRestoreObserver;Ljava/util/concurrent/atomic/AtomicBoolean;ZI)V
    ...
    iput-object v2, p0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->mObbConnection:Lcom/android/server/backup/BackupManagerService$FullBackupObbConnection;

    iput-object v2, p0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->mPipes:[Landroid/os/ParcelFileDescriptor;

    iput-object v2, p0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->mWidgetData:[B
    ...
    iput-object v2, p0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->mAgent:Landroid/app/IBackupAgent;
    ...
    iput-object v2, p0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->mAgentPackage:Ljava/lang/String;

    iput-object v2, p0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->mTargetApp:Landroid/content/pm/ApplicationInfo;
...
.method readAppManifest(Lcom/android/server/backup/BackupManagerService$FileMetadata;Ljava/io/InputStream;)Lcom/android/server/backup/BackupManagerService$RestorePolicy;
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/backup/BackupManagerService;->-get3(Lcom/android/server/backup/BackupManagerService;)Z
    ...
    invoke-static/range {v22 .. v22}, Lcom/android/server/backup/BackupManagerService;->-get7(Lcom/android/server/backup/BackupManagerService;)I
...
.method restoreOneFile(Ljava/io/InputStream;[B)Z
    ...
    iget-object v10, v0, Lcom/android/server/backup/BackupManagerService$FileMetadata;->packageName:Ljava/lang/String;
    ...
    iget-object v8, v0, Lcom/android/server/backup/BackupManagerService$FileMetadata;->installerPackageName:Ljava/lang/String;
    ...
    const-string/jumbo v9, "Dropping invalid path "
    ...
    iget-object v9, v0, Lcom/android/server/backup/BackupManagerService$FileMetadata;->path:Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/android/server/backup/BackupManagerService;->-get3(Lcom/android/server/backup/BackupManagerService;)Z
    ...
    iget-object v4, v4, Lcom/android/server/backup/BackupManagerService;->mPackageManagerBinder:Landroid/content/pm/IPackageManager;
    ...
    invoke-static {v8}, Lcom/android/server/backup/BackupManagerService;->-get7(Lcom/android/server/backup/BackupManagerService;)I

    move-result v8

    const/4 v9, 0x0

    invoke-interface {v4, v10, v9, v8}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    iget v4, v0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->mUserId:I
    ...
    iget-boolean v4, v0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->mPrivilegeApp:Z
    ...
    iget v8, v0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->mUserId:I

    invoke-virtual {v4, v10, v8}, Lcom/android/server/backup/BackupManagerService;->clearApplicationDataSynchronous(Ljava/lang/String;I)V
    ...
    const-string/jumbo v8, "changing backup agent name to null for edm restore request"

    invoke-static {v4, v8}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v27, Landroid/content/pm/ApplicationInfo;
    ...
    invoke-virtual {v4, v0, v8}, Lcom/android/server/backup/BackupManagerService;->bindToAgentSynchronous(Landroid/content/pm/ApplicationInfo;I)Landroid/app/IBackupAgent;
    ...
    iget-object v8, v0, Lcom/android/server/backup/BackupManagerService$FileMetadata;->domain:Ljava/lang/String;
    ...
    iget v14, v0, Lcom/android/server/backup/BackupManagerService$FileMetadata;->type:I

    move-object/from16 v0, v34

    iget-object v15, v0, Lcom/android/server/backup/BackupManagerService$FileMetadata;->path:Ljava/lang/String;
    ...
    invoke-static {v4, v8}, Lcom/android/server/backup/BackupManagerService;->-set1(Lcom/android/server/backup/BackupManagerService;Z)Z
    ...
    invoke-virtual {v4, v10, v8}, Landroid/content/pm/PackageManager;->getApplicationInfo(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    const-string/jumbo v8, "Fail to get application\'s info to perform restore - mdm request"
    ...
    const-string/jumbo v8, "changing backup agent restore request for nowner"
    ...
    invoke-virtual {v4, v0, v9, v8}, Lcom/android/server/backup/BackupManagerService;->bindToAgentSynchronous(Landroid/content/pm/ApplicationInfo;II)Landroid/app/IBackupAgent;
    ...
    invoke-virtual {v4, v8, v9}, Lcom/android/server/backup/BackupManagerService;->bindToAgentSynchronous(Landroid/content/pm/ApplicationInfo;I)Landroid/app/IBackupAgent;
    ...
    invoke-direct/range {v11 .. v17}, Lcom/android/server/backup/KeyValueAdbRestoreEngine;-><init>(Lcom/android/server/backup/BackupManagerService;Ljava/io/File;Lcom/android/server/backup/BackupManagerService$FileMetadata;Landroid/os/ParcelFileDescriptor;Landroid/app/IBackupAgent;I)V
    ...
    iget-wide v15, v0, Lcom/android/server/backup/BackupManagerService$FileMetadata;->size:J
...
.method public run()V
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/server/backup/BackupManagerService;->-get3(Lcom/android/server/backup/BackupManagerService;)Z
    ...
    invoke-static/range {v21 .. v22}, Lcom/android/server/backup/BackupManagerService;->-wrap8(Lcom/android/server/backup/BackupManagerService;Ljava/lang/String;)Z
    ...
    invoke-static/range {v21 .. v22}, Lcom/android/server/backup/BackupManagerService;->-set1(Lcom/android/server/backup/BackupManagerService;Z)Z
    :try_end_5
...
.method tearDownAgent(Landroid/content/pm/ApplicationInfo;Z)V
    ...
    const-string/jumbo v2, "system agent - restoreFinished on thread"
    ...
    invoke-static {v0}, Lcom/android/server/backup/BackupManagerService;->-get4(Lcom/android/server/backup/BackupManagerService;)Landroid/app/IActivityManager;
