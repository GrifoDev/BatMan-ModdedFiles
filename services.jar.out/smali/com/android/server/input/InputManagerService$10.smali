...
.method constructor <init>(Lcom/android/server/input/InputManagerService;[Ljava/lang/String;Ljava/util/ArrayList;Landroid/hardware/input/InputDeviceIdentifier;Ljava/util/ArrayList;)V
    ...
    iput-object p2, p0, Lcom/android/server/input/InputManagerService$10;->val$enabledLayoutDescriptors:[Ljava/lang/String;

    iput-object p3, p0, Lcom/android/server/input/InputManagerService$10;->val$enabledLayouts:Ljava/util/ArrayList;

    iput-object p4, p0, Lcom/android/server/input/InputManagerService$10;->val$identifier:Landroid/hardware/input/InputDeviceIdentifier;

    iput-object p5, p0, Lcom/android/server/input/InputManagerService$10;->val$potentialLayouts:Ljava/util/ArrayList;
...
.method public visitKeyboardLayout(Landroid/content/res/Resources;ILandroid/hardware/input/KeyboardLayout;)V
    ...
    iget-object v2, p0, Lcom/android/server/input/InputManagerService$10;->val$enabledLayoutDescriptors:[Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/server/input/InputManagerService$10;->val$enabledLayouts:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lcom/android/server/input/InputManagerService$10;->val$identifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    iget-boolean v1, p0, Lcom/android/server/input/InputManagerService$10;->mHasSeenDeviceSpecificLayout:Z

    if-nez v1, :cond_2

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/android/server/input/InputManagerService$10;->mHasSeenDeviceSpecificLayout:Z

    iget-object v1, p0, Lcom/android/server/input/InputManagerService$10;->val$potentialLayouts:Ljava/util/ArrayList;
