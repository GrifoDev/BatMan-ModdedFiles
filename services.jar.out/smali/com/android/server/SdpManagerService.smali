...
.method private changeToken([BJ[BJI)Z
    ...
    new-instance v0, Lcom/android/server/-$Lambda$lhXyqUMYqEEsOESeK7W8eqkbJis$6;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/server/-$Lambda$lhXyqUMYqEEsOESeK7W8eqkbJis$6;-><init>(IJJLjava/lang/Object;Ljava/lang/Object;)V
...
.method private checkCredential(Ljava/lang/String;II)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    new-instance v3, Lcom/android/server/-$Lambda$lhXyqUMYqEEsOESeK7W8eqkbJis$7;

    invoke-direct {v3, p2, p3, p1}, Lcom/android/server/-$Lambda$lhXyqUMYqEEsOESeK7W8eqkbJis$7;-><init>(IILjava/lang/Object;)V
...
.method static synthetic lambda$-com_android_server_SdpManagerService_179846([BJILcom/android/internal/widget/ILockSettings;)Lcom/android/internal/widget/VerifyCredentialResponse;
    .locals 3
...
.method static synthetic lambda$-com_android_server_SdpManagerService_180640([BJ[BJILcom/android/internal/widget/ILockSettings;)Ljava/lang/Boolean;
    .locals 9
...
.method static synthetic lambda$-com_android_server_SdpManagerService_182254(Ljava/lang/String;IILcom/android/internal/widget/ILockSettings;)Lcom/android/internal/widget/VerifyCredentialResponse;
    .locals 3
...
.method static synthetic lambda$-com_android_server_SdpManagerService_184313(Ljava/lang/String;IJ[BILcom/android/internal/widget/ILockSettings;)Ljava/lang/Boolean;
    .locals 8
...
.method private setLockCredentialWithToken(Ljava/lang/String;IJ[BI)Z
    ...
    new-instance v1, Lcom/android/server/-$Lambda$lhXyqUMYqEEsOESeK7W8eqkbJis$8;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/server/-$Lambda$lhXyqUMYqEEsOESeK7W8eqkbJis$8;-><init>(IIJLjava/lang/Object;Ljava/lang/Object;)V
...
.method private verifyResetTokenInternal([BI)Z
    .locals 13
    ...
    const-string/jumbo v8, "Verify reset token for user "
    ...
    invoke-static {v5}, Lcom/sec/sdp/internal/SDPLog;->i(Ljava/lang/String;)V
    ...
    const-string/jumbo v8, "Unexpected condition while find engine info"

    invoke-direct {v5, v8}, Ljava/lang/Exception;-><init>(Ljava/lang/String;)V

    invoke-static {v5}, Lcom/sec/sdp/internal/SDPLog;->e(Ljava/lang/Exception;)V
    ...
    const-string/jumbo v8, "Result of token verification : "
    ...
    const-string/jumbo v5, "Failed due to invalid token given"
    ...
    :cond_2
    invoke-direct {p0, p2}, Lcom/android/server/SdpManagerService;->maybeLegacyKnoxUser(I)Z

    move-result v5

    if-eqz v5, :cond_3

    invoke-direct {p0, p2}, Lcom/android/server/SdpManagerService;->checkUserSecurity(I)V

    new-instance v2, Ljava/lang/String;

    invoke-direct {v2, p1}, Ljava/lang/String;-><init>([B)V

    invoke-virtual {p0, v2, p2, v10}, Lcom/android/server/SdpManagerService;->getLegacyMasterKey(Ljava/lang/String;II)[B
    ...
    :cond_3
    invoke-direct {p0, p2}, Lcom/android/server/SdpManagerService;->getTokenHandleViaProtector(I)J
    ...
    const-string/jumbo v5, "Failed due to invalid token handle"
    ...
    :cond_4
    invoke-direct {p0, p1, v6, v7, p2}, Lcom/android/server/SdpManagerService;->verifyToken([BJI)Lcom/android/internal/widget/VerifyCredentialResponse;
...
.method private verifyToken([BJI)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    new-instance v4, Lcom/android/server/-$Lambda$lhXyqUMYqEEsOESeK7W8eqkbJis$5;

    invoke-direct {v4, p4, p2, p3, p1}, Lcom/android/server/-$Lambda$lhXyqUMYqEEsOESeK7W8eqkbJis$5;-><init>(IJLjava/lang/Object;)V
...
.method public getResetToken(I)[B
    ...
    const-string/jumbo v1, "Permission denied to read token"
...
.method public getTokenHandle(I)J
    ...
    const-string/jumbo v1, "Permission denied to read token handle"
...
.method public setForceResetPassword(ILjava/lang/String;I)V
    .locals 4

    const-string/jumbo v1, "resetPersonaPassword"
    ...
    const-string/jumbo v3, "Not able to get password reset token. sdp_minor: "
...
.method public verifyResetToken(Ljava/lang/String;I)Z
    .locals 2
    ...
    :goto_0
    :try_start_0
    invoke-direct {p0, v0, p2}, Lcom/android/server/SdpManagerService;->verifyResetTokenInternal([BI)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
