...
.method protected sendProxyConfigBroadcast(Ljava/util/HashMap;ILandroid/net/ProxyInfo;ILjava/lang/String;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string/jumbo v12, "android.intent.action.PROXY_CHANGE"
    ...
    const-string/jumbo v12, "FW-KnoxVpnHelper"

    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v14, "preparing the broadcast which contains default proxy configuration for the uid added to knox vpn "
    ...
    invoke-direct {v10, v12, v13, v14}, Landroid/net/ProxyInfo;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    const/4 v12, 0x0

    invoke-virtual {v10, v12}, Landroid/net/ProxyInfo;->setKnoxVpnProfile(I)V

    :cond_1
    :goto_1
    const-string/jumbo v12, "android.intent.extra.PROXY_INFO"
    ...
    const-string/jumbo v14, "skipping sending the broadcast which contains proxy configuration to vpn client for per-app use-case "
    ...
    const-string/jumbo v14, "Exception occured while sending proxy broadcast to knox vpn apps "
    ...
    const-string/jumbo v14, "preparing the broadcast which contains pac configuration for the uid added to knox vpn "
    ...
    invoke-direct {v10, v12, v13}, Landroid/net/ProxyInfo;-><init>(Landroid/net/Uri;I)V
    ...
    const-string/jumbo v14, "preparing the broadcast which contains static proxy configuration for the uid added to knox vpn "
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/enterprise/vpn/knoxvpn/KnoxVpnHelper;->getInstalledPackages(I)[Ljava/lang/String;
    ...
    const-string/jumbo v14, "FW-KnoxVpnHelper"

    new-instance v15, Ljava/lang/StringBuilder;

    invoke-direct {v15}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v16, "skipping sending the broadcast which contains proxy configuration to vpn client for addAll use-case "
    ...
    const-string/jumbo v16, "sending proxy broadcast to the app added to knox vpn profile for addAll use-case "
    ...
    const-string/jumbo v16, "sending proxy broadcast to the app added to knox vpn profile for per use-case "
