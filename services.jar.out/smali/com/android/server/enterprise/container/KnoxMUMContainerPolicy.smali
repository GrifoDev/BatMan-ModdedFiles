...
.method public createContainer(Lcom/samsung/android/knox/ContextInfo;Lcom/samsung/android/knox/container/CreationParams;I)I
    ...
    invoke-virtual {v13, v0}, Lcom/android/server/am/ActivityManagerService;->getPackageFromAppProcesses(I)Ljava/lang/String;
...
.method public forceResetPassword(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;I)I
    ...
    const-string/jumbo v29, "forceResetPassword: containerId: "
    ...
    const-string/jumbo v29, "android.permission.sec.MDM_ENTERPRISE_CONTAINER"

    const/16 v30, 0x0

    aput-object v29, v28, v30

    const-string/jumbo v29, "com.samsung.android.knox.permission.KNOX_CONTAINER"
    ...
    sget-object v28, Lcom/android/server/enterprise/container/KnoxMUMContainerPolicy;->mContext:Landroid/content/Context;
    ...
    const-string/jumbo v29, "UCS enabled for user = "
    ...
    const-string/jumbo v29, "current quality = "
    ...
    const-string/jumbo v29, ", SMART CARD Quality = "
    ...
    const-string/jumbo v29, "forceResetPassword declined because Lock Quality set to Smartcard for user = "
    ...
    const-string/jumbo v28, "Reset Password requested for continaer "
    ...
    invoke-static/range {v27 .. v27}, Lcom/sec/sdp/internal/SDPLog;->i(Ljava/lang/String;)V
    ...
    const-string/jumbo v28, "cxtInfo"
    ...
    const-string/jumbo v28, "resetPwdKey"
    ...
    const-string/jumbo v28, "timeout"
    ...
    invoke-static/range {v27 .. v27}, Lcom/sec/sdp/internal/SDPLog;->p([Ljava/lang/Object;)V
    ...
    const-string/jumbo v28, "SP adaptation requried for user "
    ...
    invoke-static/range {v27 .. v27}, Lcom/sec/sdp/internal/SDPLog;->d(Ljava/lang/String;)V
    ...
    const-string/jumbo v27, "Failed to reset password due to no token found"
    ...
    const-string/jumbo v28, "Result of SP adaptation : "
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/server/SdpManagerService;->getLegacyMasterKey([BII)[B
    ...
    const-string/jumbo v27, "Failed to reset password due to invaild token"
    ...
    const-string/jumbo v27, "Unexpected exception while force reset password"
    ...
    invoke-virtual {v0, v13, v1}, Lcom/android/server/SdpManagerService;->setResetToken([BI)Z

    move-result v27

    if-nez v27, :cond_9

    const-string/jumbo v27, "Failed to set reset password"
    ...
    invoke-interface {v0, v13, v8, v9, v1}, Lcom/android/internal/widget/ILockSettings;->verifyToken([BJI)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    const-string/jumbo v27, "Failed to verify with reset token"
    ...
    invoke-virtual {v0, v12, v13, v1}, Lcom/android/server/SdpManagerService;->generationalShift([B[BI)Z
    ...
    invoke-static/range {v27 .. v27}, Lcom/android/server/SdpManagerService$SecureUtil;->isFailed(Ljava/lang/Object;)Z
    ...
    const-string/jumbo v27, "retrive legacy master key as escrow token"
    ...
    const-string/jumbo v27, "Reset - Failed due to invalid legacy token"
    ...
    invoke-virtual {v0, v11, v1, v2}, Lcom/android/server/SdpManagerService;->getLegacyMasterKey(Ljava/lang/String;II)[B
    ...
    const-string/jumbo v29, "tokenHandle:"
    ...
    :cond_f
    const-string/jumbo v27, "Reset password faied (Legacy token not found)"
    ...
    :cond_10
    :try_start_8
    const-string/jumbo v27, "set token as escrow token"
    ...
    :cond_12
    const-string/jumbo v27, "Reset password start"
    ...
    const-string/jumbo v27, "android.intent.extra.user_handle"
    ...
    const-string/jumbo v27, "knox.container.proxy.EXTRA_RESET_PWD_TOKEN_HANDLE"
    ...
    const-string/jumbo v27, "knox.container.proxy.EXTRA_RESET_PWD_TOKEN"

    move-object/from16 v0, v27

    invoke-virtual {v4, v0, v6}, Landroid/os/Bundle;->putByteArray(Ljava/lang/String;[B)V

    const-string/jumbo v27, "knox.container.proxy.COMMAND_RESET_PASSWORD"
    ...
    const-string/jumbo v27, "android.intent.extra.RETURN_RESULT"
    ...
    const-string/jumbo v28, "Reset password result: "
