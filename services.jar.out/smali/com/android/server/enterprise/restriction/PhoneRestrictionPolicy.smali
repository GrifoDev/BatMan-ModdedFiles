...
.method private updateRCSStatus()Z
    .locals 9
    ...
    invoke-virtual {p0, v4, v8, v7}, Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;->isRCSEnabled(Lcom/samsung/android/knox/ContextInfo;IZ)Z
    ...
    const-string/jumbo v6, "updateRCSStatus(): isRCSEnabled = "
    ...
    invoke-direct {v1, v4, v5}, Lcom/sec/ims/ImsManager;-><init>(Landroid/content/Context;Lcom/sec/ims/ImsManager$ConnectionListener;)V

    if-eqz v1, :cond_2

    invoke-virtual {v1}, Lcom/sec/ims/ImsManager;->isRcsEnabled()Z
    ...
    const-string/jumbo v6, "updateRCSStatus(): changed "
    ...
    invoke-virtual {v1, v3}, Lcom/sec/ims/ImsManager;->enableRcs(Z)V
    :try_end_0
    ...
    const-string/jumbo v5, "updateRCSStatus() : failed with unexpected exception."
    ...
    const-string/jumbo v5, "updateRCSStatus() : this device doesn\'t support RCS"
...
.method public onAdminRemoved(I)V
    ...
    invoke-direct {p0}, Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;->updateRCSStatus()Z
