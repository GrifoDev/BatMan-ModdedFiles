...
.method private checkCallerPermissionFor(Ljava/lang/String;)I
    ...
    const-string/jumbo v3, "checkCallerPermissionFor, ServiceName :"
...
.method private doSyncForSyncer(Ljava/lang/String;I)V
    ...
    const-string/jumbo v10, " doSyncForSyncer, syncerName :"
    ...
    const-string/jumbo v10, " , mUserID :"
    ...
    invoke-direct {p0, p1, v8}, Lcom/android/server/bridge/BridgeProxy;->getPolicy(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v8, "delete_synced_data_of_user"
    ...
    const-string/jumbo v10, " delete synced data policyName = "
    ...
    const-string/jumbo v10, " providerID = "
    ...
    const-string/jumbo v10, " SyncerID = "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-object v10, p0, Lcom/android/server/bridge/BridgeProxy;->mDelegateUserHandle:Landroid/os/UserHandle;

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    move-result-object v9

    const-string/jumbo v10, " syncerName = "
    ...
    iget v8, p0, Lcom/android/server/bridge/BridgeProxy;->mDelegateUserId:I
    ...
    iget-object v8, p0, Lcom/android/server/bridge/BridgeProxy;->mSecureFolderPkg:Ljava/lang/String;

    iget-object v9, p0, Lcom/android/server/bridge/BridgeProxy;->mSecureSyncerServiceClass:Ljava/lang/String;
    ...
    :goto_3
    iget-object v8, p0, Lcom/android/server/bridge/BridgeProxy;->mContext:Landroid/content/Context;

    invoke-virtual {v8, v4, v7}, Landroid/content/Context;->startServiceAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)Landroid/content/ComponentName;
    :try_end_0
    ...
    invoke-virtual {v8, v9, p2, v6}, Lcom/samsung/android/knox/SemRemoteContentManager;->exchangeData(Landroid/content/Context;ILandroid/os/Bundle;)Landroid/os/Bundle;
    ...
    const-string/jumbo v10, " start syncing for "
    ...
    const-string/jumbo v10, "for policy name ="
    ...
    const-string/jumbo v10, " from provider"
    ...
    const-string/jumbo v8, "com.samsung.containeragent.ACTION_DB_CHANGED"

    invoke-virtual {v4, v8}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    const-string/jumbo v8, "provider_user"
    ...
    iget-object v8, p0, Lcom/android/server/bridge/BridgeProxy;->mContainerAgentPkg:Ljava/lang/String;

    iget-object v9, p0, Lcom/android/server/bridge/BridgeProxy;->mSyncerServiceClass:Ljava/lang/String;
    ...
    :cond_7
    :try_start_2
    iget-object v7, p0, Lcom/android/server/bridge/BridgeProxy;->mDelegateUserHandle:Landroid/os/UserHandle;
    :try_end_2
    ...
    const-string/jumbo v9, "Unable to start service"
...
.method private policyChanged(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    iget-object v14, v0, Lcom/android/server/bridge/BridgeProxy;->dbObserver:Lcom/android/server/bridge/operations/DbObserver;
    ...
    invoke-virtual {v14, v0}, Lcom/android/server/bridge/operations/DbObserver;->unRegisterObserver(Ljava/lang/String;)V
    ...
    invoke-virtual {v14, v0}, Lcom/android/server/bridge/operations/DbObserver;->registerObserver(Ljava/lang/String;)V
