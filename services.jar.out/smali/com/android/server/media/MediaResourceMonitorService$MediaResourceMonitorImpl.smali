...
.method private getMediaType(I)Ljava/lang/String;
    ...
    const-string/jumbo v0, "no Media Type"
...
.method private getProtocolType(I)Ljava/lang/String;
    ...
    const-string/jumbo v0, "no Protocal Type"

    return-object v0

    :pswitch_0
    const-string/jumbo v0, "Local File"
...
.method public notifyResourceGranted(II)V
    ...
    invoke-static {v4, v5}, Lcom/android/server/media/MediaResourceMonitorService;->-set0(Lcom/android/server/media/MediaResourceMonitorService;Landroid/content/pm/PackageManager;)Landroid/content/pm/PackageManager;

    iget-object v4, p0, Lcom/android/server/media/MediaResourceMonitorService$MediaResourceMonitorImpl;->this$0:Lcom/android/server/media/MediaResourceMonitorService;

    invoke-static {v4}, Lcom/android/server/media/MediaResourceMonitorService;->-get1(Lcom/android/server/media/MediaResourceMonitorService;)Landroid/content/pm/PackageManager;
