...
.method private dispatchMediaKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    ...
    invoke-static {v1}, Lcom/android/server/media/MediaSessionService;->-get16(Lcom/android/server/media/MediaSessionService;)Landroid/util/SparseArray;
    ...
    invoke-static {v1}, Lcom/android/server/media/MediaSessionService;->-get12(Lcom/android/server/media/MediaSessionService;)Landroid/os/PowerManager$WakeLock;
...
.method private handleVolumeKeyLongPress(IIIZ)V
    ...
    invoke-static {v0}, Lcom/android/server/media/MediaSessionService;->-get11(Lcom/android/server/media/MediaSessionService;)Ljava/lang/Object;
...
.method private startVoiceInput(Z)V
    ...
    invoke-static {v7}, Lcom/android/server/media/MediaSessionService;->-get9(Lcom/android/server/media/MediaSessionService;)Landroid/app/KeyguardManager;
    ...
    invoke-static {v6}, Lcom/android/server/media/MediaSessionService;->-get12(Lcom/android/server/media/MediaSessionService;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v6}, Lcom/android/server/media/MediaSessionService;->-get9(Lcom/android/server/media/MediaSessionService;)Landroid/app/KeyguardManager;
    ...
    invoke-static {v7}, Lcom/android/server/media/MediaSessionService;->-get12(Lcom/android/server/media/MediaSessionService;)Landroid/os/PowerManager$WakeLock;
...
.method public addSessionsListener(Landroid/media/session/IActiveSessionsListener;Landroid/content/ComponentName;I)V
    ...
    invoke-static {v1}, Lcom/android/server/media/MediaSessionService;->-get10(Lcom/android/server/media/MediaSessionService;)Ljava/lang/Object;
    ...
    invoke-static {v1}, Lcom/android/server/media/MediaSessionService;->-get15(Lcom/android/server/media/MediaSessionService;)Ljava/util/ArrayList;
...
.method public dispatchAdjustVolume(III)V
    ...
    invoke-static {v6}, Lcom/android/server/media/MediaSessionService;->-get10(Lcom/android/server/media/MediaSessionService;)Ljava/lang/Object;
    ...
    invoke-static {v6}, Lcom/android/server/media/MediaSessionService;->-get14(Lcom/android/server/media/MediaSessionService;)Lcom/android/server/media/MediaSessionStack;
...
.method public dispatchMediaKeyEvent(Landroid/view/KeyEvent;Z)V
    ...
    const-string/jumbo v20, "hmtState"

    invoke-static/range {v20 .. v20}, Landroid/media/AudioSystem;->getParameters(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v20 .. v20}, Landroid/view/KeyEvent;->isMediaKey(I)Z
    ...
    const-string/jumbo v20, "MediaSessionService"

    new-instance v21, Ljava/lang/StringBuilder;

    invoke-direct/range {v21 .. v21}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v22, "dispatchMediaKeyEvent, pid="
    ...
    const-string/jumbo v21, "Not dispatching media key event because user setup is in progress."
    ...
    const-string/jumbo v21, "Attempted to dispatch null or non-media key event."
    ...
    const-string/jumbo v21, "Only the system can dispatch media key event to the global priority session."
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/media/MediaSessionService;->-get10(Lcom/android/server/media/MediaSessionService;)Ljava/lang/Object;
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/media/MediaSessionService;->-get16(Lcom/android/server/media/MediaSessionService;)Landroid/util/SparseArray;
    ...
    invoke-static/range {v22 .. v22}, Lcom/android/server/media/MediaSessionService;->-get5(Lcom/android/server/media/MediaSessionService;)I
    ...
    check-cast v18, Lcom/android/server/media/MediaSessionService$UserRecord;

    if-eqz v18, :cond_4

    invoke-static/range {v18 .. v18}, Lcom/android/server/media/MediaSessionService$UserRecord;->-get0(Lcom/android/server/media/MediaSessionService$UserRecord;)Landroid/app/PendingIntent;

    move-result-object v20

    if-nez v20, :cond_6

    invoke-static/range {v18 .. v18}, Lcom/android/server/media/MediaSessionService$UserRecord;->-get1(Lcom/android/server/media/MediaSessionService$UserRecord;)Landroid/content/ComponentName;
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/media/MediaSessionService;->-get14(Lcom/android/server/media/MediaSessionService;)Lcom/android/server/media/MediaSessionStack;
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/media/MediaSessionService;->-get8(Lcom/android/server/media/MediaSessionService;)Z
    ...
    const-string/jumbo v23, "getDevice, "
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/media/MediaSessionService;->-get13(Lcom/android/server/media/MediaSessionService;)Ljava/util/HashMap;
    ...
    check-cast v11, Lcom/android/server/media/MediaSessionRecord;
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/media/MediaSessionService;->-get3(Lcom/android/server/media/MediaSessionService;)Landroid/media/IAudioService;

    move-result-object v20

    invoke-virtual {v11}, Lcom/android/server/media/MediaSessionRecord;->getOwnerUid()I
    ...
    const-string/jumbo v22, "Error getAppDevice."
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/media/MediaSessionService;->-get6(Lcom/android/server/media/MediaSessionService;)I
    ...
    const-string/jumbo v23, " is selected"
    ...
    invoke-virtual {v13, v0}, Lcom/android/server/media/MediaSessionRecord;->hasFlag(I)Z
    ...
    const-string/jumbo v20, "unmount"
    ...
    const-string/jumbo v22, "Headset"
    ...
    invoke-direct {v0, v1, v2, v13}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->handleVoiceKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    :try_end_9
    ...
    invoke-direct {v0, v1, v2, v13}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->dispatchMediaKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    :try_end_b
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lcom/android/server/media/MediaSessionService;->-get10(Lcom/android/server/media/MediaSessionService;)Ljava/lang/Object;
    ...
    invoke-static {v11}, Lcom/android/server/media/MediaSessionService;->-get15(Lcom/android/server/media/MediaSessionService;)Ljava/util/ArrayList;
    ...
    invoke-static {v9}, Lcom/android/server/media/MediaSessionService;->-get15(Lcom/android/server/media/MediaSessionService;)Ljava/util/ArrayList;
    ...
    invoke-static {v9}, Lcom/android/server/media/MediaSessionService;->-get2(Lcom/android/server/media/MediaSessionService;)Ljava/util/ArrayList;
    ...
    invoke-static {v9}, Lcom/android/server/media/MediaSessionService;->-get14(Lcom/android/server/media/MediaSessionService;)Lcom/android/server/media/MediaSessionStack;
    ...
    invoke-static {v9}, Lcom/android/server/media/MediaSessionService;->-get16(Lcom/android/server/media/MediaSessionService;)Landroid/util/SparseArray;
    ...
    invoke-static {v11}, Lcom/android/server/media/MediaSessionService;->-get16(Lcom/android/server/media/MediaSessionService;)Landroid/util/SparseArray;
    ...
    invoke-static {v9}, Lcom/android/server/media/MediaSessionService;->-get13(Lcom/android/server/media/MediaSessionService;)Ljava/util/HashMap;
...
.method public isGlobalPriorityActive()Z
    ...
    invoke-static {v0}, Lcom/android/server/media/MediaSessionService;->-get14(Lcom/android/server/media/MediaSessionService;)Lcom/android/server/media/MediaSessionStack;
...
.method public removeSessionsListener(Landroid/media/session/IActiveSessionsListener;)V
    ...
    invoke-static {v3}, Lcom/android/server/media/MediaSessionService;->-get10(Lcom/android/server/media/MediaSessionService;)Ljava/lang/Object;
    ...
    invoke-static {v3}, Lcom/android/server/media/MediaSessionService;->-get15(Lcom/android/server/media/MediaSessionService;)Ljava/util/ArrayList;
