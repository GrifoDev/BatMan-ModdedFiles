...
.field private static final ENABLE:I = 0x0
...
.field private static final SUPPORT_CMF_WALLPAPER:Z = true
...
.field private mSetImageWallpaper:Z
...
.method static synthetic -wrap1(IZ)Lcom/android/internal/util/JournaledFile;
    .locals 1
...
.method static synthetic -wrap10(Lcom/android/server/wallpaper/WallpaperManagerService;Ljava/io/InputStream;Ljava/io/FileOutputStream;)V
    .locals 0
...
.method static synthetic -wrap7(ILjava/lang/String;)[Ljava/lang/String;
    .locals 1
...
.method static synthetic -wrap8(Lcom/android/server/wallpaper/WallpaperManagerService;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -wrap9(Lcom/android/server/wallpaper/WallpaperManagerService;I)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v7, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mSetImageWallpaper:Z
...
.method private generateCrop(Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;I)V
    ...
    iget-object v7, v0, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->cropFile:Ljava/io/File;

    const-string/jumbo v25, "WallpaperManagerService"

    new-instance v26, Ljava/lang/StringBuilder;

    invoke-direct/range {v26 .. v26}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v27, "Generating crop for new wallpaper(s): 0x"
    ...
    const-string/jumbo v26, "Invalid wallpaper data"
    ...
    const-string/jumbo v26, "Unable to apply new wallpaper"
    ...
    invoke-static/range {v25 .. v25}, Landroid/os/SELinux;->restorecon(Ljava/io/File;)Z
    ...
    const-string/jumbo v27, "restorecon() of crop file returned "
    ...
    const-string/jumbo v27, " cropFile length="
    ...
    invoke-static/range {v25 .. v26}, Landroid/graphics/BitmapRegionDecoder;->newInstance(Ljava/lang/String;Z)Landroid/graphics/BitmapRegionDecoder;
    ...
    const-string/jumbo v26, "Null crop of new wallpaper; copying"
    ...
    const-string/jumbo v27, "Downsampling cropped rect with scale "
    ...
    invoke-virtual {v10, v8, v0}, Landroid/graphics/BitmapRegionDecoder;->decodeRegion(Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v26, "Could not decode new wallpaper"
    ...
    const-string/jumbo v27, ", extracting "
    ...
    invoke-static {v9, v11, v0, v1}, Landroid/graphics/Bitmap;->createScaledBitmap(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;

    move-result-object v16

    const-string/jumbo v25, "WallpaperManagerService"

    const-string/jumbo v26, "Final extract:"
    ...
    const-string/jumbo v26, "Error decoding crop"
...
.method private getDeviceColorCodeFromSystemProperty(Landroid/content/Context;)Ljava/lang/String;
    ...
    new-instance v3, Lcom/android/server/wallpaper/WallpaperManagerService$7;

    invoke-direct {v3, p0, p1}, Lcom/android/server/wallpaper/WallpaperManagerService$7;-><init>(Lcom/android/server/wallpaper/WallpaperManagerService;Landroid/content/Context;)V
...
.method private migrateOldKeyguardWallpaper()V
    ...
    invoke-direct {v4, p0, v3}, Lcom/android/server/wallpaper/WallpaperManagerService$6;-><init>(Lcom/android/server/wallpaper/WallpaperManagerService;Ljava/lang/String;)V

    sget-object v5, Landroid/os/AsyncTask;->THREAD_POOL_EXECUTOR:Ljava/util/concurrent/Executor;

    new-array v6, v8, [Ljava/lang/Void;

    invoke-virtual {v4, v5, v6}, Lcom/android/server/wallpaper/WallpaperManagerService$6;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method private onRefreshWallpaperByUiMode(Z)V
    ...
    const-string/jumbo v4, "onRefreshWallpaperByUiMode mWallpaperObserver is null"
...
.method private parsingColor(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v3, "parsingColor cmfColorCode = "
...
.method private rebindDefaultWallpaperIfNeeded()V
    ...
    iget-object v6, v0, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->wallpaperComponent:Landroid/content/ComponentName;
...
.method private setRestoreKWP(ILcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)Z
    ...
    const-string/jumbo v12, "restorecon() of lock file returned "
...
.method bindWallpaperComponentLocked(Landroid/content/ComponentName;ZZLcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;Landroid/os/IRemoteCallback;)Z
    ...
    iget-boolean v4, v0, Lcom/android/server/wallpaper/WallpaperManagerService;->mSetImageWallpaper:Z
    ...
    iput-boolean v4, v0, Lcom/android/server/wallpaper/WallpaperManagerService;->mSetImageWallpaper:Z
    ...
    const-string/jumbo v6, "Binding to:"
    ...
    const-string/jumbo v5, "send ChangedIntent complete, detaching lastwallpaper"
    ...
    const-string/jumbo v5, "call detaching lastwallpaper"
    ...
    const-string/jumbo v6, "Wallpaper Token adding Start, previous userId : "
...
.method public copyFileToWallpaperFile()V
    ...
    iput v11, v2, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->kwpType:I

    iput-boolean v10, v2, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->imageWallpaperPending:Z
    ...
    invoke-direct {p0, v3, v10}, Lcom/android/server/wallpaper/WallpaperManagerService;->getWallpaperData(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
    ...
    const-string/jumbo v9, "restorecon() of lock file returned "
    ...
    :goto_0
    invoke-virtual {p0, v10}, Lcom/android/server/wallpaper/WallpaperManagerService;->setKWPTypeLiveWallpaper(I)V

    invoke-virtual {p0, v11}, Lcom/android/server/wallpaper/WallpaperManagerService;->setKWPTypePreload(I)V
...
.method public setImageWallpaper(Z)V
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mSetImageWallpaper:Z
...
.method public setWallpaperIndexOf(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Rect;ZLandroid/os/Bundle;ILandroid/app/IWallpaperManagerCallback;III)Landroid/os/ParcelFileDescriptor;
    ...
    iget-boolean v2, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mIsDesktopMode:Z
    ...
    const-string/jumbo v3, "setWallpaperIndexOf Don\'t tell anyone KeyguardWallpaperUpdator is alive while in DeX mode."
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/wallpaper/WallpaperManagerService;->setSWPTypePreload(I)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/wallpaper/WallpaperManagerService;->setKWPTypePreload(I)V
...
.method systemReady()V
    ...
    invoke-direct {v6, p0}, Lcom/android/server/wallpaper/WallpaperManagerService$3;-><init>(Lcom/android/server/wallpaper/WallpaperManagerService;)V
    ...
    invoke-direct {v5, p0, v2}, Lcom/android/server/wallpaper/WallpaperManagerService$4;-><init>(Lcom/android/server/wallpaper/WallpaperManagerService;Lcom/samsung/android/knox/SemPersonaManager;)V
