...
.method private cleanupUpstream()V
    ...
    iput-object v6, v2, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mMyUpstreamIfaceName:Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/Tethering;->-get27(Lcom/android/server/connectivity/Tethering;)Landroid/net/INetworkStatsService;
...
.method public enter()V
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/Tethering;->-wrap12(Lcom/android/server/connectivity/Tethering;)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v10, p0, v11}, Lcom/android/server/connectivity/Tethering;->-wrap9(Lcom/android/server/connectivity/Tethering;Lcom/android/internal/util/State;I)V
    ...
    const-string/jumbo v12, "TetheredState.processMessage what="
    ...
    const-string/jumbo v12, "calling nwserice to untether ifcae "
    ...
    invoke-static {v10}, Lcom/android/server/connectivity/Tethering;->-get19(Lcom/android/server/connectivity/Tethering;)Landroid/os/INetworkManagementService;
    ...
    invoke-static {v10}, Lcom/android/server/connectivity/Tethering;->-get28(Lcom/android/server/connectivity/Tethering;)Lcom/android/internal/util/StateMachine;
    ...
    invoke-virtual {v10, v12, v11}, Lcom/android/internal/util/StateMachine;->sendMessage(ILjava/lang/Object;)V
    ...
    invoke-static {v10, v11}, Lcom/android/server/connectivity/Tethering;->-wrap1(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    invoke-static {v10, v11}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->-wrap1(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;I)V
    ...
    invoke-static {v10}, Lcom/android/server/connectivity/Tethering;->-wrap15(Lcom/android/server/connectivity/Tethering;)V
    ...
    invoke-static {v11}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->-get0(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;)Lcom/android/internal/util/State;

    move-result-object v11

    invoke-static {v10, v11}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->-wrap3(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Lcom/android/internal/util/IState;)V
    ...
    const-string/jumbo v12, "Untethered "
    ...
    invoke-static {v11}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->-get3(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;)Lcom/android/internal/util/State;
    ...
    const-string/jumbo v10, "actualIface"
    ...
    iput-object v10, v11, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mActualUpstreamIfaceName:Ljava/lang/String;
    ...
    const-string/jumbo v11, "newUpstreamIfaceName = "
    ...
    const-string/jumbo v11, ", mActualUpstreamIfaceName = "
    ...
    iget-object v11, v11, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mActualUpstreamIfaceName:Ljava/lang/String;
    ...
    const-string/jumbo v11, ", mMyUpstreamIfaceName = "
    ...
    const-string/jumbo v11, "Connection changed noop - dropping"
    ...
    iget-object v13, v13, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mActualUpstreamIfaceName:Ljava/lang/String;

    invoke-interface {v10, v11, v12, v13}, Landroid/os/INetworkManagementService;->updateRa(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v10, "Tethering"

    const-string/jumbo v11, "update RA when the address is changed"
    ...
    const-string/jumbo v12, "Exception update RA: "
    ...
    const-string/jumbo v11, "don\'t sent RA, It can cause deactivation of some PDN "
    ...
    invoke-static {v10}, Lcom/android/server/connectivity/Tethering;->-get8(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    ...
    const-string/jumbo v11, "wifi_ap_wifi_sharing"
    ...
    invoke-interface {v10, v7}, Landroid/os/INetworkManagementService;->getInterfaceConfig(Ljava/lang/String;)Landroid/net/InterfaceConfiguration;
    ...
    invoke-virtual {v5, v10}, Landroid/net/InterfaceConfiguration;->hasFlag(Ljava/lang/String;)Z
    ...
    const-string/jumbo v12, "newUpstreamIfaceName :"
    ...
    const-string/jumbo v12, "Enabling NAT - Tethered Iface = "
    ...
    invoke-interface {v10, v11, v7}, Landroid/os/INetworkManagementService;->startInterfaceForwarding(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_5
    .catch Ljava/lang/Exception; {:try_start_5 .. :try_end_5} :catch_3
    ...
    const-string/jumbo v12, "CscFeature_RIL_PDPRetryMechanism4"
    ...
    invoke-static {v10}, Lcom/android/server/connectivity/Tethering;->-get22(Lcom/android/server/connectivity/Tethering;)I
    ...
    iput-object v7, v10, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mMyUpstreamIfaceName:Ljava/lang/String;
    ...
    const-string/jumbo v12, "Exception ifcg: "
    ...
    const-string/jumbo v12, "Exception enabling Nat: "
    ...
    invoke-interface {v10, v11, v7}, Landroid/os/INetworkManagementService;->disableNat(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_7
    ...
    const-string/jumbo v12, "Tried to enableNat on an unknown iface :"
    ...
    const-string/jumbo v12, "Tether lost upstream connection "
    ...
    invoke-static {v10}, Lcom/android/server/connectivity/Tethering;->-wrap12(Lcom/android/server/connectivity/Tethering;)V
