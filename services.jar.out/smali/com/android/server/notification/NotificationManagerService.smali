...
.method buzzBeepBlinkLocked(Lcom/android/server/notification/NotificationRecord;)V
    ...
    :goto_1
    sget-boolean v36, Lcom/android/server/notification/NotificationManagerService;->DBG:Z
    ...
    :cond_1
    const-string/jumbo v36, "NotificationService"
    ...
    const-string/jumbo v38, " canInterrupt="
    ...
    const-string/jumbo v38, " intercept="
    ...
    const-string/jumbo v37, "Interrupting!"
    ...
    invoke-virtual/range {v36 .. v37}, Landroid/net/Uri;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static/range {v36 .. v36}, Lcom/samsung/android/app/SemDualAppManager;->isDualAppId(I)Z

    move-result v36

    if-eqz v36, :cond_6

    invoke-static {}, Lcom/android/server/DualAppManagerService;->getDualAppNotificationSound()Ljava/lang/String;
    ...
    const-string/jumbo v36, "notification_sound"
    ...
    invoke-virtual/range {v36 .. v36}, Landroid/media/AudioManager;->getRingerModeInternal()I
    ...
    invoke-virtual/range {v36 .. v37}, Landroid/media/AudioManager;->getStreamVolume(I)I
    ...
    invoke-virtual/range {v36 .. v36}, Landroid/media/AudioManager;->isAudioFocusExclusive()Z
    ...
    sget-object v40, Landroid/os/Vibrator$SemMagnitudeTypes;->TYPE_NOTIFICATION:Landroid/os/Vibrator$SemMagnitudeTypes;
    ...
    invoke-static/range {v36 .. v36}, Landroid/view/accessibility/AccessibilityManager;->getInstance(Landroid/content/Context;)Landroid/view/accessibility/AccessibilityManager;
    ...
    invoke-virtual/range {v36 .. v36}, Lcom/android/server/lights/Light;->pulse()V
    ...
    const-string/jumbo v37, "Suppressed SystemUI from triggering screen on"
    ...
    invoke-virtual/range {v36 .. v37}, Lcom/android/server/notification/ManagedServices$UserProfiles;->isCurrentProfile(I)Z
    ...
    invoke-virtual/range {v36 .. v36}, Landroid/media/AudioManager;->getRingtonePlayer()Landroid/media/IRingtonePlayer;
    ...
    const-string/jumbo v38, "Playing sound "
    ...
    const-string/jumbo v38, " with attributes "
    ...
    invoke-virtual/range {v36 .. v36}, Landroid/service/notification/StatusBarNotification;->getUser()Landroid/os/UserHandle;
    ...
    invoke-virtual/range {v36 .. v36}, Lcom/android/server/notification/EasyMuteController;->registerListener()V
    :try_end_2
