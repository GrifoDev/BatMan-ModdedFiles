...
.method private updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    iput-object v8, p0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;
    ...
    invoke-virtual {p2, v8}, Landroid/net/NetworkInfo;->setType(I)V
    ...
    const-string/jumbo v8, "roaming status changed, notifying NetworkStatsService"
    ...
    :cond_1
    const-string/jumbo v8, "ignoring duplicate network state non-change"
    ...
    const-string/jumbo v9, "Update the connection status of VPN -> "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;
    ...
    const-string/jumbo v9, "2Gvoice suspended networkinfo : "
    ...
    iget v11, v8, Landroid/net/Network;->netId:I
    ...
    :goto_4
    invoke-interface {v10, v11, v9, v8}, Landroid/os/INetworkManagementService;->createVirtualNetwork(IZZ)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    :cond_7
    iget-boolean v8, p1, Lcom/android/server/connectivity/NetworkAgentInfo;->everConnected:Z
    ...
    iput-boolean v8, p1, Lcom/android/server/connectivity/NetworkAgentInfo;->everConnected:Z
    ...
    const-string/jumbo v8, "ril.ims_netid"
    ...
    const-string/jumbo v9, "ril.ims_netid was set to "
    ...
    const-string/jumbo v8, "ril.epdn_netid"
    ...
    const-string/jumbo v8, "ril.eims_netid"
    ...
    const-string/jumbo v9, "ril.epdn_netid was set to "
    ...
    invoke-direct {p0, v8, v9}, Lcom/android/server/ConnectivityService;->updateBidirectionalTcp(Landroid/net/LinkProperties;Z)V
    ...
    invoke-virtual {v8, v9}, Lcom/android/server/connectivity/NetworkMonitor;->sendMessage(I)V
    ...
    :try_start_2
    iget-boolean v8, p0, Lcom/android/server/ConnectivityService;->mDefaultProxyDisabled:Z

    if-nez v8, :cond_d

    const/4 v8, 0x1

    iput-boolean v8, p0, Lcom/android/server/ConnectivityService;->mDefaultProxyDisabled:Z
    ...
    invoke-direct {p0, p1, v8, v9}, Lcom/android/server/ConnectivityService;->updateSignalStrengthThresholds(Lcom/android/server/connectivity/NetworkAgentInfo;Ljava/lang/String;Landroid/net/NetworkRequest;)V

    sget-object v8, Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;->REAP:Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;

    invoke-direct {p0, p1, v8}, Lcom/android/server/ConnectivityService;->rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;)V

    const v8, 0x80001

    invoke-virtual {p0, p1, v8}, Lcom/android/server/ConnectivityService;->notifyNetworkCallbacks(Lcom/android/server/connectivity/NetworkAgentInfo;I)V
    ...
    const-string/jumbo v9, "2Gvoice connected networkinfo : "
    ...
    const-string/jumbo v9, "isSuspendedToConnected : "
    ...
    :goto_7
    invoke-interface {v9, v10, v8}, Landroid/os/INetworkManagementService;->createPhysicalNetwork(ILjava/lang/String;)V
    :try_end_3
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_3} :catch_0
    ...
    const-string/jumbo v9, "Error creating network "
    ...
    invoke-virtual {v8, p1}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->update(Lcom/android/server/connectivity/NetworkAgentInfo;)V
...
.method public requestNetwork(Landroid/net/NetworkCapabilities;Landroid/os/Messenger;ILandroid/os/IBinder;I)Landroid/net/NetworkRequest;
    ...
    sget-object v7, Lcom/android/server/ConnectivityService$NetworkRequestType;->TRACK_DEFAULT:Lcom/android/server/ConnectivityService$NetworkRequestType;

    :goto_0
    sget-object v3, Lcom/android/server/ConnectivityService$NetworkRequestType;->TRACK_DEFAULT:Lcom/android/server/ConnectivityService$NetworkRequestType;
    ...
    :goto_1
    invoke-direct/range {p0 .. p1}, Lcom/android/server/ConnectivityService;->ensureRequestableCapabilities(Landroid/net/NetworkCapabilities;)V
    ...
    const-string/jumbo v4, "Bad timeout specified"
    ...
    :cond_1
    sget-object v7, Lcom/android/server/ConnectivityService$NetworkRequestType;->REQUEST:Lcom/android/server/ConnectivityService$NetworkRequestType;
    ...
    invoke-direct {v15, v0}, Landroid/net/NetworkCapabilities;-><init>(Landroid/net/NetworkCapabilities;)V

    move-object/from16 v0, p0

    invoke-direct {v0, v15}, Lcom/android/server/ConnectivityService;->enforceNetworkRequestPermissions(Landroid/net/NetworkCapabilities;)V

    move-object/from16 v0, p0

    invoke-direct {v0, v15}, Lcom/android/server/ConnectivityService;->enforceMeteredApnPolicy(Landroid/net/NetworkCapabilities;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/net/NetworkCapabilities;->getNetworkSpecifier()Ljava/lang/String;
    ...
    const-string/jumbo v4, "Invalid network specifier - must not be \'*\'"
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/ConnectivityService$NetworkRequestInfo;-><init>(Lcom/android/server/ConnectivityService;Landroid/os/Messenger;Landroid/net/NetworkRequest;Landroid/os/IBinder;Lcom/android/server/ConnectivityService$NetworkRequestType;)V
    ...
    invoke-virtual {v3, v4, v8, v9}, Lcom/android/server/ConnectivityService$InternalHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    iget-object v3, v0, Lcom/android/server/ConnectivityService;->mRequestNetworkInfos:Ljava/util/LinkedList;

    new-instance v8, Lcom/android/server/ConnectivityService$RequestNetworkInfo;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v10

    iget v12, v2, Lcom/android/server/ConnectivityService$NetworkRequestInfo;->mUid:I

    iget v13, v2, Lcom/android/server/ConnectivityService$NetworkRequestInfo;->mPid:I

    move-object/from16 v9, p0

    move/from16 v14, p5

    invoke-direct/range {v8 .. v14}, Lcom/android/server/ConnectivityService$RequestNetworkInfo;-><init>(Lcom/android/server/ConnectivityService;JIII)V
