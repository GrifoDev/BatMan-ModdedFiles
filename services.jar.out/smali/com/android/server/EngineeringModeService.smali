...
.method private isTokenAreaEmpty()I
    .locals 5
    ...
    const-string/jumbo v4, "isTokenAreaEmpty() is called EM"
    ...
    const-string/jumbo v3, "isTokenAreaEmpty is only supported in EM version 2"
    ...
    :cond_1
    :try_start_2
    invoke-direct {p0}, Lcom/android/server/EngineeringModeService;->nativeEM20IsTokenAreaEmpty()I
    ...
    const-string/jumbo v3, "Token area is all zero"
...
.method private native nativeEM20IsTokenAreaEmpty()I
.end method
...
.method private registerClients()V
    ...
    :try_start_0
    new-instance v4, Lcom/android/server/EngineeringModeService$EMApplication;

    const-string/jumbo v13, "com.sec.android.app.emservice"

    const/16 v14, 0x3e8

    invoke-direct {v4, p0, v13, v14}, Lcom/android/server/EngineeringModeService$EMApplication;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;I)V

    iget-object v13, p0, Lcom/android/server/EngineeringModeService;->mEMCList:Lcom/android/server/EngineeringModeService$EMClientList;

    invoke-virtual {v13, v4}, Lcom/android/server/EngineeringModeService$EMClientList;->add(Lcom/android/server/EngineeringModeService$EMClient;)V

    new-instance v5, Lcom/android/server/EngineeringModeService$EMApplication;

    const-string/jumbo v13, "com.samsung.security"

    const/16 v14, 0x3e8

    invoke-direct {v5, p0, v13, v14}, Lcom/android/server/EngineeringModeService$EMApplication;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;I)V
    ...
    invoke-virtual {v5, v13}, Lcom/android/server/EngineeringModeService$EMApplication;->addMode(Ljava/lang/Integer;)V
    ...
    invoke-virtual {v13, v5}, Lcom/android/server/EngineeringModeService$EMClientList;->add(Lcom/android/server/EngineeringModeService$EMClient;)V
    ...
    invoke-direct {v12, p0, v13, v14}, Lcom/android/server/EngineeringModeService$EMSystemServer;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;I)V
    ...
    const-string/jumbo v13, "com.samsung.android.MtpApplication"

    const/16 v14, 0x3e8

    invoke-direct {v0, p0, v13, v14}, Lcom/android/server/EngineeringModeService$SystemApplication;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;I)V

    iget v13, p0, Lcom/android/server/EngineeringModeService;->mVersion:I
    ...
    invoke-virtual {v0, v13}, Lcom/android/server/EngineeringModeService$SystemApplication;->addMode(Ljava/lang/Integer;)V

    :goto_0
    iget-object v13, p0, Lcom/android/server/EngineeringModeService;->mEMCList:Lcom/android/server/EngineeringModeService$EMClientList;

    invoke-virtual {v13, v0}, Lcom/android/server/EngineeringModeService$EMClientList;->add(Lcom/android/server/EngineeringModeService$EMClient;)V

    new-instance v1, Lcom/android/server/EngineeringModeService$SystemApplication;

    const-string/jumbo v13, "com.sec.bcservice"

    const/16 v14, 0x3e8

    invoke-direct {v1, p0, v13, v14}, Lcom/android/server/EngineeringModeService$SystemApplication;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;I)V
    ...
    invoke-virtual {v1, v13}, Lcom/android/server/EngineeringModeService$SystemApplication;->addMode(Ljava/lang/Integer;)V

    iget-object v13, p0, Lcom/android/server/EngineeringModeService;->mEMCList:Lcom/android/server/EngineeringModeService$EMClientList;

    invoke-virtual {v13, v1}, Lcom/android/server/EngineeringModeService$EMClientList;->add(Lcom/android/server/EngineeringModeService$EMClient;)V

    new-instance v8, Lcom/android/server/EngineeringModeService$PlatformApplication;

    const-string/jumbo v13, "com.sec.keystringscreen"

    invoke-direct {v8, p0, v13}, Lcom/android/server/EngineeringModeService$PlatformApplication;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v13}, Lcom/android/server/EngineeringModeService$PlatformApplication;->addMode(Ljava/lang/Integer;)V

    :goto_1
    iget-object v13, p0, Lcom/android/server/EngineeringModeService;->mEMCList:Lcom/android/server/EngineeringModeService$EMClientList;

    invoke-virtual {v13, v8}, Lcom/android/server/EngineeringModeService$EMClientList;->add(Lcom/android/server/EngineeringModeService$EMClient;)V

    new-instance v7, Lcom/android/server/EngineeringModeService$SystemApplication;

    const-string/jumbo v13, "com.samsung.toolkit.ga_settingapplication"

    const/16 v14, 0x3e8

    invoke-direct {v7, p0, v13, v14}, Lcom/android/server/EngineeringModeService$SystemApplication;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;I)V
    ...
    invoke-virtual {v7, v13}, Lcom/android/server/EngineeringModeService$SystemApplication;->addMode(Ljava/lang/Integer;)V

    :goto_2
    iget-object v13, p0, Lcom/android/server/EngineeringModeService;->mEMCList:Lcom/android/server/EngineeringModeService$EMClientList;

    invoke-virtual {v13, v7}, Lcom/android/server/EngineeringModeService$EMClientList;->add(Lcom/android/server/EngineeringModeService$EMClient;)V

    new-instance v11, Lcom/android/server/EngineeringModeService$SystemApplication;

    const-string/jumbo v13, "com.sec.android.app.servicemodeapp"

    const/16 v14, 0x3e8

    invoke-direct {v11, p0, v13, v14}, Lcom/android/server/EngineeringModeService$SystemApplication;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;I)V
    ...
    invoke-virtual {v11, v13}, Lcom/android/server/EngineeringModeService$SystemApplication;->addMode(Ljava/lang/Integer;)V

    iget-object v13, p0, Lcom/android/server/EngineeringModeService;->mEMCList:Lcom/android/server/EngineeringModeService$EMClientList;

    invoke-virtual {v13, v11}, Lcom/android/server/EngineeringModeService$EMClientList;->add(Lcom/android/server/EngineeringModeService$EMClient;)V

    new-instance v6, Lcom/android/server/EngineeringModeService$SystemApplication;

    const-string/jumbo v13, "com.sdet.fotaagent"

    const/16 v14, 0x3e8

    invoke-direct {v6, p0, v13, v14}, Lcom/android/server/EngineeringModeService$SystemApplication;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;I)V
    ...
    invoke-virtual {v6, v13}, Lcom/android/server/EngineeringModeService$SystemApplication;->addMode(Ljava/lang/Integer;)V

    :goto_3
    iget-object v13, p0, Lcom/android/server/EngineeringModeService;->mEMCList:Lcom/android/server/EngineeringModeService$EMClientList;

    invoke-virtual {v13, v6}, Lcom/android/server/EngineeringModeService$EMClientList;->add(Lcom/android/server/EngineeringModeService$EMClient;)V

    new-instance v9, Lcom/android/server/EngineeringModeService$SystemApplication;

    const-string/jumbo v13, "com.samsung.knox.kss"

    const/16 v14, 0x3e8

    invoke-direct {v9, p0, v13, v14}, Lcom/android/server/EngineeringModeService$SystemApplication;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;I)V
    ...
    invoke-virtual {v9, v13}, Lcom/android/server/EngineeringModeService$SystemApplication;->addMode(Ljava/lang/Integer;)V

    :goto_4
    iget-object v13, p0, Lcom/android/server/EngineeringModeService;->mEMCList:Lcom/android/server/EngineeringModeService$EMClientList;

    invoke-virtual {v13, v9}, Lcom/android/server/EngineeringModeService$EMClientList;->add(Lcom/android/server/EngineeringModeService$EMClient;)V
    ...
    invoke-direct {v10, p0, v13}, Lcom/android/server/EngineeringModeService$PlatformApplication;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v13}, Lcom/android/server/EngineeringModeService$PlatformApplication;->addMode(Ljava/lang/Integer;)V

    :goto_5
    iget-object v13, p0, Lcom/android/server/EngineeringModeService;->mEMCList:Lcom/android/server/EngineeringModeService$EMClientList;

    invoke-virtual {v13, v10}, Lcom/android/server/EngineeringModeService$EMClientList;->add(Lcom/android/server/EngineeringModeService$EMClient;)V
    ...
    invoke-direct {v2, p0, v13}, Lcom/android/server/EngineeringModeService$PlatformApplication;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v13}, Lcom/android/server/EngineeringModeService$PlatformApplication;->addMode(Ljava/lang/Integer;)V

    :goto_6
    iget-object v13, p0, Lcom/android/server/EngineeringModeService;->mEMCList:Lcom/android/server/EngineeringModeService$EMClientList;

    invoke-virtual {v13, v2}, Lcom/android/server/EngineeringModeService$EMClientList;->add(Lcom/android/server/EngineeringModeService$EMClient;)V
...
.method public getServerTime()J
    ...
    iget-object v0, v0, Lcom/android/server/EngineeringModeService;->mLock:Ljava/lang/Object;
    ...
    const-string/jumbo v11, "EngineeringModeService"

    new-instance v17, Ljava/lang/StringBuilder;

    invoke-direct/range {v17 .. v17}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v18, "getServerTime() is called. EM"
    ...
    iget v11, v0, Lcom/android/server/EngineeringModeService;->mVersion:I
    ...
    const-string/jumbo v17, "getServerTime is only supported in EM version from 2.0"
    ...
    const-string/jumbo v17, "Network isn\'t connected, skip getting server time"
    ...
    invoke-direct {v0, v11}, Lcom/android/server/EngineeringModeService;->nativeEM20IsTokenInstalled(Ljava/lang/String;)I
    ...
    const-string/jumbo v17, "Token isn\'t installed, skip getting server time"
    ...
    iget-object v11, v0, Lcom/android/server/EngineeringModeService;->mEmServerDate:Ljava/lang/String;
    ...
    invoke-virtual {v4, v11}, Lcom/android/server/EngineeringModeService$EMSConnectionTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
    ...
    const-string/jumbo v17, "No valid response from EMS server!"
    ...
    const-string/jumbo v17, "responseBody isn\'t null"
    ...
    const-string/jumbo v17, "Failed to verify server time"
    ...
    iput-object v11, v0, Lcom/android/server/EngineeringModeService;->mEmServerDate:Ljava/lang/String;
    :try_end_7
    ...
    iput-object v10, v0, Lcom/android/server/EngineeringModeService;->mEmServerDate:Ljava/lang/String;
    ...
    const-string/jumbo v11, "yyyyMMdd"
    ...
    const-string/jumbo v18, "EM Server time ("
    ...
    const-string/jumbo v17, "Failed to parse server date"
...
.method public getStatus(ILjava/lang/String;)I
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/EngineeringModeService;->isTokenAreaEmpty()I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
