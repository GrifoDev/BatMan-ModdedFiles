...
.method private startOtherServices()V
    ...
    new-instance v208, Lcom/android/server/TelephonyRegistry;
    ...
    :try_start_c
    new-instance v175, Lcom/android/server/rmm/RmmService;

    move-object/from16 v0, v175

    invoke-direct {v0, v5}, Lcom/android/server/rmm/RmmService;-><init>(Landroid/content/Context;)V

    invoke-virtual/range {v175 .. v175}, Lcom/android/server/rmm/RmmService;->startRmm()V
    :try_end_c
    ...
    new-instance v182, Ldalvik/system/PathClassLoader;
    ...
    invoke-virtual {v6, v7}, Lcom/android/server/desktopmode/DesktopModeService;->setSystemService(Ljava/lang/Object;)V
    ...
    invoke-virtual {v6, v0}, Lcom/android/server/desktopmode/DesktopModeService;->setSystemService(Ljava/lang/Object;)V
    ...
    check-cast v165, Lcom/android/server/am/IMultiWindowManagerServiceBridge;
    ...
    invoke-virtual/range {v223 .. v223}, Lcom/android/server/wm/WindowManagerService;->getInputMonitor()Lcom/android/server/wm/InputMonitor;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_31
    .catch Ljava/lang/Throwable; {:try_start_31 .. :try_end_31} :catch_9e
    .catch Ljava/lang/RuntimeException; {:try_start_31 .. :try_end_31} :catch_9d
    ...
    :cond_8
    :try_start_34
    invoke-virtual/range {v223 .. v223}, Lcom/android/server/wm/WindowManagerService;->displayReady()V
    :try_end_34
    ...
    new-instance v177, Lcom/samsung/accessory/manager/SAccessoryManager;
    ...
    :try_end_36
    .catch Ljava/lang/Throwable; {:try_start_36 .. :try_end_36} :catch_97
    ...
    new-instance v152, Lcom/samsung/android/mateservice/MateService;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_3a
    .catch Ljava/lang/Throwable; {:try_start_3a .. :try_end_3a} :catch_95
    ...
    new-instance v159, Ldalvik/system/PathClassLoader;
    ...
    invoke-static {v6, v7}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_3c
    .catch Ljava/lang/Exception; {:try_start_3c .. :try_end_3c} :catch_27
    ...
    new-instance v186, Lcom/android/server/SdpManagerService;
    ...
    new-instance v184, Lcom/android/server/SdpLogService;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_44
    .catch Ljava/lang/Throwable; {:try_start_44 .. :try_end_44} :catch_92
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_46
    .catch Ljava/lang/Throwable; {:try_start_46 .. :try_end_46} :catch_91
    ...
    new-instance v147, Lcom/android/server/enterprise/otp/OTPService;
    ...
    :goto_33
    :try_start_53
    new-instance v201, Lcom/android/server/enterprise/spd/SPDControlPolicy;
    ...
    :try_start_57
    new-instance v204, Lcom/android/server/statusbar/StatusBarManagerService;
    ...
    new-instance v145, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;

    move-object/from16 v0, v145

    invoke-direct {v0, v5}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;-><init>(Landroid/content/Context;)V
    :try_end_5e
    ...
    :try_start_60
    new-instance v168, Lcom/android/server/NetworkScoreService;
    ...
    new-instance v219, Ldalvik/system/PathClassLoader;
    ...
    const-string/jumbo v7, "com.samsung.feature.mmfw_monitor"
    ...
    :try_start_85
    new-instance v156, Lcom/android/server/media/MediaRouterService;
    ...
    :cond_4a
    invoke-virtual/range {v223 .. v223}, Lcom/android/server/wm/WindowManagerService;->detectSafeMode()Z
    ...
    invoke-virtual/range {v222 .. v222}, Ljava/lang/Object;->getClass()Ljava/lang/Class;
    ...
    :goto_6d
    :try_start_93
    invoke-virtual/range {v223 .. v223}, Lcom/android/server/wm/WindowManagerService;->systemReady()V
    :try_end_93
    ...
    :cond_50
    invoke-virtual/range {v223 .. v223}, Lcom/android/server/wm/WindowManagerService;->computeNewConfiguration()Landroid/content/res/Configuration;

    move-result-object v56

    new-instance v157, Landroid/util/DisplayMetrics;

    invoke-direct/range {v157 .. v157}, Landroid/util/DisplayMetrics;-><init>()V
    ...
    invoke-virtual/range {v206 .. v206}, Landroid/content/res/Resources$Theme;->getChangingConfigurations()I

    move-result v6

    if-eqz v6, :cond_51

    invoke-virtual/range {v206 .. v206}, Landroid/content/res/Resources$Theme;->rebase()V
    ...
    :goto_73
    :try_start_98
    invoke-virtual/range {v185 .. v185}, Lcom/android/server/SdpManagerService;->systemReady()V
    :try_end_98
    .catch Ljava/lang/Throwable; {:try_start_98 .. :try_end_98} :catch_6e

    :goto_74
    :try_start_99
    invoke-virtual/range {v183 .. v183}, Lcom/android/server/SdpLogService;->systemReady()V
    :try_end_99
    ...
    :try_start_9f
    new-instance v191, Lcom/android/server/enterprise/container/SmartCardAccessPolicy;
    ...
    new-instance v193, Lcom/android/server/enterprise/smartcard/SmartCardBrowserPolicy;
    ...
    new-instance v195, Lcom/android/server/enterprise/smartcard/SmartCardEmailPolicy;
    ...
    new-instance v197, Lcom/android/server/enterprise/smartcard/SmartCardLockscreenPolicy;
    ...
    new-instance v199, Lcom/android/server/enterprise/smartcard/SmartCardVpnPolicy;
    ...
    move-object/from16 v26, v155

    move-object/from16 v158, v27

    move-object/from16 v29, v151

    move-object/from16 v30, v176
    ...
    invoke-static {v6, v7, v0}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_a7
    .catch Ljava/lang/RuntimeException; {:try_start_a7 .. :try_end_a7} :catch_9b
    ...
    invoke-virtual/range {v93 .. v93}, Ljava/lang/Exception;->printStackTrace()V
    :try_end_aa
    .catch Ljava/lang/Exception; {:try_start_aa .. :try_end_aa} :catch_15
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_ac
    .catch Ljava/lang/Throwable; {:try_start_ac .. :try_end_ac} :catch_22
    ...
    :try_end_ad
    .catch Ljava/lang/Throwable; {:try_start_ad .. :try_end_ad} :catch_23
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_ae
    .catch Ljava/lang/Throwable; {:try_start_ae .. :try_end_ae} :catch_96
    ...
    :try_end_af
    .catch Ljava/lang/Throwable; {:try_start_af .. :try_end_af} :catch_25
    ...
    invoke-static {v6, v7}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_b0
    .catch Ljava/lang/Throwable; {:try_start_b0 .. :try_end_b0} :catch_39
    ...
    :try_start_b1
    invoke-interface/range {v160 .. v160}, Landroid/os/storage/IMountService;->waitForAsecScan()V
    :try_end_b1
    .catch Landroid/os/RemoteException; {:try_start_b1 .. :try_end_b1} :catch_46
    ...
    invoke-static {v6, v7}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_b2
    .catch Ljava/lang/Throwable; {:try_start_b2 .. :try_end_b2} :catch_4a
    ...
    invoke-virtual {v6, v7}, Lcom/android/server/SystemServiceManager;->startService(Ljava/lang/String;)Lcom/android/server/SystemService;
    :try_end_b4
    .catch Ljava/lang/Throwable; {:try_start_b4 .. :try_end_b4} :catch_4c
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_b6
    .catch Ljava/lang/Throwable; {:try_start_b6 .. :try_end_b6} :catch_53
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_b7
    .catch Ljava/lang/Throwable; {:try_start_b7 .. :try_end_b7} :catch_54
    ...
    :try_start_b8
    new-instance v170, Lcom/android/server/NetworkTimeUpdateService;

    move-object/from16 v0, v170

    invoke-direct {v0, v5}, Lcom/android/server/NetworkTimeUpdateService;-><init>(Landroid/content/Context;)V
    :try_end_b8
    .catch Ljava/lang/Throwable; {:try_start_b8 .. :try_end_b8} :catch_58
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_b9
    .catch Ljava/lang/Throwable; {:try_start_b9 .. :try_end_b9} :catch_7d
    ...
    invoke-static {v6, v7}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_ba
    .catch Ljava/lang/Throwable; {:try_start_ba .. :try_end_ba} :catch_61
