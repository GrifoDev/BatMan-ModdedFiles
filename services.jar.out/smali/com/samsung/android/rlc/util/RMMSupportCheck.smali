...
.method public static setChangedTime(Landroid/content/Context;)V
    ...
    sget-object v6, Lcom/samsung/android/rlc/util/RMMSupportCheck;->TAG:Ljava/lang/String;

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "Init boot time was changed : "
    ...
    invoke-static {v6, v4}, Lcom/samsung/android/rlc/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v4, v2}, Lcom/samsung/android/rlc/util/PreferencesUtil;->setString(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v0}, Lcom/samsung/android/rlc/util/RLCUtil;->setStringInSecure(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "There is no boot Time : "
    ...
    invoke-static {p0, v1, v4}, Lcom/samsung/android/rlc/util/PreferencesUtil;->setString(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
...
.method public static setCheckAlarm(Landroid/content/Context;)V
    ...
    const-string/jumbo v1, "Set SecondCheck Alarm"
    ...
    const-string/jumbo v2, "retryInterval2"

    invoke-static {p0, v2}, Lcom/samsung/android/rlc/util/PreferencesUtil;->getString(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "Invalid interval, so skip retry checking"
    ...
    const-string/jumbo v2, "Rmm Service already activated : "
    ...
    invoke-virtual {v1, v3}, Lcom/samsung/android/rlc/util/RLCUtil;->getStringInSecure(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v12, "3rd"

    invoke-virtual {v1, v12}, Lcom/samsung/android/rlc/util/RLCUtil;->getStringInSecure(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v14, "CheckTime: "
    ...
    const-string/jumbo v14, ", Check Flag : "
    ...
    invoke-static {v1, v13}, Lcom/samsung/android/rlc/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v10, "There is no boot Time : "
    ...
    invoke-virtual {v2, v3, v1}, Lcom/samsung/android/rlc/util/RLCUtil;->setStringInSecure(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "Second Check Flag : "
    ...
    const-string/jumbo v5, "set seven day check alarm : "
    ...
    invoke-static {v1, v4}, Lcom/samsung/android/rlc/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v1, Landroid/content/Intent;

    const-string/jumbo v4, "com.samsung.android.rlc.THIRD_CHECK_DEVICE"
    ...
    const-string/jumbo v1, "Start third check "
