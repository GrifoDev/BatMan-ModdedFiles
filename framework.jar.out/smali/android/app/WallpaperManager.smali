...
.method private getDefaultWallpaperInformation(I)Landroid/os/Bundle;
    ...
    :cond_0
    :goto_0
    sget-boolean v7, Landroid/app/WallpaperManager;->SUPPORT_INFINITY_WALLPAPER:Z
...
.method private getDefaultWallpaperURI(I)Ljava/lang/String;
    ...
    sget-boolean v6, Landroid/app/WallpaperManager;->SUPPORT_INFINITY_WALLPAPER:Z
    ...
    invoke-static {v6}, Landroid/app/WallpaperManager$Globals;->-get0(Landroid/app/WallpaperManager$Globals;)Z
...
.method private getPreloadWallpaperURI(ILjava/lang/String;)Ljava/lang/String;
    ...
    sget-boolean v5, Landroid/app/WallpaperManager;->SUPPORT_INFINITY_WALLPAPER:Z
...
.method private openDefaultInfinityWallpaper(Landroid/content/Context;)Ljava/io/InputStream;
    ...
    invoke-static {v9}, Landroid/app/WallpaperManager$Globals;->-get1(Landroid/app/WallpaperManager$Globals;)Landroid/app/IWallpaperManager;
    ...
    invoke-direct {p0, v9}, Landroid/app/WallpaperManager;->parseInfinityColorInfo(Ljava/lang/String;)Ljava/lang/String;
...
.method public static openDefaultWallpaper(Landroid/content/Context;I)Ljava/io/InputStream;
    ...
    invoke-static {v10}, Landroid/app/WallpaperManager$Globals;->-get1(Landroid/app/WallpaperManager$Globals;)Landroid/app/IWallpaperManager;
...
.method private setBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;ZII)I
    ...
    invoke-direct {v0, v1}, Landroid/app/WallpaperManager;->parseInfinityColorInfo(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v11}, Landroid/app/WallpaperManager;->setOppositeSideOfWallpaper(ILjava/lang/String;)V
...
.method private setOppositeSideOfWallpaper(ILjava/lang/String;)V
    ...
    const-string/jumbo v2, "User id is between max and min presona id."
    ...
    invoke-interface {v1, v2}, Landroid/app/IWallpaperManager;->setKWPTypeLiveWallpaper(I)V
    ...
    const-string/jumbo v2, "setOppositeSideOfWallpaper set lock wallpaper to still image"
    ...
    :try_start_5
    invoke-virtual/range {v16 .. v17}, Landroid/content/res/Resources;->openRawResource(I)Ljava/io/InputStream;

    move-result-object v1

    move-object/from16 v0, p0

    invoke-direct {v0, v1, v15}, Landroid/app/WallpaperManager;->copyStreamToWallpaperFile(Ljava/io/InputStream;Ljava/io/FileOutputStream;)V
    ...
    const-string/jumbo v2, "setOppositeSideOfWallpaper set home wallpaper to still image"
...
.method private setResource(III)I
    ...
    invoke-direct {v0, v2, v15}, Landroid/app/WallpaperManager;->copyStreamToWallpaperFile(Ljava/io/InputStream;Ljava/io/FileOutputStream;)V
...
.method private setStream(Ljava/io/InputStream;Landroid/graphics/Rect;ZII)I
    ...
    invoke-interface/range {v4 .. v12}, Landroid/app/IWallpaperManager;->setWallpaper(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Rect;ZLandroid/os/Bundle;ILandroid/app/IWallpaperManagerCallback;I)Landroid/os/ParcelFileDescriptor;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v0, v1, v13}, Landroid/app/WallpaperManager;->setOppositeSideOfWallpaper(ILjava/lang/String;)V
...
.method public clear(I)V
    ...
    sget-boolean v1, Landroid/app/WallpaperManager;->SUPPORT_INFINITY_WALLPAPER:Z
...
.method public setAnimatedLockscreenWallpaper(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, Landroid/app/WallpaperManager;->parseInfinityColorInfo(Ljava/lang/String;)Ljava/lang/String;
