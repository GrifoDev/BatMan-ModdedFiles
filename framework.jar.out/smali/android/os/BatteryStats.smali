...
.method public final dumpLocked(Landroid/content/Context;Ljava/io/PrintWriter;Ljava/lang/String;IIZ)V
    ...
    invoke-virtual/range {v206 .. v206}, Landroid/util/SparseArray;->size()I
    ...
    new-instance v181, Ljava/util/ArrayList;

    invoke-direct/range {v181 .. v181}, Ljava/util/ArrayList;-><init>()V
    ...
    check-cast v200, Landroid/os/BatteryStats$Uid;

    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getWakelockStats()Landroid/util/ArrayMap;

    move-result-object v214

    invoke-virtual/range {v214 .. v214}, Landroid/util/ArrayMap;->size()I
    ...
    check-cast v237, Landroid/os/BatteryStats$Uid$Wakelock;
    ...
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getUid()I
    ...
    :cond_3c
    new-instance v180, Landroid/os/BatteryStats$1;
    ...
    check-cast v173, Landroid/os/BatteryStats$TimerEntry;
    ...
    :cond_41
    invoke-virtual/range {v181 .. v181}, Ljava/util/ArrayList;->size()I
    ...
    :cond_42
    invoke-virtual/range {v181 .. v181}, Ljava/util/ArrayList;->clear()V
    ...
    invoke-interface/range {v215 .. v215}, Ljava/util/Map;->size()I
    ...
    invoke-interface/range {v215 .. v215}, Ljava/util/Map;->entrySet()Ljava/util/Set;
    ...
    :goto_17
    invoke-virtual/range {v160 .. v160}, Ljava/util/ArrayList;->size()I
    ...
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getModemControllerActivity()Landroid/os/BatteryStats$ControllerActivityCounter;
    ...
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getWifiControllerActivity()Landroid/os/BatteryStats$ControllerActivityCounter;
    ...
    :cond_53
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getBluetoothScanTimer()Landroid/os/BatteryStats$Timer;
    ...
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->hasUserActivity()Z
    ...
    :cond_64
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getSyncStats()Landroid/util/ArrayMap;
    ...
    :cond_67
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getJobStats()Landroid/util/ArrayMap;
    ...
    :cond_69
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getFlashlightTurnedOnTimer()Landroid/os/BatteryStats$Timer;
    ...
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getCameraTurnedOnTimer()Landroid/os/BatteryStats$Timer;
    ...
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getVideoTurnedOnTimer()Landroid/os/BatteryStats$Timer;
    ...
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getAudioTurnedOnTimer()Landroid/os/BatteryStats$Timer;
    ...
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getSensorStats()Landroid/util/SparseArray;

    move-result-object v165

    invoke-virtual/range {v165 .. v165}, Landroid/util/SparseArray;->size()I
    ...
    check-cast v161, Landroid/os/BatteryStats$Uid$Sensor;
    ...
    invoke-virtual/range {v161 .. v161}, Landroid/os/BatteryStats$Uid$Sensor;->getHandle()I
    ...
    invoke-virtual/range {v161 .. v161}, Landroid/os/BatteryStats$Uid$Sensor;->getSensorTime()Landroid/os/BatteryStats$Timer;
    ...
    :cond_6d
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getVibratorOnTimer()Landroid/os/BatteryStats$Timer;
    ...
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getForegroundActivityTimer()Landroid/os/BatteryStats$Timer;
    ...
    :cond_76
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getProcessStats()Landroid/util/ArrayMap;
    ...
    check-cast v157, Landroid/os/BatteryStats$Uid$Proc;
    ...
    invoke-virtual/range {v157 .. v157}, Landroid/os/BatteryStats$Uid$Proc;->countExcessivePowers()I
    ...
    :cond_85
    invoke-virtual/range {v200 .. v200}, Landroid/os/BatteryStats$Uid;->getPackageStats()Landroid/util/ArrayMap;

    move-result-object v144

    invoke-virtual/range {v144 .. v144}, Landroid/util/ArrayMap;->size()I
    ...
    check-cast v156, Landroid/os/BatteryStats$Uid$Pkg;

    invoke-virtual/range {v156 .. v156}, Landroid/os/BatteryStats$Uid$Pkg;->getWakeupAlarmStats()Landroid/util/ArrayMap;
    ...
    :cond_86
    invoke-virtual/range {v156 .. v156}, Landroid/os/BatteryStats$Uid$Pkg;->getServiceStats()Landroid/util/ArrayMap;

    move-result-object v166

    invoke-virtual/range {v166 .. v166}, Landroid/util/ArrayMap;->size()I
