...
.method public static getCallbackName(I)Ljava/lang/String;
    ...
    :pswitch_7
    const-string/jumbo v0, "CALLBACK_RELEASED"

    return-object v0

    :pswitch_8
    const-string/jumbo v0, "CALLBACK_EXIT"
...
.method private inferLegacyTypeForNetworkCapabilities(Landroid/net/NetworkCapabilities;)I
    ...
    invoke-interface {v4}, Landroid/net/IConnectivityManager;->getMptcpState()Z
    :try_end_0
    ...
    invoke-direct {p0, v6, v3}, Landroid/net/ConnectivityManager;->networkCapabilitiesForFeature(ILjava/lang/String;)Landroid/net/NetworkCapabilities;
...
.method private insertBigdataForHotSpotEnabled(ZI)V
    ...
    invoke-direct {p0}, Landroid/net/ConnectivityManager;->getWifiManager()Landroid/net/wifi/WifiManager;

    move-result-object v8

    iput-object v8, p0, Landroid/net/ConnectivityManager;->mWifiManager:Landroid/net/wifi/WifiManager;

    const/4 v8, -0x1

    if-eq p2, v8, :cond_1

    iget-object v8, p0, Landroid/net/ConnectivityManager;->mContext:Landroid/content/Context;
    ...
    const-string/jumbo v8, "ConnectivityManager"
    ...
    iget-object v8, p0, Landroid/net/ConnectivityManager;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    const-string/jumbo v9, "mWifiManager.callSECApi(msg) failed!"
...
.method private insertGsimForHotSpotEnabled(Z)V
    ...
    iput-object v2, p0, Landroid/net/ConnectivityManager;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    iget-object v2, p0, Landroid/net/ConnectivityManager;->mWifiManager:Landroid/net/wifi/WifiManager;
...
.method private sendRequestForNetwork(Landroid/net/NetworkCapabilities;Landroid/net/ConnectivityManager$NetworkCallback;IIILandroid/net/ConnectivityManager$CallbackHandler;)Landroid/net/NetworkRequest;
    ...
    const-string/jumbo v4, "requestNetwork; CallingUid : "
    ...
    invoke-interface {v1}, Landroid/net/IConnectivityManager;->getMptcpState()Z
    ...
    const-string/jumbo v4, "Sending Hipri Request broadcast "
    ...
    const-string/jumbo v9, "com.android.hipriRequest"
    ...
    :cond_2
    sget-object v12, Landroid/net/ConnectivityManager;->sCallbacks:Ljava/util/HashMap;
    ...
    invoke-virtual {v1, v10, p2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_3
    invoke-static {p2, v10}, Landroid/net/ConnectivityManager$NetworkCallback;->-set0(Landroid/net/ConnectivityManager$NetworkCallback;Landroid/net/NetworkRequest;)Landroid/net/NetworkRequest;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public requestNetwork(Landroid/net/NetworkRequest;Landroid/net/ConnectivityManager$NetworkCallback;I)V
    ...
    const-string/jumbo v2, "Non-positive timeoutMs: "
...
.method public requestNetwork(Landroid/net/NetworkRequest;Landroid/net/ConnectivityManager$NetworkCallback;Landroid/os/Handler;I)V
    ...
    const-string/jumbo v1, "Non-positive timeoutMs"
...
.method public startTethering(IZLandroid/net/ConnectivityManager$OnStartTetheringCallback;Landroid/os/Handler;)V
    ...
    const-string/jumbo v11, "OnStartTetheringCallback cannot be null."
    ...
    new-instance v10, Landroid/net/ConnectivityManager$2;
    ...
    invoke-direct {v10, v0, v1, v2}, Landroid/net/ConnectivityManager$2;-><init>(Landroid/net/ConnectivityManager;Landroid/os/Handler;Landroid/net/ConnectivityManager$OnStartTetheringCallback;)V

    if-nez p1, :cond_1

    move-object/from16 v0, p0

    iget-object v11, v0, Landroid/net/ConnectivityManager;->mContext:Landroid/content/Context;

    invoke-virtual {v11}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v9

    const-string/jumbo v11, "ConnectivityManager"

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v13, "startTethering packageName : "
    ...
    invoke-direct {v0, v12, v11}, Landroid/net/ConnectivityManager;->insertBigdataForHotSpotEnabled(ZI)V

    const/4 v11, 0x1

    move-object/from16 v0, p0

    invoke-direct {v0, v11}, Landroid/net/ConnectivityManager;->insertGsimForHotSpotEnabled(Z)V

    sget-boolean v11, Landroid/net/ConnectivityManager;->DBG:Z
    ...
    const-string/jumbo v15, "startTethering"
    ...
    invoke-direct/range {p0 .. p0}, Landroid/net/ConnectivityManager;->getWifiManager()Landroid/net/wifi/WifiManager;

    move-result-object v11

    invoke-virtual {v11, v8}, Landroid/net/wifi/WifiManager;->callSECApi(Landroid/os/Message;)I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v11, v0, Landroid/net/ConnectivityManager;->mService:Landroid/net/IConnectivityManager;

    move/from16 v0, p1

    move/from16 v1, p2

    invoke-interface {v11, v0, v10, v1}, Landroid/net/IConnectivityManager;->startTethering(ILandroid/os/ResultReceiver;Z)V
    :try_end_1
    ...
    const-string/jumbo v12, "Exception trying to log in tethering."
    ...
    const-string/jumbo v12, "Exception trying to start tethering."
    ...
    invoke-virtual {v10, v11, v12}, Landroid/os/ResultReceiver;->send(ILandroid/os/Bundle;)V
...
.method public stopTethering(I)V
    ...
    iget-object v6, p0, Landroid/net/ConnectivityManager;->mContext:Landroid/content/Context;

    invoke-virtual {v6}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v5

    const-string/jumbo v6, "ConnectivityManager"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "stopTethering packageName : "
    ...
    invoke-direct {p0, v9, v6}, Landroid/net/ConnectivityManager;->insertBigdataForHotSpotEnabled(ZI)V

    invoke-direct {p0, v9}, Landroid/net/ConnectivityManager;->insertGsimForHotSpotEnabled(Z)V

    sget-boolean v6, Landroid/net/ConnectivityManager;->DBG:Z
    ...
    const-string/jumbo v10, "stopTethering"
    ...
    invoke-interface {v6, p1}, Landroid/net/IConnectivityManager;->stopTethering(I)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    const-string/jumbo v7, "Exception trying to log in tethering."
