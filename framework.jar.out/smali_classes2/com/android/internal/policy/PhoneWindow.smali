...
.method protected dispatchWindowAttributesChanged(Landroid/view/WindowManager$LayoutParams;)V
    ...
    iget-object v2, v2, Lcom/android/internal/policy/DecorView;->mMultiWindowDecorSupportBridge:Lcom/samsung/android/internal/policy/MultiWindowDecorSupportBridge;

    invoke-virtual {v2}, Lcom/samsung/android/internal/policy/MultiWindowDecorSupportBridge;->isFullWindow()Z
    ...
    invoke-virtual {v2}, Lcom/samsung/android/internal/policy/MultiWindowDecorSupportBridge;->isFullScreenFreeform()Z
    ...
    invoke-virtual {v2, v3}, Lcom/samsung/android/internal/policy/MultiWindowDecorSupportBridge;->isImmersiveMode(I)Z
...
.method protected generateLayout(Lcom/android/internal/policy/DecorView;)Landroid/view/ViewGroup;
    ...
    :cond_15
    sget-boolean v33, Lcom/samsung/android/framework/feature/NavigationBarFeatures;->SUPPORT_LIGHT_NAVIGATION_BAR:Z

    if-eqz v33, :cond_16

    sget-boolean v33, Lcom/android/internal/policy/PhoneWindow;->IS_FACTORY_MODE:Z
    ...
    const-string/jumbo v34, "current_sec_theme_package_festival"
    ...
    sget-boolean v33, Lcom/samsung/android/framework/feature/NavigationBarFeatures;->SUPPORT_CUSTOM_BG_COLOR:Z
    ...
    const-string/jumbo v34, "navigationbar_current_color"
    ...
    const-string/jumbo v34, "navigationbar_theme_color"
    ...
    const-string/jumbo v34, "navigationbar_use_theme_default"
    ...
    iget-boolean v0, v0, Lcom/android/internal/policy/PhoneWindow;->mIsParentThemeDeviceDefaultLight:Z
    ...
    invoke-virtual/range {v33 .. v34}, Lcom/android/internal/policy/DecorView;->setLastBackgroundResource(I)V
    ...
    invoke-virtual/range {v33 .. v33}, Lcom/android/internal/policy/DecorView;->startChanging()V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/internal/policy/DecorView;->onResourcesLoaded(Landroid/view/LayoutInflater;I)V
    ...
    const-string/jumbo v34, "Window couldn\'t find content container view"
    ...
    invoke-virtual/range {v33 .. v33}, Landroid/content/res/Resources;->getAssets()Landroid/content/res/AssetManager;

    move-result-object v33

    invoke-virtual/range {v33 .. v33}, Landroid/content/res/AssetManager;->getOverlays()Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v33 .. v34}, Landroid/content/Context;->getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v12}, Lcom/android/internal/policy/DecorView;->setWindowFrame(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual/range {v33 .. v34}, Lcom/android/internal/policy/DecorView;->setElevation(F)V
    ...
    invoke-virtual/range {v33 .. v34}, Lcom/android/internal/policy/DecorView;->setClipToOutline(Z)V
    ...
    invoke-virtual/range {v33 .. v33}, Lcom/android/internal/policy/DecorView;->finishChanging()V
...
.method public setNavigationBarInternalColor(I)V
    ...
    :cond_0
    iget-boolean v2, p0, Lcom/android/internal/policy/PhoneWindow;->mIsParentThemeDeviceDefaultLight:Z
