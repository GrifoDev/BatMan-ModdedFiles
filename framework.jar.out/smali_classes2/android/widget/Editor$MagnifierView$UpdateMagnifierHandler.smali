...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v2}, Landroid/widget/Editor$MagnifierView;->-get12(Landroid/widget/Editor$MagnifierView;)F
    ...
    invoke-static {v3}, Landroid/widget/Editor$MagnifierView;->-get16(Landroid/widget/Editor$MagnifierView;)[F
    ...
    invoke-static {v3}, Landroid/widget/Editor$MagnifierView;->-get15(Landroid/widget/Editor$MagnifierView;)Landroid/graphics/PointF;
    ...
    invoke-static {v3}, Landroid/widget/Editor$MagnifierView;->-get6(Landroid/widget/Editor$MagnifierView;)F
    ...
    invoke-static {v3}, Landroid/widget/Editor$MagnifierView;->-get5(Landroid/widget/Editor$MagnifierView;)[I
    ...
    invoke-static {v2}, Landroid/widget/Editor$MagnifierView;->-get13(Landroid/widget/Editor$MagnifierView;)F
    ...
    invoke-static {v3}, Landroid/widget/Editor$MagnifierView;->-get18(Landroid/widget/Editor$MagnifierView;)I
    ...
    invoke-static {v3}, Landroid/widget/Editor$MagnifierView;->-get8(Landroid/widget/Editor$MagnifierView;)I
    ...
    invoke-static {v2}, Landroid/widget/Editor$MagnifierView;->-get16(Landroid/widget/Editor$MagnifierView;)[F
    ...
    invoke-static {v3}, Landroid/widget/Editor$MagnifierView;->-get14(Landroid/widget/Editor$MagnifierView;)[F
    ...
    invoke-static {v2}, Landroid/widget/Editor$MagnifierView;->-get18(Landroid/widget/Editor$MagnifierView;)I
    ...
    invoke-static {v1}, Landroid/widget/Editor$MagnifierView;->-get7(Landroid/widget/Editor$MagnifierView;)Landroid/content/Context;

    move-result-object v1

    iget-object v2, p0, Landroid/widget/Editor$MagnifierView$UpdateMagnifierHandler;->this$1:Landroid/widget/Editor$MagnifierView;

    invoke-static {v2}, Landroid/widget/Editor$MagnifierView;->-get19(Landroid/widget/Editor$MagnifierView;)Landroid/view/View;
