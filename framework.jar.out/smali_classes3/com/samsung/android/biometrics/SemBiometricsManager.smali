...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/samsung/android/biometrics/SemBiometricsManager;
    ...
    const-class v1, Lcom/samsung/android/biometrics/SemBiometricsManager;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/samsung/android/biometrics/SemBiometricsManager;->mSemIBManager:Lcom/samsung/android/biometrics/SemBiometricsManager;

    if-nez v0, :cond_0

    new-instance v0, Lcom/samsung/android/biometrics/SemBiometricsManager;

    invoke-direct {v0, p0}, Lcom/samsung/android/biometrics/SemBiometricsManager;-><init>(Landroid/content/Context;)V
