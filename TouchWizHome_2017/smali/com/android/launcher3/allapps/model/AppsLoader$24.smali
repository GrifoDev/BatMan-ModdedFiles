...
.method constructor <init>(Lcom/android/launcher3/allapps/model/AppsLoader;Ljava/util/ArrayList;Z)V
    ...
    iput-object p2, p0, Lcom/android/launcher3/allapps/model/AppsLoader$24;->val$items:Ljava/util/ArrayList;

    iput-boolean p3, p0, Lcom/android/launcher3/allapps/model/AppsLoader$24;->val$isGameApp:Z
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/android/launcher3/allapps/model/AppsLoader$24;->val$items:Ljava/util/ArrayList;
    ...
    iget-boolean v10, p0, Lcom/android/launcher3/allapps/model/AppsLoader$24;->val$isGameApp:Z
    ...
    invoke-static {}, Lcom/android/launcher3/allapps/model/AppsLoader;->access$2600()Ljava/lang/Object;
    ...
    invoke-static {}, Lcom/android/launcher3/allapps/model/AppsLoader;->access$2700()Lcom/android/launcher3/util/LongArrayMap;
    ...
    invoke-static {v1}, Lcom/android/launcher3/allapps/model/AppsLoader;->access$2900(Lcom/android/launcher3/allapps/model/AppsLoader;)Lcom/android/launcher3/common/model/FavoritesUpdater;

    move-result-object v1

    # getter for: Lcom/android/launcher3/allapps/model/AppsLoader;->sContext:Landroid/content/Context;
    invoke-static {}, Lcom/android/launcher3/allapps/model/AppsLoader;->access$2800()Landroid/content/Context;

    move-result-object v10

    iget-object v11, p0, Lcom/android/launcher3/allapps/model/AppsLoader$24;->val$items:Ljava/util/ArrayList;
    ...
    :cond_3
    new-instance v0, Lcom/android/launcher3/allapps/model/AppsLoader$24$1;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lcom/android/launcher3/allapps/model/AppsLoader$24$1;-><init>(Lcom/android/launcher3/allapps/model/AppsLoader$24;Lcom/android/launcher3/allapps/model/AppsLoader$AppsCallbacks;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    iget-object v1, p0, Lcom/android/launcher3/allapps/model/AppsLoader$24;->this$0:Lcom/android/launcher3/allapps/model/AppsLoader;

    # invokes: Lcom/android/launcher3/allapps/model/AppsLoader;->runOrAddDifferRunnable(Ljava/lang/Runnable;)V
    invoke-static {v1, v0}, Lcom/android/launcher3/allapps/model/AppsLoader;->access$2400(Lcom/android/launcher3/allapps/model/AppsLoader;Ljava/lang/Runnable;)V
