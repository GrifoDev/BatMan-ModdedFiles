...
.method public putNotification(Landroid/service/notification/StatusBarNotification;ZZ)Landroid/os/Bundle;
    ...
    iget-object v11, v13, Landroid/app/Notification;->tickerText:Ljava/lang/CharSequence;
    ...
    const-string/jumbo v13, "android.title"

    invoke-virtual {v3, v13}, Landroid/os/Bundle;->getCharSequence(Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    const-string/jumbo v13, "android.subText"
    ...
    :cond_1
    sget-boolean v13, Lcom/android/server/cocktailbar/edgelighting/EdgeLightingPolicyManager;->DEBUG:Z

    if-eqz v13, :cond_4

    sget-object v13, Lcom/android/server/cocktailbar/edgelighting/EdgeLightingPolicyManager;->TAG:Ljava/lang/String;

    new-instance v14, Ljava/lang/StringBuilder;

    invoke-direct {v14}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v15, "putNotification tickerText:"
    ...
    iget v4, v13, Landroid/app/Notification;->ledARGB:I
    ...
    const-string/jumbo v13, "isHeadup"

    move/from16 v0, p2

    invoke-virtual {v2, v13, v0}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string/jumbo v13, "isUpdate"
    ...
    invoke-virtual {v2, v13, v11}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string/jumbo v13, "titleText"

    invoke-virtual {v2, v13, v12}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string/jumbo v13, "text"

    invoke-virtual {v2, v13, v10}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string/jumbo v13, "subText"

    invoke-virtual {v2, v13, v9}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string/jumbo v13, "smallIcon"

    invoke-virtual {v2, v13, v8}, Landroid/os/Bundle;->putParcelable(Ljava/lang/String;Landroid/os/Parcelable;)V
    ...
    const-string/jumbo v13, "notification_color"
    ...
    iget-object v13, v0, Lcom/android/server/cocktailbar/edgelighting/EdgeLightingPolicyManager;->mResumedComponent:Landroid/content/ComponentName;
    ...
    new-instance v16, Lcom/android/server/cocktailbar/edgelighting/EdgeLightingPolicyManager$NotificationData;

    move-object/from16 v0, v16

    invoke-direct {v0, v6, v7, v2}, Lcom/android/server/cocktailbar/edgelighting/EdgeLightingPolicyManager$NotificationData;-><init>(JLandroid/os/Bundle;)V
    ...
    :cond_4
    sget-object v14, Lcom/android/server/cocktailbar/edgelighting/EdgeLightingPolicyManager;->TAG:Ljava/lang/String;
