...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :pswitch_0
    sget-boolean v16, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SAMSUNG_MULTIWINDOW_DYNAMIC_ENABLED:Z
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/server/am/MultiWindowManagerService;->-get2(Lcom/android/server/am/MultiWindowManagerService;)Landroid/os/RemoteCallbackList;
    ...
    check-cast v25, Lcom/android/internal/os/SomeArgs;
    ...
    :try_start_1
    invoke-interface/range {v3 .. v8}, Lcom/samsung/android/multiwindow/IMultiWindowCallback;->onStateChanged(Landroid/graphics/Rect;ILandroid/content/ComponentName;II)V
    :try_end_1
    ...
    :try_start_2
    const-string/jumbo v16, "MultiWindowManagerService"

    const-string/jumbo v21, "onStateChanged, RemoteException occured"
    ...
    invoke-interface {v3, v5, v0, v1}, Lcom/samsung/android/multiwindow/IMultiWindowCallback;->onAnimationEnd(IILandroid/graphics/Rect;)V
    :try_end_5
    ...
    const-string/jumbo v21, "onAnimationEnd, RemoteException occured"
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/server/am/MultiWindowManagerService;->-get7(Lcom/android/server/am/MultiWindowManagerService;)Landroid/os/RemoteCallbackList;
    ...
    check-cast v9, Lcom/samsung/android/multiwindow/IMultiWindowEventListener;
    :try_end_8
    ...
    invoke-interface {v9, v0}, Lcom/samsung/android/multiwindow/IMultiWindowEventListener;->onMultiWindowSettingChanged(Z)V
    :try_end_9
    ...
    const-string/jumbo v21, "Error delivering MultiWindowSetting changed event."
    ...
    iget-object v15, v0, Lcom/android/internal/os/SomeArgs;->arg4:Ljava/lang/Object;
    ...
    :try_start_d
    invoke-interface/range {v9 .. v15}, Lcom/samsung/android/multiwindow/IMultiWindowEventListener;->onMultiWindowFocusChanged(Landroid/graphics/Rect;Landroid/graphics/Rect;IILjava/lang/String;Landroid/os/Bundle;)V
    :try_end_d
    ...
    const-string/jumbo v21, "Error delivering MultiWindow focus change event."
    ...
    :try_start_11
    invoke-interface {v9}, Lcom/samsung/android/multiwindow/IMultiWindowEventListener;->onMultiWindowAppTransitionFinished()V
    :try_end_11
    ...
    const-string/jumbo v21, "Error delivering MultiWindow App Transition Finished event."
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/server/am/MultiWindowManagerService;->-get1(Lcom/android/server/am/MultiWindowManagerService;)Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/server/am/MultiWindowManagerService;->-get8(Lcom/android/server/am/MultiWindowManagerService;)Lcom/android/server/am/ActivityStackSupervisor;
    ...
    invoke-virtual/range {v16 .. v22}, Lcom/android/server/am/ActivityStackSupervisor;->moveTaskToStackLocked(IIZZLjava/lang/String;Z)Z
    :try_end_17
    ...
    invoke-virtual/range {v16 .. v21}, Lcom/android/server/am/MultiWindowSettingsObserver;->setMultiWindowSettingToRepository(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;IZ)V
    :try_end_18
    ...
    :try_start_1a
    invoke-interface {v9}, Lcom/samsung/android/multiwindow/IMultiWindowEventListener;->onMultiWindowScreenFreezeAnimationFinished()V
    :try_end_1a
    ...
    const-string/jumbo v21, "Error delivering onMultiWindowScreenFreezeAnimationFinished event."
    ...
    invoke-virtual/range {v29 .. v29}, Lcom/android/server/am/ActivityStack;->topRunningActivityLocked()Lcom/android/server/am/ActivityRecord;
    ...
    invoke-interface {v9, v0, v1, v2}, Lcom/samsung/android/multiwindow/IMultiWindowEventListener;->onMultiWindowDockedMinimizedChanged(ZZLandroid/content/pm/ActivityInfo;)V
    :try_end_1f
    ...
    const-string/jumbo v21, "Error delivering onMultiWindowDockedMinimizedChanged event."
    ...
    invoke-virtual {v0, v5}, Lcom/android/server/am/MultiWindowManagerService;->applyFreeformMinimizePolicyLocked(I)V
    :try_end_22
    ...
    const-string/jumbo v21, "NOTIFY_ACTIVITY_STACK_ATTACHED, stackId="
    ...
    const-string/jumbo v21, ", displayId="
    ...
    const-string/jumbo v20, "freeform attached"
    ...
    const-string/jumbo v21, "NOTIFY_ACTIVITY_STACK_DETACHED, stackId="
    ...
    const-string/jumbo v20, "freeform detached"
    ...
    const-string/jumbo v21, "NOTIFY_PROCESS_KILL_BY_CLOSING_FREEFORM, pid="
    ...
    invoke-static {v0, v1}, Lcom/android/server/am/MultiWindowManagerService;->-wrap1(Lcom/android/server/am/MultiWindowManagerService;I)V
    ...
    :try_start_24
    invoke-interface {v9, v14}, Lcom/samsung/android/multiwindow/IMultiWindowEventListener;->onSnapWindowDismissed(Ljava/lang/String;)V
    :try_end_24
    ...
    const-string/jumbo v21, "Error delivering onSnapWindowDismissed event."
