...
.method private moveTaskToFreeformStackOrRelayoutLocked(Lcom/android/server/am/TaskRecord;Z)V
    ...
    invoke-virtual {p0}, Lcom/android/server/am/SamsungActivityManagerService;->isKnoxDesktopModeLocked()Z
    ...
    iget-object v1, v11, Lcom/android/server/am/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;

    if-eqz v1, :cond_2

    iget-object v0, v11, Lcom/android/server/am/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;

    iget-object v12, v0, Landroid/content/pm/ActivityInfo;->windowLayout:Landroid/content/pm/ActivityInfo$WindowLayout;
    ...
    invoke-interface {v0, p1, v1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->updateDexCompatLaunchPolicy(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo;)V
    ...
    iget v0, v12, Landroid/content/pm/ActivityInfo$WindowLayout;->width:I

    if-gtz v0, :cond_0

    iget v0, v12, Landroid/content/pm/ActivityInfo$WindowLayout;->height:I
    ...
    invoke-virtual {v0, p1, v12}, Lcom/android/server/am/ActivityStack;->layoutTaskInStack(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo$WindowLayout;)Z
    ...
    :cond_3
    iget v0, v12, Landroid/content/pm/ActivityInfo$WindowLayout;->widthFraction:F

    cmpl-float v0, v0, v3

    if-gtz v0, :cond_0

    iget v0, v12, Landroid/content/pm/ActivityInfo$WindowLayout;->heightFraction:F
    ...
    invoke-virtual {v0, v2, v7, v6}, Lcom/android/server/am/ActivityStackSupervisor;->getStack(IZZ)Lcom/android/server/am/ActivityStack;
    ...
    invoke-virtual {v9, p1, v8, v12}, Lcom/android/server/am/ActivityStack;->getDefaultTaskBoundsInStack(Lcom/android/server/am/TaskRecord;Landroid/graphics/Rect;Landroid/content/pm/ActivityInfo$WindowLayout;)V

    :cond_6
    iput-object v8, p1, Lcom/android/server/am/TaskRecord;->mLastNonFullscreenBounds:Landroid/graphics/Rect;

    iput-object v8, p1, Lcom/android/server/am/TaskRecord;->mBounds:Landroid/graphics/Rect;
...
.method public applyConventionalMode(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-interface {v5, v0, v1}, Lcom/android/server/PackageConfigurationController;->onApplicationStarted(Ljava/lang/String;I)V
...
.method public clearHomeStack()V
    ...
    invoke-virtual {v4, v6, v7, v8}, Lcom/android/server/am/ActivityManagerService;->removeTaskByIdLocked(IZZ)Z
    :try_end_0
...
.method public dispatchForceMultiWindowModeChanged(I)V
    .locals 5
    ...
    invoke-virtual {v3, v1}, Lcom/android/server/am/ActivityStackSupervisor;->scheduleReportMultiWindowModeChanged(Lcom/android/server/am/TaskRecord;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
