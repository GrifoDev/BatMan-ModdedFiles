...
.method private doUpdateTilesList()V
    ...
    invoke-virtual/range {v49 .. v49}, Landroid/os/UserManager;->isAdminUser()Z
    ...
    const-string/jumbo v53, "android.hardware.wifi"
    ...
    :cond_1
    new-instance v54, Landroid/content/ComponentName;

    const-class v53, Lcom/android/settings/Settings$WifiSettingsActivity;
    ...
    const-string/jumbo v53, "android.hardware.bluetooth"
    ...
    const-class v53, Lcom/android/settings/Settings$BluetoothSettingsActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$DataUsageSummaryActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$SimSettingsActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$PowerUsageSummaryActivity;
    ...
    const-class v53, Lcom/android/settings/Settings$UserSettingsActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$NetworkDashboardActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$ConnectedDeviceDashboardActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$DateTimeSettingsActivity;
    ...
    const-class v53, Lcom/android/settings/Settings$NfcSettingsActivity;
    ...
    const-class v53, Lcom/android/settings/Settings$NfcOsaifukeitaiSettingsActivity;
    ...
    const-class v53, Lcom/android/settings/Settings$PaymentSettingsActivity;
    ...
    const-string/jumbo v53, "android.hardware.nfc.hce"
    ...
    const-class v54, Lcom/android/settings/Settings$PrintSettingsActivity;
    ...
    const-string/jumbo v54, "android.software.print"
    ...
    const-class v54, Lcom/android/settings/Settings$HelpActivity;
    ...
    const-string/jumbo v53, "connectivity"
    ...
    const-string/jumbo v53, "no_config_tethering"
    ...
    const-class v53, Lcom/android/settings/Settings$TetherSettingsActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$DockSettingsActivity;
    ...
    const-string/jumbo v53, "com.sec.feature.fingerprint_manager_service"
    ...
    const-class v54, Lcom/android/settings/fingerprint/FingerprintEntry;
    ...
    const-class v53, Lcom/android/settings/Settings$TRoamingSettingsActivity;
    ...
    const-class v54, Lcom/samsung/android/settings/face/FaceEntry;
    ...
    const-class v54, Lcom/samsung/android/settings/iris/IrisLockSettings;
    ...
    const-class v54, Lcom/samsung/android/settings/smartscan/SmartScanEntry;
    ...
    const-class v54, Lcom/android/settings/Settings$LockAndSecuritySettingsActivity;
    ...
    invoke-static/range {v54 .. v54}, Lcom/android/settings/Utils;->checkKnoxCustomSettingsHiddenItem(I)Z
    ...
    const-class v54, Lcom/android/settings/Settings$ManageApplicationsActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$LocationSettingsActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$AirplaneModeSettingsActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$LanguageAndInputSettingsActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$LocalePickerActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$ApplicationsActivity;
    ...
    const-string/jumbo v53, "no_debugging_features"
    ...
    const-class v53, Lcom/android/settings/Settings$DevelopmentSettingsActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$PersonalPageSettingsActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$WifiDisplaySettingsActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$SoftwareUpdateSettingActivity;
    ...
    const-string/jumbo v54, "CscFeature_Common_EnableSprintExtension"

    invoke-virtual/range {v53 .. v54}, Lcom/samsung/android/feature/SemCscFeature;->getBoolean(Ljava/lang/String;)Z
    ...
    invoke-static/range {v53 .. v54}, Lcom/samsung/android/settingslib/Log;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v55, "sprint chameleon tethering showTile : "
    ...
    const-class v54, Lcom/android/settings/Settings$SprTetherSettingsActivity;
    ...
    invoke-interface/range {v53 .. v53}, Lcom/android/settings/dashboard/DashboardFeatureProvider;->getAllCategories()Ljava/util/List;
    ...
    invoke-virtual/range {v53 .. v53}, Landroid/content/Intent;->getComponent()Landroid/content/ComponentName;
    ...
    sget-object v53, Lcom/android/settings/core/gateway/SettingsGateway;->SETTINGS_FOR_RESTRICTED:[Ljava/lang/String;
    ...
    const-class v53, Lcom/android/settings/Settings$PrivacySettingsActivity;
    ...
    const-class v54, Lcom/android/settings/backup/BackupSettingsActivity;
    ...
    const-class v53, Lcom/android/settings/Settings$PenSettingsMenuActivity;
    ...
    const-class v54, Lcom/android/settings/Settings$CloudAccountSettingsActivity;
    ...
    const-string/jumbo v54, "no_modify_accounts"
    ...
    const-class v54, Lcom/android/settings/Settings$WirelessSettingsActivity;
    ...
    const-string/jumbo v54, "Invalid backup intent URI!"
