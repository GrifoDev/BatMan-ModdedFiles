...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v8}, Lcom/samsung/android/settings/notification/SoundSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v8

    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mRingtonePreference_DS:Landroid/support/v7/preference/Preference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mTcoloring:Landroid/support/v7/preference/Preference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mRingtoyou:Landroid/support/v7/preference/Preference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mFeelring:Landroid/support/v7/preference/Preference;
    ...
    invoke-virtual {v6, p0}, Lcom/android/settings/notification/SettingPref;->init(Lcom/android/settings/SettingsPreferenceFragment;)Landroid/support/v7/preference/Preference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mDialKeypadTone:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mScreenLockSound:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mTouchSounds:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mKeyboardSound:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mDeviceVibration:Landroid/support/v7/preference/SecPreferenceScreen;

    iget-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mDeviceVibration:Landroid/support/v7/preference/SecPreferenceScreen;

    invoke-virtual {v8, v11}, Landroid/support/v7/preference/SecPreferenceScreen;->semSetSummaryColorToColorPrimaryDark(Z)V
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mVibrateWhenRinging:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mVibrationOnTouch:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mKeyboardVibration:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mDefaultVolumeControl:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iget-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mDefaultVolumeControl:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    invoke-virtual {v8, v9}, Landroid/support/v14/preference/SecSwitchPreference;->setOnPreferenceClickListener(Landroid/support/v7/preference/Preference$OnPreferenceClickListener;)V

    :cond_a
    iget-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mVibrateWhenRinging:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    invoke-virtual {v8, v9}, Landroid/support/v14/preference/SecSwitchPreference;->setOnPreferenceChangeListener(Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;)V

    iget-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mVibrationOnTouch:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iget-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mKeyboardVibration:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iget-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mRingtonePreference_DS:Landroid/support/v7/preference/Preference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mZenModeDND:Lcom/android/settings/SecSettingsSwitchPreference;
    ...
    invoke-virtual {v8, v9}, Lcom/android/settings/SecSettingsSwitchPreference;->setOnPreferenceChangeListener(Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;)V
    ...
    invoke-virtual {v8, v9}, Landroid/support/v14/preference/SecSwitchPreference;->setSummary(Ljava/lang/CharSequence;)V
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mIntervalSoundMode:Landroid/support/v7/preference/SecPreferenceScreen;

    iget-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mIntervalSoundMode:Landroid/support/v7/preference/SecPreferenceScreen;
    ...
    invoke-static {v8}, Lcom/samsung/android/settings/notification/SoundSettings;->IsMultiSoundSupported(Landroid/content/Context;)Z
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mNotificationSound:Lcom/android/settings/DefaultRingtonePreference;

    iget-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mNotificationSound:Lcom/android/settings/DefaultRingtonePreference;
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mSoundEffects:Landroid/support/v7/preference/SecPreferenceScreen;

    iget-object v8, p0, Lcom/samsung/android/settings/notification/SoundSettings;->mSoundEffects:Landroid/support/v7/preference/SecPreferenceScreen;
