...
.method private initActionBarBtn(I)V
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/localepicker/LocaleListEditor;->mActionBar:Landroid/app/ActionBar;

    const/4 v8, 0x1

    if-ne p1, v8, :cond_6

    iget-object v8, p0, Lcom/samsung/android/settings/localepicker/LocaleListEditor;->mMenu:Landroid/view/Menu;
    ...
    :cond_0
    iget-object v8, p0, Lcom/samsung/android/settings/localepicker/LocaleListEditor;->mFooterView:Landroid/view/View;

    if-eqz v8, :cond_1

    iget-object v8, p0, Lcom/samsung/android/settings/localepicker/LocaleListEditor;->mListView:Landroid/widget/ListView;
    ...
    :cond_1
    iget-object v8, p0, Lcom/samsung/android/settings/localepicker/LocaleListEditor;->mActionBar:Landroid/app/ActionBar;
    ...
    invoke-direct {v4, v8, v9}, Landroid/app/ActionBar$LayoutParams;-><init>(II)V
    ...
    invoke-virtual {v8, v0, v4}, Landroid/app/ActionBar;->setCustomView(Landroid/view/View;Landroid/app/ActionBar$LayoutParams;)V
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/localepicker/LocaleListEditor;->mCancelButton:Landroid/widget/Button;
    ...
    iget-object v8, p0, Lcom/samsung/android/settings/localepicker/LocaleListEditor;->mCancelButton:Landroid/widget/Button;

    new-instance v9, Lcom/samsung/android/settings/localepicker/LocaleListEditor$5;

    invoke-direct {v9, p0}, Lcom/samsung/android/settings/localepicker/LocaleListEditor$5;-><init>(Lcom/samsung/android/settings/localepicker/LocaleListEditor;)V
    ...
    iput-object v8, p0, Lcom/samsung/android/settings/localepicker/LocaleListEditor;->mSaveButton:Landroid/widget/Button;
    ...
    iget-boolean v8, p0, Lcom/samsung/android/settings/localepicker/LocaleListEditor;->mIsShowHardKey:Z

    if-eqz v8, :cond_3

    iget-object v8, p0, Lcom/samsung/android/settings/localepicker/LocaleListEditor;->mSaveButton:Landroid/widget/Button;
    ...
    new-instance v9, Lcom/samsung/android/settings/localepicker/LocaleListEditor$6;

    invoke-direct {v9, p0}, Lcom/samsung/android/settings/localepicker/LocaleListEditor$6;-><init>(Lcom/samsung/android/settings/localepicker/LocaleListEditor;)V

    invoke-virtual {v8, v9}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-boolean v8, p0, Lcom/samsung/android/settings/localepicker/LocaleListEditor;->mIsEnabledShowBtnBg:Z
    ...
    invoke-interface {v8, v9, v10, v11, v12}, Landroid/view/Menu;->add(IIII)Landroid/view/MenuItem;
